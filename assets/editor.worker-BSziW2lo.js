(function() {
	...
	var y = class e {
		...
		constructor(e) {
			this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new L(e?.onListenerError ?? t, this._options?.leakWarningThreshold ?? -1) : void 0, this._perfMon = this._options?._profName ? new y(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
		}
		dispose() {
		...
		get event() {
			return this._event ??= (e, n, r) => {
				if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
					...
					console.warn(e);
					const n = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], r = new E(`${e}. HINT: Stack shows most frequent listener (${n[1]}-times)`, n[0]);
	...
	const q = globalThis;
	let V;
	void 0 !== q.vscode && void 0 !== q.vscode.process ? V = q.vscode.process : "undefined" != typeof process && "string" == typeof process?.versions?.node && (V = process);
	const K = "string" == typeof V?.versions?.electron && "renderer" === V?.type;
	if ("object" == typeof V) {
		I = "win32" === V.platform, T = "darwin" === V.platform, V.platform;
		const e = V.env.VSCODE_NLS_CONFIG;
		if (e) try {
			JSON.parse(e).resolvedLanguage;
		} catch (Zi) {}
	} else "object" != typeof navigator || K ? console.error("Unable to resolve platform.") : (O = navigator.userAgent, I = O.indexOf("Windows") >= 0, T = O.indexOf("Macintosh") >= 0, (O.indexOf("Macintosh") >= 0 || O.indexOf("iPad") >= 0 || O.indexOf("iPhone") >= 0) && navigator.maxTouchPoints, O.indexOf("Linux"), O?.indexOf("Mobi"), A(), navigator.language.toLowerCase());
	const U = I, $ = T, W = O, z = "function" == typeof q.postMessage && !q.importScripts;
	(() => {
		if (z) {
			const e = [];
	...
	const j = !!(W && W.indexOf("Chrome") >= 0);
	function G(e) {
		return e;
	}
	W && W.indexOf("Firefox"), !j && W && W.indexOf("Safari"), W && W.indexOf("Edg/"), W && W.indexOf("Android");
	var X, Q = class {
		constructor(e, t) {
	...
	var se = class e {
		...
		static {
			this._locales = new J(() => Object.keys(e.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")));
		}
		static getLocales() {
	...
	var le = class {
		...
		listen(e, t, n) {
			...
			const i = new R({
				onWillAddFirstListener: () => {
					r = String(++this._lastSentReq), this._pendingEmitters.set(r, i), this._send(new he(this._workerId, r, e, t, n));
				},
				onDidRemoveLastListener: () => {
		...
		createProxyToRemoteChannel(e, t) {
			return new Proxy(Object.create(null), { get: (n, r) => ("string" != typeof r || n[r] || (fe(r) ? n[r] = (t) => this.listen(e, r, t) : me(r) ? n[r] = this.listen(e, r, void 0) : 36 === r.charCodeAt(0) && (n[r] = async (...n) => (await t?.(), this.sendMessage(e, r, n)))), n[r]) });
		}
		_handleMessage(e) {
			switch (e.type) {
		...
		_handleSubscribeEventMessage(e) {
			const t = e.req, n = this._handler.handleEvent(e.channel, e.eventName, e.arg)((e) => {
				this._send(new ce(this._workerId, t, e));
			});
	...
	var pe = class {
		constructor(e, t) {
			this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new ge({
				sendMessage: (t, n) => {
					e(t, n);
				},
	...
	const _e = "undefined" != typeof Buffer;
	let Ce;
	new J(() => new Uint8Array(256));
	var ye = class e {
		static wrap(t) {
			return _e && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new e(t);
		}
		constructor(e) {
			this.buffer = e, this.byteLength = this.buffer.byteLength;
		}
		toString() {
			return _e ? this.buffer.toString() : (Ce || (Ce = new TextDecoder()), Ce.decode(this.buffer));
		}
	};
	...
	(class e {
		...
		_step() {
			...
			for (let e = 64; e < 320; e += 4) t.setUint32(e, Ee(t.getUint32(e - 12, !1) ^ t.getUint32(e - 32, !1) ^ t.getUint32(e - 56, !1) ^ t.getUint32(e - 64, !1), 1), !1);
			let r, i, s, o = this._h0, a = this._h1, l = this._h2, u = this._h3, h = this._h4;
			for (let e = 0; e < 80; e++) e < 20 ? (r = a & l | ~a & u, i = 1518500249) : e < 40 ? (r = a ^ l ^ u, i = 1859775393) : e < 60 ? (r = a & l | a & u | l & u, i = 2400959708) : (r = a ^ l ^ u, i = 3395469782), s = Ee(o, 5) + r + h + i + t.getUint32(4 * e, !1) & 4294967295, h = u, u = l, l = Ee(a, 30), a = o, o = s;
	...
	function xe(e, t, n) {
		return new Oe(new Re(e), new Re(t)).ComputeDiff(n).changes;
	}
	var Ae = class {
		static Assert(e, t) {
		...
		static _getElements(t) {
			...
			if (e._isStringArray(n)) {
				...
				for (let t = 0, r = n.length; t < r; t++) e[t] = Ne(n[t], 0);
				return [
					n,
					e,
					!0
		...
		ComputeDiffRecursive(e, t, n, r, i) {
			...
			if (e > t || n > r) {
				let i;
				return n <= r ? (Ae.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), i = [new we(e, 0, n, r - n + 1)]) : e <= t ? (Ae.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"), i = [new we(e, t - e + 1, n, 0)]) : (Ae.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), Ae.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"), i = []), i;
			}
			...
			if (!i[0]) {
				...
				let o = [];
				return o = i[0] ? [new we(l + 1, t - (l + 1) + 1, u + 1, r - (u + 1) + 1)] : this.ComputeDiffRecursive(l + 1, t, u + 1, r, i), this.ConcatenateChanges(s, o);
			}
			return [new we(e, t - e + 1, n, r - n + 1)];
		}
		WALKTRACE(e, t, n, r, i, s, o, a, l, u, h, c, d, g, m, f, p, b) {
			let w = null, _ = null, C = new Me(), y = t, L = n, v = d[0] - f[0] - r, N = -1073741824, E = this.m_forwardHistory.length - 1;
			do {
				const t = v + e;
				t === y || t < L && l[t - 1] < l[t + 1] ? (g = (h = l[t + 1]) - v - r, h < N && C.MarkNextChange(), N = h, C.AddModifiedElement(h + 1, g), v = t + 1 - e) : (g = (h = l[t - 1] + 1) - v - r, h < N && C.MarkNextChange(), N = h - 1, C.AddOriginalElement(h, g + 1), v = t - 1 - e), E >= 0 && (e = (l = this.m_forwardHistory[E])[0], y = 1, L = l.length - 1);
			} while (--E >= -1);
			if (w = C.getReverseChanges(), b[0]) {
				...
				_ = [new we(e, c - e + 1, t, m - t + 1)];
			} else {
				C = new Me(), y = s, L = o, v = d[0] - f[0] - a, N = 1073741824, E = p ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const e = v + i;
					e === y || e < L && u[e - 1] >= u[e + 1] ? (g = (h = u[e + 1] - 1) - v - a, h > N && C.MarkNextChange(), N = h + 1, C.AddOriginalElement(h + 1, g + 1), v = e + 1 - i) : (g = (h = u[e - 1]) - v - a, h > N && C.MarkNextChange(), N = h, C.AddModifiedElement(h + 1, g + 1), v = e - 1 - i), E >= 0 && (i = (u = this.m_reverseHistory[E])[0], y = 1, L = u.length - 1);
				} while (--E >= -1);
				_ = C.getChanges();
			}
		...
		ComputeRecursionPoint(e, t, n, r, i, s, o) {
			...
			for (let L = 1; L <= g / 2 + 1; L++) {
				let g = 0, v = 0;
				u = this.ClipDiagonalBound(b - L, L, b, m), h = this.ClipDiagonalBound(b + L, L, b, m);
				for (let e = u; e <= h; e += 2) {
					a = e === u || e < h && f[e - 1] < f[e + 1] ? f[e + 1] : f[e - 1] + 1, l = a - (e - b) - _;
					const n = a;
					for (; a < t && l < r && this.ElementsAreEqual(a + 1, l + 1);) a++, l++;
					if (f[e] = a, a + l > g + v && (g = a, v = l), !y && Math.abs(e - w) <= L - 1 && a >= p[e]) return i[0] = a, s[0] = l, n <= p[e] && L <= 1448 ? this.WALKTRACE(b, u, h, _, w, c, d, C, f, p, a, t, i, l, r, s, y, o) : null;
				}
				const N = (g - e + (v - n) - L) / 2;
				if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(g, N)) return o[0] = !0, i[0] = g, s[0] = v, N > 0 && L <= 1448 ? this.WALKTRACE(b, u, h, _, w, c, d, C, f, p, a, t, i, l, r, s, y, o) : (e++, n++, [new we(e, t - e + 1, n, r - n + 1)]);
				c = this.ClipDiagonalBound(w - L, L, w, m), d = this.ClipDiagonalBound(w + L, L, w, m);
				for (let m = c; m <= d; m += 2) {
					a = m === c || m < d && p[m - 1] >= p[m + 1] ? p[m + 1] - 1 : p[m - 1], l = a - (m - w) - C;
					const g = a;
					for (; a > e && l > n && this.ElementsAreEqual(a, l);) a--, l--;
					if (p[m] = a, y && Math.abs(m - b) <= L && a <= f[m]) return i[0] = a, s[0] = l, g >= f[m] && L <= 1448 ? this.WALKTRACE(b, u, h, _, w, c, d, C, f, p, a, t, i, l, r, s, y, o) : null;
				}
				if (L <= 1447) {
					let e = new Int32Array(h - u + 2);
					e[0] = b - u + 1, ke.Copy2(f, u, e, 1, h - u + 1), this.m_forwardHistory.push(e), e = new Int32Array(d - c + 2), e[0] = w - c + 1, ke.Copy2(p, c, e, 1, d - c + 1), this.m_reverseHistory.push(e);
				}
			}
		...
		ConcatenateChanges(e, t) {
			...
			if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
				...
				return ke.Copy(e, 0, r, 0, e.length - 1), r[e.length - 1] = n[0], ke.Copy(t, 1, r, e.length, t.length - 1), r;
			}
			{
				const n = new Array(e.length + t.length);
				return ke.Copy(e, 0, n, 0, e.length), ke.Copy(t, 0, n, e.length, t.length), n;
			}
		}
		ChangesOverlap(e, t, n) {
			if (Ae.Assert(e.originalStart <= t.originalStart, "Left change is not less than or equal to right change"), Ae.Assert(e.modifiedStart <= t.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= t.originalStart || e.modifiedStart + e.modifiedLength >= t.modifiedStart) {
				...
				return e.originalStart + e.originalLength >= t.originalStart && (r = t.originalStart + t.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= t.modifiedStart && (i = t.modifiedStart + t.modifiedLength - e.modifiedStart), n[0] = new we(e.originalStart, r, e.modifiedStart, i), !0;
			}
			return n[0] = null, !1;
		}
	...
	(function(e) {
		e.isCancellationToken = function(t) {
			return t === e.None || t === e.Cancelled || t instanceof He || !(!t || "object" != typeof t) && "boolean" == typeof t.isCancellationRequested && "function" == typeof t.onCancellationRequested;
	...
	var He = class {
		...
		get onCancellationRequested() {
			return this._isCancelled ? We : (this._emitter || (this._emitter = new R()), this._emitter.event);
		}
		dispose() {
	...
	const Ge = new je(), Xe = new je(), Qe = new je(), Je = new Array(230), Ye = Object.create(null), Ze = Object.create(null), et = [];
	for (let es = 0; es <= 193; es++) et[es] = -1;
	var tt;
	let nt;
	(function() {
		const e = "", t = [
		...
		for (const i of t) {
			...
			if (r[t] || (r[t] = !0, Ye[s] = t, Ze[s.toLowerCase()] = t, e && (et[t] = o)), !n[o]) {
				if (n[o] = !0, !a) throw new Error(`String representation missing for key code ${o} around scan code ${s}`);
				Ge.define(o, a), Xe.define(o, h || a), Qe.define(o, c || h || a);
			}
			l && (Je[l] = o);
		}
	})(), function(e) {
		e.toString = function(e) {
			...
			return Xe.strToKeyCode(e) || Qe.strToKeyCode(e);
	...
	const it = nt.cwd, st = nt.env, ot = nt.platform, at = 46, lt = 47, ut = 92, ht = 58;
	...
	function dt(e, t) {
		if ("string" != typeof e) throw new ct(t, "string", e);
	}
	const gt = "win32" === ot;
	function mt(e) {
		return e === lt || e === ut;
	...
	function wt(e, t) {
		(function(e) {
			if (null === e || "object" != typeof e) throw new ct("pathObject", "Object", e);
		})(t);
	...
	const _t = {
		resolve(...e) {
			...
			for (let i = e.length - 1; i >= -1; i--) {
				...
				if (1 === o) mt(h) && (a = 1, u = !0);
				else if (mt(h)) if (u = !0, mt(s.charCodeAt(1))) {
					let e = 2, t = e;
				...
				else pt(h) && s.charCodeAt(1) === ht && (l = s.slice(0, 2), a = 2, o > 2 && mt(s.charCodeAt(2)) && (u = !0, a = 3));
		...
		normalize(e) {
			...
			else pt(s) && e.charCodeAt(1) === ht && (n = e.slice(0, 2), r = 2, t > 2 && mt(e.charCodeAt(2)) && (i = !0, r = 3));
			let o = r < t ? bt(e.slice(r), !i, "\\", mt) : "";
			if (0 !== o.length || i || (o = "."), o.length > 0 && mt(e.charCodeAt(t - 1)) && (o += "\\"), !i && void 0 === n && e.includes(":")) {
				if (o.length >= 2 && pt(o.charCodeAt(0)) && o.charCodeAt(1) === ht) return `.\\${o}`;
				let n = e.indexOf(":");
				do
		...
		isAbsolute(e) {
			...
			return mt(n) || t > 2 && pt(n) && e.charCodeAt(1) === ht && mt(e.charCodeAt(2));
		},
		join(...e) {
			...
			return _t.normalize(t);
		},
		relative(e, t) {
			if (dt(e, "from"), dt(t, "to"), e === t) return "";
			const n = _t.resolve(e), r = _t.resolve(t);
			if (n === r) return "";
			...
			if (d !== h) {
				...
				o > h && (e.charCodeAt(i + d) === ut ? c = d : 2 === d && (c = 3)), -1 === c && (c = 0);
			}
			let g = "";
			for (d = i + c + 1; d <= s; ++d) d !== s && e.charCodeAt(d) !== ut || (g += 0 === g.length ? ".." : "\\..");
			return a += c, g.length > 0 ? `${g}${r.slice(a, l)}` : (r.charCodeAt(a) === ut && ++a, r.slice(a, l));
		},
		toNamespacedPath(e) {
			if ("string" != typeof e || 0 === e.length) return e;
			const t = _t.resolve(e);
			...
			} else if (pt(t.charCodeAt(0)) && t.charCodeAt(1) === ht && t.charCodeAt(2) === ut) return `\\\\?\\${t}`;
			return t;
		},
		dirname(e) {
			dt(e, "path");
			...
			} else pt(i) && e.charCodeAt(1) === ht && (n = t > 2 && mt(e.charCodeAt(2)) ? 3 : 2, r = n);
			let s = -1, o = !0;
		...
		basename(e, t) {
			...
			let n, r = 0, i = -1, s = !0;
			if (e.length >= 2 && pt(e.charCodeAt(0)) && e.charCodeAt(1) === ht && (r = 2), void 0 !== t && t.length > 0 && t.length <= e.length) {
				if (t === e) return "";
		...
		extname(e) {
			...
			e.length >= 2 && e.charCodeAt(1) === ht && pt(e.charCodeAt(0)) && (t = r = 2);
		...
		parse(e) {
			...
			} else if (pt(i) && e.charCodeAt(1) === ht) {
			...
			} else -1 === a && (l = !1, a = u + 1), i === at ? -1 === s ? s = u : 1 !== h && (h = 1) : -1 !== s && (h = -1);
	...
	yt.win32 = _t.win32 = _t, yt.posix = _t.posix = yt;
	const Lt = /^\w[\w\d+.-]*$/, vt = /^\//, Nt = /^\/\//, Et = "", St = "/", Rt = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
	var xt = class e {
		static isUri(t) {
		...
		constructor(e, t, n, r, i, s = !1) {
			"object" == typeof e ? (this.scheme = e.scheme || Et, this.authority = e.authority || Et, this.path = e.path || Et, this.query = e.query || Et, this.fragment = e.fragment || Et) : (this.scheme = function(e, t) {
				return e || t ? e : "file";
			}(e, s), this.authority = t || Et, this.path = function(e, t) {
				switch (e) {
					case "https":
					case "http":
					case "file": t ? t[0] !== St && (t = St + t) : t = St;
				}
				return t;
			}(this.scheme, n || Et), this.query = r || Et, this.fragment = i || Et, function(e, t) {
				...
				if (e.scheme && !Lt.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
				if (e.path) {
					if (e.authority) {
						if (!vt.test(e.path)) throw new Error("[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash (\"/\") character");
					} else if (Nt.test(e.path)) throw new Error("[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters (\"//\")");
				}
			}(this, s));
		}
		get fsPath() {
		...
		with(e) {
			...
			return void 0 === t ? t = this.scheme : null === t && (t = Et), void 0 === n ? n = this.authority : null === n && (n = Et), void 0 === r ? r = this.path : null === r && (r = Et), void 0 === i ? i = this.query : null === i && (i = Et), void 0 === s ? s = this.fragment : null === s && (s = Et), t === this.scheme && n === this.authority && r === this.path && i === this.query && s === this.fragment ? this : new kt(t, n, r, i, s);
		}
		static parse(e, t = !1) {
			const n = Rt.exec(e);
			return n ? new kt(n[2] || Et, qt(n[4] || Et), qt(n[5] || Et), qt(n[7] || Et), qt(n[9] || Et), t) : new kt(Et, Et, Et, Et, Et);
		}
		static file(e) {
			let t = Et;
			if (U && (e = e.replace(/\\/g, St)), e[0] === St && e[1] === St) {
				const n = e.indexOf(St, 2);
				-1 === n ? (t = e.substring(2), e = St) : (t = e.substring(2, n), e = e.substring(n) || St);
			}
			return new kt("file", t, e, Et, Et);
		}
		static from(e, t) {
			return new kt(e.scheme, e.authority, e.path, e.query, e.fragment, t);
		}
		static joinPath(t, ...n) {
			if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
			let r;
			return r = U && "file" === t.scheme ? e.file(_t.join(Tt(t, !0), ...n)).path : yt.join(t.path, ...n), t.with({ path: r });
		}
		toString(e = !1) {
			return Pt(this, e);
		}
	...
	var kt = class extends xt {
		...
		get fsPath() {
			return this._fsPath || (this._fsPath = Tt(this, !1)), this._fsPath;
		}
		toString(e = !1) {
	...
	function It(e) {
		...
		for (let n = 0; n < e.length; n++) {
			const r = e.charCodeAt(n);
			35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), t += Mt[r]) : void 0 !== t && (t += e[n]);
		}
		return void 0 !== t ? t : e;
	}
	function Tt(e, t) {
		let n;
		return n = e.authority && e.path.length > 1 && "file" === e.scheme ? `//${e.authority}${e.path}` : 47 === e.path.charCodeAt(0) && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && 58 === e.path.charCodeAt(2) ? t ? e.path.substr(1) : e.path[1].toLowerCase() + e.path.substr(2) : e.path, U && (n = n.replace(/\//g, "\\")), n;
	}
	function Pt(e, t) {
		const n = t ? It : Ot;
		let r = "", { scheme: i, authority: s, path: o, query: a, fragment: l } = e;
		if (i && (r += i, r += ":"), (s || "file" === i) && (r += St, r += St), s) {
			let e = s.indexOf("@");
			if (-1 !== e) {
		...
		return a && (r += "?", r += n(a, !1, !1)), l && (r += "#", r += t ? l : Ot(l, !1, !1)), r;
	}
	function Ft(e) {
		try {
			return decodeURIComponent(e);
		} catch {
			return e.length > 3 ? e.substr(0, 3) + Ft(e.substr(3)) : e;
		}
	}
	const Dt = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function qt(e) {
		return e.match(Dt) ? e.replace(Dt, (e) => Ft(e)) : e;
	}
	...
	var Ut, $t, Wt, zt, Ht, jt, Gt, Xt, Qt, Jt, Yt, Zt, en, tn, nn, rn, sn, on, an, ln, un, hn, cn, dn, gn, mn, fn, pn, bn, wn, _n, Cn, yn, Ln, vn, Nn, En, Sn, Rn, xn, An, kn, Mn, On, In, Tn, Pn, Fn, Dn, qn, Vn, Kn, Bn, Un, $n, Wn, zn, Hn, jn, Gn, Xn, Qn = class extends f {
		get isResolved() {
	...
	var Jn, Yn, Zn, er, tr, nr, rr = class {
		static {
			this.CtrlCmd = 2048;
		}
		static {
		...
		constructor(t, n) {
			if (this[Jn] = "ResourceMap", t instanceof e) this.map = new Map(t.map), this.toKey = n ?? e.defaultToKey;
			else if (function(e) {
		...
		*[(Jn = Symbol.toStringTag, Symbol.iterator)]() {
		...
		constructor() {
			this[Yn] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
		}
		clear() {
	...
	function gr(e, t, n, i, s) {
		if (t = cr(t), s || (s = r.first(dr)), n.length > s.maxLen) {
			let r = e - s.maxLen / 2;
			return r < 0 ? r = 0 : i += r, gr(e, t, n = n.substring(r, e + s.maxLen / 2), i, s);
		}
	...
	var fr = class {
		static computeUnicodeHighlights(e, t, n) {
			...
			const h = new ur(null, l), c = [];
			let d, g = !1, m = 0, f = 0, p = 0;
			e: for (let b = r, w = i; b <= w; b++) {
				const t = e.getLineContent(b), n = t.length;
				h.reset(0);
				do
					if (d = h.next(t), d) {
						let e = d.index, r = d.index + d[0].length;
						e > 0 && Z(t.charCodeAt(e - 1)) && e--, r + 1 < n && Z(t.charCodeAt(r - 1)) && r++;
						const i = t.substring(e, r);
						let o = gr(e + 1, hr, t, 0);
						o && o.endColumn <= e + 1 && (o = null);
						const l = s.shouldHighlightNonBasicASCII(i, o ? o.word : null);
						if (0 !== l) {
							if (3 === l ? m++ : 2 === l ? f++ : 1 === l ? p++ : a(), c.length >= 1e3) {
								g = !0;
								break e;
							}
							c.push(new Te(b, e + 1, b, r + 1));
						}
					}
				while (d);
			}
	...
	(class e {
		...
		findLastMaxBy(e) {
			let t, n = !0;
			return this.iterate((r) => ((n || wr.isGreaterThan(e(r, t))) && (n = !1, t = r), !0)), t;
		}
	});
	var vr = class e {
		static fromTo(t, n) {
	...
	var Rr = class e {
		...
		findLastMonotonous(t) {
			...
			const n = Er(this._array, t, this._findLastMonotonousLastIdx);
		...
		static {
			this.compareByStart = yr((e) => e.startLineNumber, Lr);
		}
		static joinMany(e) {
			if (0 === e.length) return [];
			let t = new Ar(e[0].slice());
			for (let n = 1; n < e.length; n++) t = t.getUnion(new Ar(e[n].slice()));
			return t.ranges;
		}
		static join(t) {
		...
		toInclusiveRange() {
			return this.isEmpty ? null : new Te(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER);
		}
		toExclusiveRange() {
		...
		toOffsetRange() {
			return new vr(this.startLineNumber - 1, this.endLineNumberExclusive - 1);
		}
		addMargin(t, n) {
		...
		addRange(e) {
			if (0 === e.length) return;
			const t = Sr(this._normalizedRanges, (t) => t.endLineNumberExclusive >= e.startLineNumber), n = Er(this._normalizedRanges, (t) => t.startLineNumber <= e.endLineNumberExclusive) + 1;
		...
		contains(e) {
			const t = Nr(this._normalizedRanges, (t) => t.startLineNumber <= e);
			return !!t && t.endLineNumberExclusive > e;
		}
		intersects(e) {
			const t = Nr(this._normalizedRanges, (t) => t.startLineNumber < e.endLineNumberExclusive);
		...
		getUnion(t) {
			...
			for (; r < this._normalizedRanges.length || i < t._normalizedRanges.length;) {
				...
				null === s ? s = e : s.endLineNumberExclusive >= e.startLineNumber ? s = new xr(s.startLineNumber, Math.max(s.endLineNumberExclusive, e.endLineNumberExclusive)) : (n.push(s), s = e);
			}
			return null !== s && n.push(s), new e(n);
		}
		subtractFrom(t) {
			const n = Sr(this._normalizedRanges, (e) => e.endLineNumberExclusive >= t.startLineNumber), r = Er(this._normalizedRanges, (e) => e.startLineNumber <= t.endLineNumberExclusive) + 1;
			if (n === r) return new e([t]);
			const i = [];
			let s = t.startLineNumber;
			for (let e = n; e < r; e++) {
				const t = this._normalizedRanges[e];
				t.startLineNumber > s && i.push(new xr(s, t.startLineNumber)), s = t.endLineNumberExclusive;
			}
			return s < t.endLineNumberExclusive && i.push(new xr(s, t.endLineNumberExclusive)), new e(i);
		}
		toString() {
		...
		createRange(e) {
			return 0 === this.lineCount ? new Te(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount) : new Te(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1);
		}
		toRange() {
			return new Te(1, 1, this.lineCount + 1, this.columnCount + 1);
		}
		toLineRange() {
			return xr.ofLength(1, this.lineCount + 1);
		}
		addToPosition(e) {
		...
		getOffsetRange(e) {
			return new vr(this.getOffset(e.getStartPosition()), this.getOffset(e.getEndPosition()));
		}
		getRange(e) {
			return Te.fromPositions(this.getPosition(e.start), this.getPosition(e.endExclusive));
		}
		getStringReplacement(e) {
			return new Or.deps.StringReplacement(this.getOffsetRange(e.range), e.text);
		}
		getTextReplacement(e) {
			return new Or.deps.TextReplacement(this.getRange(e.replaceRange), e.newText);
		}
		getTextEdit(e) {
			const t = e.replacements.map((e) => this.getTextReplacement(e));
			return new Or.deps.TextEdit(t);
		}
	}, Or = class {
		static {
			this._deps = void 0;
		...
		getPosition(e) {
			const t = Er(this.lineStartOffsetByLineIdx, (t) => t <= e);
			return new Ie(t + 1, e - this.lineStartOffsetByLineIdx[t] + 1);
		}
		get textLength() {
			const e = this.lineStartOffsetByLineIdx.length - 1;
			return new Or.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e]);
		}
		getLineLength(e) {
		...
		getLineLength(e) {
			return this.getValueOfRange(new Te(e, 1, e, Number.MAX_SAFE_INTEGER)).length;
		}
		getTransformer() {
			return this._transformer || (this._transformer = new Ir(this.getValue())), this._transformer;
		}
		getLineAt(e) {
			return this.getValueOfRange(new Te(e, 1, e, Number.MAX_SAFE_INTEGER));
		}
	}, Pr = class extends Tr {
		constructor(e, t) {
		...
		get length() {
			...
			return new kr(this._lineCount - 1, e.length);
		}
	}, Fr = class extends Pr {
		constructor(e) {
		...
		static joinReplacements(t, n) {
			...
			for (let e = 0; e < t.length; e++) {
				...
				if (s += r.text, e < t.length - 1) {
					const i = t[e + 1], o = Te.fromPositions(r.range.getEndPosition(), i.range.getStartPosition());
					s += n.getValueOfRange(o);
				}
			}
			return new e(Te.fromPositions(r, i), s);
		}
		...
		removeCommonPrefix(t) {
			const n = t.getValueOfRange(this.range).replaceAll("\r\n", "\n"), r = this.text.replaceAll("\r\n", "\n"), i = function(e, t) {
				...
				return n;
			}(n, r), s = kr.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), o = r.substring(i);
			return new e(Te.fromPositions(s, this.range.getEndPosition()), o);
		}
		removeCommonSuffix(t) {
			const n = t.getValueOfRange(this.range).replaceAll("\r\n", "\n"), r = this.text.replaceAll("\r\n", "\n"), i = function(e, t) {
				...
				return n;
			}(n, r), s = kr.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), o = r.substring(0, r.length - i);
			return new e(Te.fromPositions(this.range.getStartPosition(), s), o);
		}
		toString() {
		...
		static inverse(t, n, r) {
			...
			let s = 1, o = 1;
			for (const l of t) {
				const t = new e(new xr(s, l.original.startLineNumber), new xr(o, l.modified.startLineNumber));
				t.modified.isEmpty || i.push(t), s = l.original.endLineNumberExclusive, o = l.modified.endLineNumberExclusive;
			}
			const a = new e(new xr(s, n + 1), new xr(o, r + 1));
		...
		toRangeMapping() {
			...
			if (1 === this.original.startLineNumber || 1 === this.modified.startLineNumber) {
				...
				return new Ur(new Te(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new Te(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			}
			return new Ur(new Te(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new Te(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
		}
		toRangeMapping2(e, t) {
			if (Kr(this.original.endLineNumberExclusive, e) && Kr(this.modified.endLineNumberExclusive, t)) return new Ur(new Te(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new Te(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			if (!this.original.isEmpty && !this.modified.isEmpty) return new Ur(Te.fromPositions(new Ie(this.original.startLineNumber, 1), Vr(new Ie(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), Te.fromPositions(new Ie(this.modified.startLineNumber, 1), Vr(new Ie(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
			if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new Ur(Te.fromPositions(Vr(new Ie(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e), Vr(new Ie(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), Te.fromPositions(Vr(new Ie(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Vr(new Ie(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
			throw new o();
		}
	};
	function Vr(e, t) {
	...
	var Br = class e extends qr {
		static fromRangeMappings(t) {
			return new e(xr.join(t.map((e) => xr.fromRangeInclusive(e.originalRange))), xr.join(t.map((e) => xr.fromRangeInclusive(e.modifiedRange))), t);
		}
		constructor(e, t, n) {
		...
		toTextEdit(e) {
			...
			return new Dr(this.originalRange, t);
		}
	};
	...
	var Wr = class {
		computeDiff(e, t, n) {
			...
			for (const o of r.changes) {
				let e, t;
				e = 0 === o.originalEndLineNumber ? new xr(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : new xr(o.originalStartLineNumber, o.originalEndLineNumber + 1), t = 0 === o.modifiedEndLineNumber ? new xr(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : new xr(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
				let n = new Br(e, t, o.charChanges?.map((e) => new Ur(new Te(e.originalStartLineNumber, e.originalStartColumn, e.originalEndLineNumber, e.originalEndColumn), new Te(e.modifiedStartLineNumber, e.modifiedStartColumn, e.modifiedEndLineNumber, e.modifiedEndColumn))));
			...
			return l(() => u(i, (e, t) => t.original.startLineNumber - e.original.endLineNumberExclusive === t.modified.startLineNumber - e.modified.endLineNumberExclusive && e.original.endLineNumberExclusive < t.original.startLineNumber && e.modified.endLineNumberExclusive < t.modified.startLineNumber)), new _r(i, [], r.quitEarly);
		}
	};
	function zr(e, t, n, r) {
	...
	var Hr = class {
		constructor(e) {
			const t = [], n = [];
			for (let r = 0, i = e.length; r < i; r++) t[r] = Jr(e[r], 1), n[r] = Yr(e[r], 1);
		...
		constructor(e, t, n) {
			this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = t, this.original = new Hr(e), this.modified = new Hr(t), this.continueLineDiff = Zr(n.maxComputationTime), this.continueCharDiff = Zr(0 === n.maxComputationTime ? 0 : Math.min(n.maxComputationTime, 5e3));
		}
		computeDiff() {
			...
			if (this.shouldIgnoreTrimWhitespace) {
				const e = [];
				for (let n = 0, r = t.length; n < r; n++) e.push(Xr.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[n], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
				return {
					quitEarly: n,
					changes: e
				};
			...
			for (let o = -1, a = t.length; o < a; o++) {
				...
				e && (r.push(Xr.createFromDiffResult(this.shouldIgnoreTrimWhitespace, e, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += e.originalLength, s += e.modifiedLength);
			}
			return {
				quitEarly: n,
				changes: r
		...
		_pushTrimWhitespaceCharChange(e, t, n, r, i, s, o) {
			...
			let a;
			this.shouldComputeCharChanges && (a = [new Gr(t, n, t, r, i, s, i, o)]), e.push(new Xr(t, t, i, i, a));
		}
	...
	var ei = class e {
		static trivial(t, n) {
			return new e([new ti(vr.ofLength(t.length), vr.ofLength(n.length))], !1);
		}
		static trivialTimedOut(t, n) {
			return new e([new ti(vr.ofLength(t.length), vr.ofLength(n.length))], !0);
		}
		constructor(e, t) {
		...
		static fromOffsetPairs(t, n) {
			return new e(new vr(t.offset1, n.offset1), new vr(t.offset2, n.offset2));
		}
		static assertSorted(e) {
			let t;
			for (const n of e) {
	...
	var ai = class e {
		...
		compute(e, t, n = ri.instance, r) {
			...
			function h(e, t) {
				e + 1 === l && t + 1 === u || a.push(new ti(new vr(e + 1, l), new vr(t + 1, u))), l = e, u = t;
			}
			let c = e.length - 1, d = t.length - 1;
			for (; c >= 0 && d >= 0;) 3 === s.get(c, d) ? (h(c, d), c--, d--) : 1 === s.get(c, d) ? c-- : d--;
			return h(-1, -1), a.reverse(), new ei(a, !1);
		}
	}, ui = class {
		compute(e, t, n = ri.instance) {
			...
			a.set(0, s(0, 0));
			const l = new di();
			l.set(0, 0 === a.get(0) ? null : new hi(null, 0, 0, a.get(0)));
			let u = 0;
			e: for (;;) {
				...
				for (u = e; u <= t; u += 2) {
					...
					const d = s(h, c);
					a.set(u, d);
					const g = l.get(h === n ? u + 1 : u - 1);
					if (l.set(u, d !== h ? new hi(g, h, c, d - h) : g), a.get(u) === r.length && a.get(u) - u === i.length) break e;
				}
			}
			let h = l.get(u);
			const c = [];
			...
			for (;;) {
				...
				if (e === d && t === g || c.push(new ti(new vr(e, d), new vr(t, g))), !h) break;
				d = h.x, g = h.y, h = h.prev;
			}
			return c.reverse(), new ei(c, !1);
		}
	}, hi = class {
		constructor(e, t, n, r) {
		...
		getBoundaryScore(e) {
			const t = wi(e > 0 ? this.elements[e - 1] : -1), n = wi(e < this.elements.length ? this.elements[e] : -1);
			if (7 === t && 8 === n) return 0;
			if (8 === t) return 150;
			let r = 0;
		...
		translateOffset(e, t = "right") {
			const n = Er(this.firstElementOffsetByLineIdx, (t) => t <= e), r = e - this.firstElementOffsetByLineIdx[n];
			return new Ie(this.range.startLineNumber + n, 1 + this.lineStartOffsets[n] + r + (0 === r && "left" === t ? 0 : this.trimmedWsLengthsByLineIdx[n]));
		}
		translateRange(e) {
			const t = this.translateOffset(e.start, "right"), n = this.translateOffset(e.endExclusive, "left");
			return n.isBefore(t) ? Te.fromPositions(n, n) : Te.fromPositions(t, n);
		}
		...
		findSubWordContaining(e) {
			...
			if (!mi(this.elements[e])) return;
			let t = e;
			for (; t > 0 && mi(this.elements[t - 1]) && !fi(this.elements[t]);) t--;
			let n = e;
			for (; n < this.elements.length && mi(this.elements[n]) && !fi(this.elements[n]);) n++;
			return new vr(t, n);
		}
		countLinesIn(e) {
		...
		extendToFullLines(e) {
			return new vr(Nr(this.firstElementOffsetByLineIdx, (t) => t <= e.start) ?? 0, function(t) {
				const n = Sr(t, (t) => e.endExclusive <= t);
	...
	function _i(e, t, n) {
		...
		const r = new ui().compute(new gi([e], new Te(1, 1, 1, e.length), !1), new gi([t], new Te(1, 1, 1, t.length), !1), n);
		let i = 0;
	...
	function Ci(e, t, n) {
		let r = n;
		return r = yi(e, t, r), r = yi(e, t, r), r = function(e, t, n) {
			if (!e.getBoundaryScore || !t.getBoundaryScore) return n;
			for (let r = 0; r < n.length; r++) {
				const i = r > 0 ? n[r - 1] : void 0, s = n[r], o = r + 1 < n.length ? n[r + 1] : void 0, a = new vr(i ? i.seq1Range.endExclusive + 1 : 0, o ? o.seq1Range.start - 1 : e.length), l = new vr(i ? i.seq2Range.endExclusive + 1 : 0, o ? o.seq2Range.start - 1 : t.length);
				s.seq1Range.isEmpty ? n[r] = Li(s, e, t, a, l) : s.seq2Range.isEmpty && (n[r] = Li(s.swap(), t, e, l, a).swap());
			}
			return n;
		}(e, t, r), r;
	}
	function yi(e, t, n) {
		...
		for (let s = 1; s < n.length; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				if (s--, s === n) {
					r[r.length - 1] = new ti(new vr(i.seq1Range.start, o.seq1Range.endExclusive - n), new vr(i.seq2Range.start, o.seq2Range.endExclusive - n));
					continue;
				}
				o = o.delta(-s);
			}
		...
		for (let s = 0; s < r.length - 1; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				if (a === i) {
					r[s + 1] = new ti(new vr(o.seq1Range.start + i, n.seq1Range.endExclusive), new vr(o.seq2Range.start + i, n.seq2Range.endExclusive));
					continue;
				}
				a > 0 && (o = o.delta(a));
			}
	...
	var Ni = class {
		...
		getBoundaryScore(e) {
			return 1e3 - ((0 === e ? 0 : Ei(this.lines[e - 1])) + (e === this.lines.length ? 0 : Ei(this.lines[e])));
		}
		getText(e) {
	...
	var Si = class {
		...
		computeDiff(e, t, n) {
			if (e.length <= 1 && function(e, t, n = (e, t) => e === t) {
				...
				return !0;
			}(e, t, (e, t) => e === t)) return new _r([], [], !1);
			if (1 === e.length && 0 === e[0].length || 1 === t.length && 0 === t[0].length) return new _r([new Br(new xr(1, e.length + 1), new xr(1, t.length + 1), [new Ur(new Te(1, 1, e.length, e[e.length - 1].length + 1), new Te(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
			...
			const a = e.map((e) => o(e.trim())), u = t.map((e) => o(e.trim())), h = new Ni(a, e), c = new Ni(u, t), d = (() => h.length + c.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, c, r, (n, r) => e[n] === t[r] ? 0 === t[r].length ? .1 : 1 + Math.log(1 + t[r].length) : .99) : this.myersDiffingAlgorithm.compute(h, c, r))();
			let g = d.diffs, m = d.hitTimeout;
			g = Ci(h, c, g), g = function(e, t, n) {
				let r = n;
				...
				do {
					...
					for (let a = 1; a < r.length; a++) {
						...
						function h(t, n) {
							const r = new vr(u.seq1Range.endExclusive, l.seq1Range.start);
			...
			const f = [], p = (s) => {
				if (i) for (let o = 0; o < s; o++) {
					const s = b + o, a = w + o;
					if (e[s] !== t[a]) {
						const o = this.refineDiff(e, t, new ti(new vr(s, s + 1), new vr(a, a + 1)), r, i, n);
			...
			return function(e, t, n, r, i, s) {
				let { moves: o, excludedChanges: a } = function(e, t, n, r) {
					...
					for (const l of s) {
						...
						if (t > .9 && e && (o.delete(e), i.push(new qr(l.range, e.range)), a.add(l.source), a.add(e.source)), !r.isValid()) return {
							moves: i,
							excludedChanges: a
						};
					}
				...
				const l = function(e, t, n, r, i, s) {
					const o = [], a = new ar();
					for (const g of e) for (let e = g.original.startLineNumber; e < g.original.endLineNumberExclusive - 2; e++) a.add(`${t[e - 1]}:${t[e + 1 - 1]}:${t[e + 2 - 1]}`, { range: new xr(e, e + 3) });
					const l = [];
					e.sort(yr((e) => e.modified.startLineNumber, Lr));
					for (const g of e) {
						let e = [];
						for (let t = g.modified.startLineNumber; t < g.modified.endLineNumberExclusive - 2; t++) {
							const r = `${n[t - 1]}:${n[t + 1 - 1]}:${n[t + 2 - 1]}`, i = new xr(t, t + 3), s = [];
							a.forEach(r, ({ range: t }) => {
								for (const r of e) if (r.originalLineRange.endLineNumberExclusive + 1 === t.endLineNumberExclusive && r.modifiedLineRange.endLineNumberExclusive + 1 === i.endLineNumberExclusive) return r.originalLineRange = new xr(r.originalLineRange.startLineNumber, t.endLineNumberExclusive), r.modifiedLineRange = new xr(r.modifiedLineRange.startLineNumber, i.endLineNumberExclusive), void s.push(r);
								const n = {
									modifiedLineRange: i,
									originalLineRange: t
								};
					...
					var u;
					l.sort((u = yr((e) => e.modifiedLineRange.length, Lr), (e, t) => -u(e, t)));
					const h = new Ar(), c = new Ar();
					for (const g of l) {
						...
						for (const i of r.ranges) {
							...
							o.push(new qr(n, t)), h.addRange(t), c.addRange(n);
						}
					}
					o.sort(yr((e) => e.original.startLineNumber, Lr));
					const d = new Rr(e);
					for (let g = 0; g < o.length; g++) {
						const t = o[g], n = d.findLastMonotonous((e) => e.original.startLineNumber <= t.original.startLineNumber), a = Nr(e, (e) => e.modified.startLineNumber <= t.modified.startLineNumber), l = Math.max(t.original.startLineNumber - n.original.startLineNumber, t.modified.startLineNumber - a.modified.startLineNumber), u = d.findLastMonotonous((e) => e.original.startLineNumber < t.original.endLineNumberExclusive), m = Nr(e, (e) => e.modified.startLineNumber < t.modified.endLineNumberExclusive), f = Math.max(u.original.endLineNumberExclusive - t.original.endLineNumberExclusive, m.modified.endLineNumberExclusive - t.modified.endLineNumberExclusive);
						let p, b;
						for (p = 0; p < l; p++) {
							...
							if (!_i(r[e - 1], i[n - 1], s)) break;
						}
						for (p > 0 && (c.addRange(new xr(t.original.startLineNumber - p, t.original.startLineNumber)), h.addRange(new xr(t.modified.startLineNumber - p, t.modified.startLineNumber))), b = 0; b < f; b++) {
							const e = t.original.endLineNumberExclusive + b, n = t.modified.endLineNumberExclusive + b;
							if (e > r.length || n > i.length) break;
							if (h.contains(n) || c.contains(e)) break;
							if (!_i(r[e - 1], i[n - 1], s)) break;
						}
						b > 0 && (c.addRange(new xr(t.original.endLineNumberExclusive, t.original.endLineNumberExclusive + b)), h.addRange(new xr(t.modified.endLineNumberExclusive, t.modified.endLineNumberExclusive + b))), (p > 0 || b > 0) && (o[g] = new qr(new xr(t.original.startLineNumber - p, t.original.endLineNumberExclusive + b), new xr(t.modified.startLineNumber - p, t.modified.endLineNumberExclusive + b)));
					}
					return o;
				...
				return function(e, t) {
					...
					e.sort(yr((e) => e.original.startLineNumber, Lr));
					const t = [e[0]];
					...
					const n = new Rr(e);
					return t.filter((t) => (n.findLastMonotonous((e) => e.original.startLineNumber < t.original.endLineNumberExclusive) || new qr(new xr(1, 1), new xr(1, 1))) !== Nr(e, (e) => e.modified.startLineNumber < t.modified.endLineNumberExclusive));
				}(e, o), o;
			}(e, t, n, r, i, s).map((e) => new Cr(e, $r(this.refineDiff(t, n, new ti(e.original.toOffsetRange(), e.modified.toOffsetRange()), s, o, a).mappings, new Fr(t), new Fr(n), !0)));
		}
		refineDiff(e, t, n, r, i, s) {
			const o = (a = n, new qr(new xr(a.seq1Range.start + 1, a.seq1Range.endExclusive + 1), new xr(a.seq2Range.start + 1, a.seq2Range.endExclusive + 1))).toRangeMapping2(e, t);
			var a;
			const l = new gi(e, o.originalRange, i), u = new gi(t, o.modifiedRange, i), h = l.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(l, u, r) : this.myersDiffingAlgorithm.compute(l, u, r);
			let c = h.diffs;
			return c = Ci(l, u, c), c = vi(l, u, c, (e, t) => e.findWordContaining(t)), s.extendToSubwords && (c = vi(l, u, c, (e, t) => e.findSubWordContaining(t), !0)), c = function(e, t, n) {
				const r = [];
				for (const i of n) {
				...
				do {
					...
					for (let l = 1; l < r.length; l++) {
						...
						function c(n, r) {
							const i = new vr(h.seq1Range.endExclusive, u.seq1Range.start);
				...
				return function(e, t) {
					...
					const a = e.extendToFullLines(n.seq1Range), l = e.getText(new vr(a.start, n.seq1Range.start));
					s(l) && (i = i.deltaStart(-l.length));
					const u = e.getText(new vr(n.seq1Range.endExclusive, a.endExclusive));
					s(u) && (i = i.deltaEnd(u.length));
					const h = ti.fromOffsetPairs(t ? t.getEndExclusives() : ni.zero, r ? r.getStarts() : ni.max), c = i.intersect(h);
					o.length > 0 && c.getStarts().equals(o[o.length - 1].getEndExclusives()) ? o[o.length - 1] = o[o.length - 1].join(c) : o.push(c);
				}), o;
			}(l, u, c), {
				mappings: c.map((e) => new Ur(l.translateRange(e.seq1Range), u.translateRange(e.seq2Range))),
	...
	var xi = class {
		constructor(e, t, n, r = 1) {
			this._rgbaBrand = void 0, this.r = 0 | Math.min(255, Math.max(0, e)), this.g = 0 | Math.min(255, Math.max(0, t)), this.b = 0 | Math.min(255, Math.max(0, n)), this.a = Ri(Math.max(Math.min(1, r), 0), 3);
		}
		static equals(e, t) {
		...
		constructor(e, t, n, r) {
			this._hslaBrand = void 0, this.h = 0 | Math.max(Math.min(360, e), 0), this.s = Ri(Math.max(Math.min(1, t), 0), 3), this.l = Ri(Math.max(Math.min(1, n), 0), 3), this.a = Ri(Math.max(Math.min(1, r), 0), 3);
		}
		static equals(e, t) {
		...
		static toRGBA(t) {
			...
			return new xi(Math.round(255 * o), Math.round(255 * a), Math.round(255 * l), s);
		}
	}, ki = class e {
		constructor(e, t, n, r) {
			this._hsvaBrand = void 0, this.h = 0 | Math.max(Math.min(360, e), 0), this.s = Ri(Math.max(Math.min(1, t), 0), 3), this.v = Ri(Math.max(Math.min(1, n), 0), 3), this.a = Ri(Math.max(Math.min(1, r), 0), 3);
		}
		static equals(e, t) {
		...
		static toRGBA(e) {
			...
			return t < 60 ? (l = s, u = o) : t < 120 ? (l = o, u = s) : t < 180 ? (u = s, h = o) : t < 240 ? (u = o, h = s) : t < 300 ? (l = o, h = s) : t <= 360 && (l = s, h = o), l = Math.round(255 * (l + a)), u = Math.round(255 * (u + a)), h = Math.round(255 * (h + a)), new xi(l, u, h, i);
		}
	}, Mi = class e {
		static fromHex(t) {
		...
		get hsla() {
			return this._hsla ? this._hsla : Ai.fromRGBA(this.rgba);
		}
		get hsva() {
		...
		constructor(e) {
			...
			if (e instanceof xi) this.rgba = e;
			else if (e instanceof Ai) this._hsla = e, this.rgba = Ai.toRGBA(e);
			else {
				if (!(e instanceof ki)) throw new Error("Invalid color ctor argument");
				this._hsva = e, this.rgba = ki.toRGBA(e);
			}
		}
		equals(e) {
			return !!e && xi.equals(this.rgba, e.rgba) && Ai.equals(this.hsla, e.hsla) && ki.equals(this.hsva, e.hsva);
		}
		getRelativeLuminance() {
			return Ri(.2126 * e._relativeLuminanceForComponent(this.rgba.r) + .7152 * e._relativeLuminanceForComponent(this.rgba.g) + .0722 * e._relativeLuminanceForComponent(this.rgba.b), 4);
		}
		...
		lighten(t) {
			return new e(new Ai(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
		}
		darken(t) {
			return new e(new Ai(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
		}
		...
		opposite() {
			return new e(new xi(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
		}
		mix(t, n = .5) {
			const r = Math.min(Math.max(n, 0), 1), i = this.rgba, s = t.rgba;
			return new e(new xi(i.r + (s.r - i.r) * r, i.g + (s.g - i.g) * r, i.b + (s.b - i.b) * r, i.a + (s.a - i.a) * r));
		}
		makeOpaque(t) {
			if (this.isOpaque() || 1 !== t.rgba.a) return this;
			const { r: n, g: r, b: i, a: s } = this.rgba;
			return new e(new xi(t.rgba.r - s * (t.rgba.r - n), t.rgba.g - s * (t.rgba.g - r), t.rgba.b - s * (t.rgba.b - i), 1));
		}
		toString() {
		...
		static {
			this.white = new e(new xi(255, 255, 255, 1));
		}
		static {
			this.black = new e(new xi(0, 0, 0, 1));
		}
		static {
			this.red = new e(new xi(255, 0, 0, 1));
		}
		static {
			this.blue = new e(new xi(0, 0, 255, 1));
		}
		static {
			this.green = new e(new xi(0, 255, 0, 1));
		}
		static {
			this.cyan = new e(new xi(0, 255, 255, 1));
		}
		static {
			this.lightgrey = new e(new xi(211, 211, 211, 1));
		}
		static {
			this.transparent = new e(new xi(0, 0, 0, 0));
		}
	};
	function Oi(e) {
		const t = [];
	...
	function Pi(e, t) {
		if (!e) return;
		const n = Mi.Format.CSS.parseHex(t);
		return n ? {
			range: e,
			color: Ii(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
		} : void 0;
	}
	function Fi(e, t, n) {
		if (!e || 1 !== t.length) return;
		const r = Oi(t[0].values());
		return {
			range: e,
			color: Ii(r[0], r[1], r[2], n ? r[3] : 1)
		};
	}
	function Di(e, t, n) {
		if (!e || 1 !== t.length) return;
		const r = Oi(t[0].values()), i = new Mi(new Ai(r[0], r[1] / 100, r[2] / 100, n ? r[3] : 1));
		return {
			range: e,
			color: Ii(i.rgba.r, i.rgba.g, i.rgba.b, i.rgba.a)
		};
	}
	function qi(e, t) {
	...
	(function(e) {
		...
		(function(t) {
			...
			function r(t) {
				...
				if (7 === n) return new e(new xi(16 * i(t.charCodeAt(1)) + i(t.charCodeAt(2)), 16 * i(t.charCodeAt(3)) + i(t.charCodeAt(4)), 16 * i(t.charCodeAt(5)) + i(t.charCodeAt(6)), 1));
				if (9 === n) return new e(new xi(16 * i(t.charCodeAt(1)) + i(t.charCodeAt(2)), 16 * i(t.charCodeAt(3)) + i(t.charCodeAt(4)), 16 * i(t.charCodeAt(5)) + i(t.charCodeAt(6)), (16 * i(t.charCodeAt(7)) + i(t.charCodeAt(8))) / 255));
				if (4 === n) {
					const n = i(t.charCodeAt(1)), r = i(t.charCodeAt(2)), s = i(t.charCodeAt(3));
					return new e(new xi(16 * n + n, 16 * r + r, 16 * s + s));
				}
				if (5 === n) {
					const n = i(t.charCodeAt(1)), r = i(t.charCodeAt(2)), s = i(t.charCodeAt(3)), o = i(t.charCodeAt(4));
					return new e(new xi(16 * n + n, 16 * r + r, 16 * s + s, (16 * o + o) / 255));
				}
				return null;
			}
			function i(e) {
			...
			t.formatRGB = function(t) {
				...
				if (t.startsWith("rgba(")) {
					...
					return new e(new xi(parseInt(n.groups?.r ?? "0"), parseInt(n.groups?.g ?? "0"), parseInt(n.groups?.b ?? "0"), parseFloat(n.groups?.a ?? "0")));
				}
				if (t.startsWith("rgb(")) {
					const n = t.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
					if (!n) throw new Error("Invalid color format " + t);
					return new e(new xi(parseInt(n.groups?.r ?? "0"), parseInt(n.groups?.g ?? "0"), parseInt(n.groups?.b ?? "0")));
				}
				return function(t) {
					switch (t) {
						case "aliceblue": return new e(new xi(240, 248, 255, 1));
						case "antiquewhite": return new e(new xi(250, 235, 215, 1));
						case "aqua":
						case "cyan": return new e(new xi(0, 255, 255, 1));
						case "aquamarine": return new e(new xi(127, 255, 212, 1));
						case "azure": return new e(new xi(240, 255, 255, 1));
						case "beige": return new e(new xi(245, 245, 220, 1));
						case "bisque": return new e(new xi(255, 228, 196, 1));
						case "black": return new e(new xi(0, 0, 0, 1));
						case "blanchedalmond": return new e(new xi(255, 235, 205, 1));
						case "blue": return new e(new xi(0, 0, 255, 1));
						case "blueviolet": return new e(new xi(138, 43, 226, 1));
						case "brown": return new e(new xi(165, 42, 42, 1));
						case "burlywood": return new e(new xi(222, 184, 135, 1));
						case "cadetblue": return new e(new xi(95, 158, 160, 1));
						case "chartreuse": return new e(new xi(127, 255, 0, 1));
						case "chocolate": return new e(new xi(210, 105, 30, 1));
						case "coral": return new e(new xi(255, 127, 80, 1));
						case "cornflowerblue": return new e(new xi(100, 149, 237, 1));
						case "cornsilk": return new e(new xi(255, 248, 220, 1));
						case "crimson": return new e(new xi(220, 20, 60, 1));
						case "darkblue": return new e(new xi(0, 0, 139, 1));
						case "darkcyan": return new e(new xi(0, 139, 139, 1));
						case "darkgoldenrod": return new e(new xi(184, 134, 11, 1));
						case "darkgray":
						case "darkgrey": return new e(new xi(169, 169, 169, 1));
						case "darkgreen": return new e(new xi(0, 100, 0, 1));
						case "darkkhaki": return new e(new xi(189, 183, 107, 1));
						case "darkmagenta": return new e(new xi(139, 0, 139, 1));
						case "darkolivegreen": return new e(new xi(85, 107, 47, 1));
						case "darkorange": return new e(new xi(255, 140, 0, 1));
						case "darkorchid": return new e(new xi(153, 50, 204, 1));
						case "darkred": return new e(new xi(139, 0, 0, 1));
						case "darksalmon": return new e(new xi(233, 150, 122, 1));
						case "darkseagreen": return new e(new xi(143, 188, 143, 1));
						case "darkslateblue": return new e(new xi(72, 61, 139, 1));
						case "darkslategray":
						case "darkslategrey": return new e(new xi(47, 79, 79, 1));
						case "darkturquoise": return new e(new xi(0, 206, 209, 1));
						case "darkviolet": return new e(new xi(148, 0, 211, 1));
						case "deeppink": return new e(new xi(255, 20, 147, 1));
						case "deepskyblue": return new e(new xi(0, 191, 255, 1));
						case "dimgray":
						case "dimgrey": return new e(new xi(105, 105, 105, 1));
						case "dodgerblue": return new e(new xi(30, 144, 255, 1));
						case "firebrick": return new e(new xi(178, 34, 34, 1));
						case "floralwhite": return new e(new xi(255, 250, 240, 1));
						case "forestgreen": return new e(new xi(34, 139, 34, 1));
						case "fuchsia":
						case "magenta": return new e(new xi(255, 0, 255, 1));
						case "gainsboro": return new e(new xi(220, 220, 220, 1));
						case "ghostwhite": return new e(new xi(248, 248, 255, 1));
						case "gold": return new e(new xi(255, 215, 0, 1));
						case "goldenrod": return new e(new xi(218, 165, 32, 1));
						case "gray":
						case "grey": return new e(new xi(128, 128, 128, 1));
						case "green": return new e(new xi(0, 128, 0, 1));
						case "greenyellow": return new e(new xi(173, 255, 47, 1));
						case "honeydew": return new e(new xi(240, 255, 240, 1));
						case "hotpink": return new e(new xi(255, 105, 180, 1));
						case "indianred": return new e(new xi(205, 92, 92, 1));
						case "indigo": return new e(new xi(75, 0, 130, 1));
						case "ivory": return new e(new xi(255, 255, 240, 1));
						case "khaki": return new e(new xi(240, 230, 140, 1));
						case "lavender": return new e(new xi(230, 230, 250, 1));
						case "lavenderblush": return new e(new xi(255, 240, 245, 1));
						case "lawngreen": return new e(new xi(124, 252, 0, 1));
						case "lemonchiffon": return new e(new xi(255, 250, 205, 1));
						case "lightblue": return new e(new xi(173, 216, 230, 1));
						case "lightcoral": return new e(new xi(240, 128, 128, 1));
						case "lightcyan": return new e(new xi(224, 255, 255, 1));
						case "lightgoldenrodyellow": return new e(new xi(250, 250, 210, 1));
						case "lightgray":
						case "lightgrey": return new e(new xi(211, 211, 211, 1));
						case "lightgreen": return new e(new xi(144, 238, 144, 1));
						case "lightpink": return new e(new xi(255, 182, 193, 1));
						case "lightsalmon": return new e(new xi(255, 160, 122, 1));
						case "lightseagreen": return new e(new xi(32, 178, 170, 1));
						case "lightskyblue": return new e(new xi(135, 206, 250, 1));
						case "lightslategray":
						case "lightslategrey": return new e(new xi(119, 136, 153, 1));
						case "lightsteelblue": return new e(new xi(176, 196, 222, 1));
						case "lightyellow": return new e(new xi(255, 255, 224, 1));
						case "lime": return new e(new xi(0, 255, 0, 1));
						case "limegreen": return new e(new xi(50, 205, 50, 1));
						case "linen": return new e(new xi(250, 240, 230, 1));
						case "maroon": return new e(new xi(128, 0, 0, 1));
						case "mediumaquamarine": return new e(new xi(102, 205, 170, 1));
						case "mediumblue": return new e(new xi(0, 0, 205, 1));
						case "mediumorchid": return new e(new xi(186, 85, 211, 1));
						case "mediumpurple": return new e(new xi(147, 112, 219, 1));
						case "mediumseagreen": return new e(new xi(60, 179, 113, 1));
						case "mediumslateblue": return new e(new xi(123, 104, 238, 1));
						case "mediumspringgreen": return new e(new xi(0, 250, 154, 1));
						case "mediumturquoise": return new e(new xi(72, 209, 204, 1));
						case "mediumvioletred": return new e(new xi(199, 21, 133, 1));
						case "midnightblue": return new e(new xi(25, 25, 112, 1));
						case "mintcream": return new e(new xi(245, 255, 250, 1));
						case "mistyrose": return new e(new xi(255, 228, 225, 1));
						case "moccasin": return new e(new xi(255, 228, 181, 1));
						case "navajowhite": return new e(new xi(255, 222, 173, 1));
						case "navy": return new e(new xi(0, 0, 128, 1));
						case "oldlace": return new e(new xi(253, 245, 230, 1));
						case "olive": return new e(new xi(128, 128, 0, 1));
						case "olivedrab": return new e(new xi(107, 142, 35, 1));
						case "orange": return new e(new xi(255, 165, 0, 1));
						case "orangered": return new e(new xi(255, 69, 0, 1));
						case "orchid": return new e(new xi(218, 112, 214, 1));
						case "palegoldenrod": return new e(new xi(238, 232, 170, 1));
						case "palegreen": return new e(new xi(152, 251, 152, 1));
						case "paleturquoise": return new e(new xi(175, 238, 238, 1));
						case "palevioletred": return new e(new xi(219, 112, 147, 1));
						case "papayawhip": return new e(new xi(255, 239, 213, 1));
						case "peachpuff": return new e(new xi(255, 218, 185, 1));
						case "peru": return new e(new xi(205, 133, 63, 1));
						case "pink": return new e(new xi(255, 192, 203, 1));
						case "plum": return new e(new xi(221, 160, 221, 1));
						case "powderblue": return new e(new xi(176, 224, 230, 1));
						case "purple": return new e(new xi(128, 0, 128, 1));
						case "rebeccapurple": return new e(new xi(102, 51, 153, 1));
						case "red": return new e(new xi(255, 0, 0, 1));
						case "rosybrown": return new e(new xi(188, 143, 143, 1));
						case "royalblue": return new e(new xi(65, 105, 225, 1));
						case "saddlebrown": return new e(new xi(139, 69, 19, 1));
						case "salmon": return new e(new xi(250, 128, 114, 1));
						case "sandybrown": return new e(new xi(244, 164, 96, 1));
						case "seagreen": return new e(new xi(46, 139, 87, 1));
						case "seashell": return new e(new xi(255, 245, 238, 1));
						case "sienna": return new e(new xi(160, 82, 45, 1));
						case "silver": return new e(new xi(192, 192, 192, 1));
						case "skyblue": return new e(new xi(135, 206, 235, 1));
						case "slateblue": return new e(new xi(106, 90, 205, 1));
						case "slategray":
						case "slategrey": return new e(new xi(112, 128, 144, 1));
						case "snow": return new e(new xi(255, 250, 250, 1));
						case "springgreen": return new e(new xi(0, 255, 127, 1));
						case "steelblue": return new e(new xi(70, 130, 180, 1));
						case "tan": return new e(new xi(210, 180, 140, 1));
						case "teal": return new e(new xi(0, 128, 128, 1));
						case "thistle": return new e(new xi(216, 191, 216, 1));
						case "tomato": return new e(new xi(255, 99, 71, 1));
						case "turquoise": return new e(new xi(64, 224, 208, 1));
						case "violet": return new e(new xi(238, 130, 238, 1));
						case "wheat": return new e(new xi(245, 222, 179, 1));
						case "white": return new e(new xi(255, 255, 255, 1));
						case "whitesmoke": return new e(new xi(245, 245, 245, 1));
						case "yellow": return new e(new xi(255, 255, 0, 1));
						case "yellowgreen": return new e(new xi(154, 205, 50, 1));
						default: return null;
					}
				}(t);
			}, t.parseHex = r;
	...
	var zi = class {
		...
		constructor(e, t) {
			this._onReturn = t, this._producerConsumer = new zi(), this._iterator = {
		...
		setValue(e, t) {
			return e = Fe(e), t = Fe(t), this.values[e] !== t && (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0);
		}
		removeValues(e, t) {
			e = Fe(e), t = Fe(t);
		...
		getPrefixSum(e) {
			return e < 0 ? 0 : (e = Fe(e), this._getPrefixSum(e));
		}
		_getPrefixSum(e) {
		...
		$acceptNewModel(e) {
			this._models[e.url] = new Qi(xt.parse(e.url), e.lines, e.EOL, e.versionId);
		}
		...
		findMatches(e) {
			...
			for (let n = 0; n < this._lines.length; n++) {
				const r = this._lines[n], i = this.offsetAt(new Ie(n + 1, 1)), s = r.matchAll(e);
		...
		getWordAtPosition(e, t) {
			const n = gr(e.column, cr(t), this._lines[e.lineNumber - 1], 0);
			return n ? new Te(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn) : null;
		}
		words(e) {
		...
		constructor(e = null) {
			this._foreignModule = e, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new Xi();
		}
		dispose() {}
		async $ping() {
			return "pong";
		...
		async $computeUnicodeHighlights(e, t, n) {
			...
			return r ? fr.computeUnicodeHighlights(r, t, n) : {
				ranges: [],
				hasMore: !1,
							...
							for (s.lastIndex = 0; null !== (l = s.exec(o));) {
								const e = o.substring(0, l.index), t = a + (e.match(/\n/g) || []).length, r = l[0].split("\n"), i = r.length, u = t + i - 1, h = e.lastIndexOf("\n") + 1, c = l.index - h + 1, d = {
									range: {
										...
										startColumn: c,
										endLineNumber: u,
										endColumn: 1 === i ? c + l[0].length : r[r.length - 1].length + 1
									},
									text: (l.groups ?? {}).label ?? "",
		...
		static computeDiff(e, t, n, r) {
			const i = "advanced" === r ? new Si() : new Wr(), s = e.getLinesContent(), o = t.getLinesContent(), a = i.computeDiff(s, o, n);
			function l(e) {
				return e.map((e) => [
		...
		async $computeMoreMinimalEdits(t, n, r) {
			...
			const s = [];
			let o;
			n = n.slice(0).sort((e, t) => e.range && t.range ? Te.compareRangesUsingStarts(e.range, t.range) : (e.range ? 0 : 1) - (t.range ? 0 : 1));
			let a = 0;
			for (let e = 1; e < n.length; e++) Te.getEndPosition(n[a].range).equals(Te.getStartPosition(n[e].range)) ? (n[a].range = Te.fromPositions(Te.getStartPosition(n[a].range), Te.getEndPosition(n[e].range)), n[a].text += n[e].text) : (a++, n[a] = n[e]);
			n.length = a + 1;
			for (let { range: l, text: u, eol: h } of n) {
				if ("number" == typeof h && (o = h), Te.isEmpty(l) && !u) continue;
				...
				const n = xe(t, u, r), a = i.offsetAt(Te.lift(l).getStartPosition());
				for (const e of n) {
		...
		async $computeLinks(e) {
			...
			return t ? function(e) {
				return e && "function" == typeof e.getLineCount && "function" == typeof e.getLineContent ? Ue.computeLinks(e) : [];
			}(t) : null;
		}
			...
			return t ? function(e) {
				return e && "function" == typeof e.getValue && "function" == typeof e.positionAt ? function(e) {
					...
					if (n.length > 0) for (const r of n) {
						...
						if (!s) continue;
						let o;
						"rgb" === i ? o = Fi(Ti(e, r), qi(s, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm), !1) : "rgba" === i ? o = Fi(Ti(e, r), qi(s, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm), !0) : "hsl" === i ? o = Di(Ti(e, r), qi(s, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm), !1) : "hsla" === i ? o = Di(Ti(e, r), qi(s, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm), !0) : "#" === i && (o = Pi(Ti(e, r), i + s)), o && t.push(o);
					}
					return t;
				}(e) : [];
			}(t) : null;
		...
		async $navigateValueSet(e, t, n, r, i) {
			...
			return $e.INSTANCE.navigateValueSet(t, a, l, u, n);
		}
		$fmr(e, t) {
	...
	"function" == typeof importScripts && (globalThis.monaco = {
		...
		CancellationTokenSource: class {
			...
			cancel() {
				this._token ? this._token instanceof He && this._token.cancel() : this._token = ze.Cancelled;
			}
			dispose(e = !1) {
				e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof He && this._token.dispose() : this._token = ze.None;
			}
		},
		Emitter: R,
		KeyCode: Nn,
	...
	self.onmessage = () => {
		(function() {
			...
			(function(e) {
				...
				const n = Yi.getChannel(t);
				return new Proxy({}, { get(e, t, r) {
					if ("then" !== t) {
