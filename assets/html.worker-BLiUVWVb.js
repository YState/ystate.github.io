(function() {
	const e = new class {
		constructor() {
			this.listeners = [], this.unexpectedErrorHandler = function(e) {
				setTimeout(() => {
					if (e.stack) {
						if (o.isErrorNoTelemetry(e)) throw new o(e.message + "\n\n" + e.stack);
	...
	function n(e) {
		if (e instanceof Error) {
			...
			return {
				...
				noTelemetry: o.isErrorNoTelemetry(e),
				cause: r ? n(r) : void 0,
				code: e.code
			};
		}
	...
	var p = class e {
		...
		add(t) {
			...
			return this._isDisposed ? e.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
		}
		delete(e) {
			if (e) {
	...
	(function(e) {
		...
		function o(e, t, n = 100, i = !1, r = !1, o, a) {
			let s, l, c, h, d = 0;
			const u = new C({
		...
		e.None = () => g.None, e.defer = function(e, t) {
			...
			return (t, n = null, i) => {
				return r = function(...e) {
					return m(() => d(e));
				}(...e.map((e) => e((e) => t.call(n, e)))), (o = i) instanceof Array ? o.push(r) : o && o.add(r), r;
				var r, o;
			};
		}, e.reduce = function(e, t, i, r) {
			let o = i;
			return n(e, (e) => (o = t(o, e), o), r);
		}, e.debounce = o, e.accumulate = function(t, n = 0, i) {
		...
		e.fromObservable = function(e, t) {
			...
			return (t, n, i) => {
				...
				const a = {
					...
					endUpdate() {
						r--, 0 === r && (e.reportChanges(), o && (o = !1, t.call(n)));
					},
	...
	var y = class e {
		...
		get event() {
			return this._event ??= (e, n, i) => {
				if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
					...
					console.warn(e);
					const n = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], i = new L(`${e}. HINT: Stack shows most frequent listener (${n[1]}-times)`, n[0]);
		...
		_removeListener(e) {
			...
			if (-1 === n) throw console.log("disposed?", this._disposed), console.log("size?", this._size), console.log("arr?", JSON.stringify(this._listeners)), /* @__PURE__ */ new Error("Attempted to dispose unknown listener");
	...
	const D = globalThis;
	let W;
	void 0 !== D.vscode && void 0 !== D.vscode.process ? W = D.vscode.process : "undefined" != typeof process && "string" == typeof process?.versions?.node && (W = process);
	const P = "string" == typeof W?.versions?.electron && "renderer" === W?.type;
	if ("object" == typeof W) {
		I = "win32" === W.platform, z = "darwin" === W.platform, W.platform;
		const e = W.env.VSCODE_NLS_CONFIG;
		if (e) try {
			JSON.parse(e).resolvedLanguage;
		} catch (dl) {}
	} else "object" != typeof navigator || P ? console.error("Unable to resolve platform.") : (N = navigator.userAgent, I = N.indexOf("Windows") >= 0, z = N.indexOf("Macintosh") >= 0, (N.indexOf("Macintosh") >= 0 || N.indexOf("iPad") >= 0 || N.indexOf("iPhone") >= 0) && navigator.maxTouchPoints, N.indexOf("Linux"), N?.indexOf("Mobi"), A(), navigator.language.toLowerCase());
	const F = I, V = z, B = N, K = "function" == typeof D.postMessage && !D.importScripts;
	(() => {
		if (K) {
			const e = [];
			...
			return (n) => {
				...
				e.push({
					id: i,
					callback: n
				}), D.postMessage({ vscodeScheduleAsyncWork: i }, "*");
			};
		}
		return (e) => setTimeout(e);
	})();
	const G = !!(B && B.indexOf("Chrome") >= 0);
	function $(e) {
		return e;
	}
	B && B.indexOf("Firefox"), !G && B && B.indexOf("Safari"), B && B.indexOf("Edg/"), B && B.indexOf("Android");
	var X, J = class {
		constructor(e, t) {
			this.lastCache = void 0, this.lastArgKey = void 0, "function" == typeof e ? (this._fn = e, this._computeKey = $) : (this._fn = t, this._computeKey = e.getCacheKey);
		}
		get(e) {
	...
	var Y = class {
		constructor(e) {
			this.executor = e, this._state = X.Uninitialized;
		}
		get value() {
			if (this._state === X.Uninitialized) {
				this._state = X.Running;
				try {
					this._value = this.executor();
				} catch (e) {
					this._error = e;
				} finally {
					this._state = X.Completed;
				}
			} else if (this._state === X.Running) throw new Error("Cannot read the value of a lazy that is being initialized");
	...
	var oe = class e {
		...
		static {
			this.cache = new J({ getCacheKey: JSON.stringify }, (t) => {
				...
				let o, a = t.filter((e) => !e.startsWith("_") && Object.hasOwn(r, e));
				0 === a.length && (a = ["_default"]);
				for (const e of a) o = i(o, n(r[e]));
		...
		static {
			this._locales = new Y(() => Object.keys(e.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")));
		}
		static getLocales() {
	...
	var le = class {
		...
		async sendMessage(e, t, n) {
			...
			return new Promise((r, o) => {
				this._pendingReplies[i] = {
					resolve: r,
					reject: o
				}, this._send(new le(this._workerId, i, e, t, n));
			});
		}
		listen(e, t, n) {
			let i = null;
			const r = new C({
				onWillAddFirstListener: () => {
					i = String(++this._lastSentReq), this._pendingEmitters.set(i, r), this._send(new he(this._workerId, i, e, t, n));
				},
				onDidRemoveLastListener: () => {
					this._pendingEmitters.delete(i), this._send(new ue(this._workerId, i)), i = null;
				}
			});
			return r.event;
		}
		...
		createProxyToRemoteChannel(e, t) {
			return new Proxy(Object.create(null), { get: (n, i) => ("string" != typeof i || n[i] || (ge(i) ? n[i] = (t) => this.listen(e, i, t) : pe(i) ? n[i] = this.listen(e, i, void 0) : 36 === i.charCodeAt(0) && (n[i] = async (...n) => (await t?.(), this.sendMessage(e, i, n)))), n[i]) });
		}
		_handleMessage(e) {
			switch (e.type) {
		...
		_handleRequestMessage(e) {
			...
			this._handler.handleMessage(e.channel, e.method, e.args).then((e) => {
				...
				e.detail instanceof Error && (e.detail = n(e.detail)), this._send(new ce(this._workerId, t, void 0, n(e)));
			});
		}
	...
	var fe = class {
		constructor(e, t) {
			this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new me({
				sendMessage: (t, n) => {
					e(t, n);
				},
		...
		_handleMessage(e, t, n) {
			if (e === se && "$initialize" === t) return this.initialize(n[0]);
			const i = e === se ? this.requestHandler : this._localChannels.get(e);
	...
	const we = "undefined" != typeof Buffer;
	let ve;
	new Y(() => new Uint8Array(256));
	var ye = class e {
		static wrap(t) {
			return we && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new e(t);
		}
		constructor(e) {
			this.buffer = e, this.byteLength = this.buffer.byteLength;
		}
		toString() {
			return we ? this.buffer.toString() : (ve || (ve = new TextDecoder()), ve.decode(this.buffer));
		}
	};
	...
	function Se(e, t) {
		t = ke(149417, t);
		for (let n = 0, i = e.length; n < i; n++) t = ke(e.charCodeAt(n), t);
		return t;
	}
	function Le(e, t, n = 32) {
		const i = n - t;
	...
	function xe(e, t = 32) {
		return e instanceof ArrayBuffer ? function({ buffer: e }) {
			...
			return t;
		}(ye.wrap(new Uint8Array(e))) : (e >>> 0).toString(16).padStart(t / 4, "0");
	}
	(class e {
		static {
		...
		update(e) {
			...
			if (0 === t) return;
			const n = this._buff;
			let i, r, o = this._buffLen, a = this._leftoverHighSurrogate;
			for (0 !== a ? (i = a, r = -1, a = 0) : (i = e.charCodeAt(0), r = 0);;) {
				let s = i;
				if (Z(i)) {
					if (!(r + 1 < t)) {
						a = i;
		...
		_step() {
			...
			for (let e = 64; e < 320; e += 4) t.setUint32(e, Le(t.getUint32(e - 12, !1) ^ t.getUint32(e - 32, !1) ^ t.getUint32(e - 56, !1) ^ t.getUint32(e - 64, !1), 1), !1);
			let i, r, o, a = this._h0, s = this._h1, l = this._h2, c = this._h3, h = this._h4;
			for (let e = 0; e < 80; e++) e < 20 ? (i = s & l | ~s & c, r = 1518500249) : e < 40 ? (i = s ^ l ^ c, r = 1859775393) : e < 60 ? (i = s & l | s & c | l & c, r = 2400959708) : (i = s ^ l ^ c, r = 3395469782), o = Le(a, 5) + i + h + r + t.getUint32(4 * e, !1) & 4294967295, h = c, c = l, l = Le(s, 30), s = a, a = o;
			this._h0 = this._h0 + a & 4294967295, this._h1 = this._h1 + s & 4294967295, this._h2 = this._h2 + l & 4294967295, this._h3 = this._h3 + c & 4294967295, this._h4 = this._h4 + h & 4294967295;
		}
	});
	var Ce = class {
		constructor(e) {
	...
	function Ee(e, t, n) {
		return new Ne(new Ce(e), new Ce(t)).ComputeDiff(n).changes;
	}
	var Ae = class {
		static Assert(e, t) {
		...
		MarkNextChange() {
			(this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new _e(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount)), this.m_originalCount = 0, this.m_modifiedCount = 0, this.m_originalStart = 1073741824, this.m_modifiedStart = 1073741824;
		}
		...
		constructor(t, n, i = null) {
			...
			const [r, o, a] = e._getElements(t), [s, l, c] = e._getElements(n);
			this._hasStrings = a && c, this._originalStringElements = r, this._originalElementsOrHash = o, this._modifiedStringElements = s, this._modifiedElementsOrHash = l, this.m_forwardHistory = [], this.m_reverseHistory = [];
		}
		...
		static _getElements(t) {
			...
			if (e._isStringArray(n)) {
				...
				for (let t = 0, i = n.length; t < i; t++) e[t] = Se(n[t], 0);
				return [
					n,
					e,
					!0
		...
		ComputeDiffRecursive(e, t, n, i, r) {
			...
			if (e > t || n > i) {
				let r;
				return n <= i ? (Ae.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), r = [new _e(e, 0, n, i - n + 1)]) : e <= t ? (Ae.Assert(n === i + 1, "modifiedStart should only be one more than modifiedEnd"), r = [new _e(e, t - e + 1, n, 0)]) : (Ae.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), Ae.Assert(n === i + 1, "modifiedStart should only be one more than modifiedEnd"), r = []), r;
			}
			const o = [0], a = [0], s = this.ComputeRecursionPoint(e, t, n, i, o, a, r), l = o[0], c = a[0];
			if (null !== s) return s;
			if (!r[0]) {
				const o = this.ComputeDiffRecursive(e, l, n, c, r);
				let a = [];
				return a = r[0] ? [new _e(l + 1, t - (l + 1) + 1, c + 1, i - (c + 1) + 1)] : this.ComputeDiffRecursive(l + 1, t, c + 1, i, r), this.ConcatenateChanges(o, a);
			}
			return [new _e(e, t - e + 1, n, i - n + 1)];
		}
		WALKTRACE(e, t, n, i, r, o, a, s, l, c, h, d, u, m, p, g, f, b) {
			let _ = null, w = null, v = new Me(), y = t, T = n, k = u[0] - g[0] - i, S = -1073741824, L = this.m_forwardHistory.length - 1;
			do {
				const t = k + e;
			...
			if (_ = v.getReverseChanges(), b[0]) {
				...
				w = [new _e(e, d - e + 1, t, p - t + 1)];
			} else {
				v = new Me(), y = o, T = a, k = u[0] - g[0] - s, S = 1073741824, L = f ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const e = k + r;
		...
		ComputeRecursionPoint(e, t, n, i, r, o, a) {
			...
			for (let T = 1; T <= m / 2 + 1; T++) {
				...
				for (let e = c; e <= h; e += 2) {
					...
					if (g[e] = s, s + l > m + k && (m = s, k = l), !y && Math.abs(e - _) <= T - 1 && s >= f[e]) return r[0] = s, o[0] = l, n <= f[e] && T <= 1448 ? this.WALKTRACE(b, c, h, w, _, d, u, v, g, f, s, t, r, l, i, o, y, a) : null;
				}
				const S = (m - e + (k - n) - T) / 2;
				if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(m, S)) return a[0] = !0, r[0] = m, o[0] = k, S > 0 && T <= 1448 ? this.WALKTRACE(b, c, h, w, _, d, u, v, g, f, s, t, r, l, i, o, y, a) : (e++, n++, [new _e(e, t - e + 1, n, i - n + 1)]);
				...
				for (let p = d; p <= u; p += 2) {
					...
					if (f[p] = s, y && Math.abs(p - b) <= T && s <= g[p]) return r[0] = s, o[0] = l, m >= g[p] && T <= 1448 ? this.WALKTRACE(b, c, h, w, _, d, u, v, g, f, s, t, r, l, i, o, y, a) : null;
				}
				if (T <= 1447) {
					let e = new Int32Array(h - c + 2);
					e[0] = b - c + 1, Re.Copy2(g, c, e, 1, h - c + 1), this.m_forwardHistory.push(e), e = new Int32Array(u - d + 2), e[0] = _ - d + 1, Re.Copy2(f, d, e, 1, u - d + 1), this.m_reverseHistory.push(e);
				}
			}
			return this.WALKTRACE(b, c, h, w, _, d, u, v, g, f, s, t, r, l, i, o, y, a);
		}
		PrettifyChanges(e) {
			for (let t = 0; t < e.length; t++) {
				const n = e[t], i = t < e.length - 1 ? e[t + 1].originalStart : this._originalElementsOrHash.length, r = t < e.length - 1 ? e[t + 1].modifiedStart : this._modifiedElementsOrHash.length, o = n.originalLength > 0, a = n.modifiedLength > 0;
				for (; n.originalStart + n.originalLength < i && n.modifiedStart + n.modifiedLength < r && (!o || this.OriginalElementsAreEqual(n.originalStart, n.originalStart + n.originalLength)) && (!a || this.ModifiedElementsAreEqual(n.modifiedStart, n.modifiedStart + n.modifiedLength));) {
			...
			if (this._hasStrings) for (let t = 1, n = e.length; t < n; t++) {
				const n = e[t - 1], i = e[t], r = i.originalStart - n.originalStart - n.originalLength, o = n.originalStart, a = i.originalStart + i.originalLength, s = a - o, l = n.modifiedStart, c = i.modifiedStart + i.modifiedLength, h = c - l;
				if (r < 5 && s < 20 && h < 20) {
					const e = this._findBetterContiguousSequence(o, s, l, h, r);
					if (e) {
						const [t, o] = e;
						t === n.originalStart + n.originalLength && o === n.modifiedStart + n.modifiedLength || (n.originalLength = t - n.originalStart, n.modifiedLength = o - n.modifiedStart, i.originalStart = t + r, i.modifiedStart = o + r, i.originalLength = a - i.originalStart, i.modifiedLength = c - i.modifiedStart);
					}
				}
			}
			return e;
		...
		_findBetterContiguousSequence(e, t, n, i, r) {
			...
			const o = e + t - r + 1, a = n + i - r + 1;
			let s = 0, l = 0, c = 0;
			for (let h = e; h < o; h++) for (let e = n; e < a; e++) {
		...
		ConcatenateChanges(e, t) {
			...
			if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
				...
				return Re.Copy(e, 0, i, 0, e.length - 1), i[e.length - 1] = n[0], Re.Copy(t, 1, i, e.length, t.length - 1), i;
			}
			{
				const n = new Array(e.length + t.length);
				return Re.Copy(e, 0, n, 0, e.length), Re.Copy(t, 0, n, e.length, t.length), n;
			}
		}
		ChangesOverlap(e, t, n) {
			if (Ae.Assert(e.originalStart <= t.originalStart, "Left change is not less than or equal to right change"), Ae.Assert(e.modifiedStart <= t.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= t.originalStart || e.modifiedStart + e.modifiedLength >= t.modifiedStart) {
				let i = e.originalLength, r = e.modifiedLength;
				return e.originalStart + e.originalLength >= t.originalStart && (i = t.originalStart + t.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= t.modifiedStart && (r = t.modifiedStart + t.modifiedLength - e.modifiedStart), n[0] = new _e(e.originalStart, i, e.modifiedStart, r), !0;
			}
			return n[0] = null, !1;
		}
	...
	var Fe = class e {
		static _createLink(e, t, n, i, r) {
			...
			if (i > 0) {
				const e = t.charCodeAt(i - 1), n = t.charCodeAt(o);
		...
		static computeLinks(t, n = function() {
			...
			const i = function() {
				if (null === qe) {
					qe = new He(0);
					const e = " 	<>'\"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|";
					for (let n = 0; n < 36; n++) qe.set(e.charCodeAt(n), 1);
					const t = ".,;:";
					for (let n = 0; n < 4; n++) qe.set(t.charCodeAt(n), 2);
				}
				return qe;
			}(), r = [];
			for (let o = 1, a = t.getLineCount(); o <= a; o++) {
				const a = t.getLineContent(o), s = a.length;
				let l = 0, c = 0, h = 0, d = 1, u = !1, m = !1, p = !1, g = !1;
				for (; l < s;) {
					let t = !1;
					const s = a.charCodeAt(l);
					if (13 === d) {
						let n;
						switch (s) {
							case 40:
						...
						1 === n && (r.push(e._createLink(i, a, o, c, l)), t = !0);
					} else if (12 === d) {
						let e;
				...
				13 === d && r.push(e._createLink(i, a, o, c, s));
			}
			return r;
		}
	}, Ve = class e {
	...
	const Be = Object.freeze(function(e, t) {
	...
	var je = class {
		...
		get onCancellationRequested() {
			return this._isCancelled ? Be : (this._emitter || (this._emitter = new C()), this._emitter.event);
		}
		dispose() {
	...
	const $e = new Ge(), Xe = new Ge(), Je = new Ge(), Ye = new Array(230), Qe = Object.create(null), Ze = Object.create(null), et = [];
	for (let ul = 0; ul <= 193; ul++) et[ul] = -1;
	var tt;
	let nt;
	(function() {
		const e = "", t = [
		...
		for (const r of t) {
			const [e, t, o, a, s, l, c, h, d] = r;
			if (i[t] || (i[t] = !0, Qe[o] = t, Ze[o.toLowerCase()] = t, e && (et[t] = a)), !n[a]) {
				if (n[a] = !0, !s) throw new Error(`String representation missing for key code ${a} around scan code ${o}`);
				$e.define(a, s), Xe.define(a, h || s), Je.define(a, d || h || s);
			}
			l && (Ye[l] = a);
		}
	})(), function(e) {
	...
	const it = globalThis.vscode;
	if (void 0 !== it && void 0 !== it.process) {
		const e = it.process;
		nt = {
			get platform() {
				return e.platform;
	...
	} else nt = "undefined" != typeof process && "string" == typeof process?.versions?.node ? {
		get platform() {
	...
	const rt = nt.cwd, ot = nt.env, at = nt.platform, st = 46, lt = 47, ct = 92, ht = 58;
	...
	function ut(e, t) {
		if ("string" != typeof e) throw new dt(t, "string", e);
	}
	const mt = "win32" === at;
	function pt(e) {
		return e === lt || e === ct;
		...
		for (let c = 0; c <= e.length; ++c) {
			...
			if (i(l)) {
				if (a === c - 1 || 1 === s);
					...
					if (r.length < 2 || 2 !== o || r.charCodeAt(r.length - 1) !== st || r.charCodeAt(r.length - 2) !== st) {
						if (r.length > 2) {
							const e = r.lastIndexOf(n);
							-1 === e ? (r = "", o = 0) : (r = r.slice(0, e), o = r.length - 1 - r.lastIndexOf(n)), a = c, s = 0;
							continue;
						}
						if (0 !== r.length) {
							r = "", o = 0, a = c, s = 0;
				...
				} else r.length > 0 ? r += `${n}${e.slice(a + 1, c)}` : r = e.slice(a + 1, c), o = c - a - 1;
				a = c, s = 0;
			} else l === st && -1 !== s ? ++s : s = -1;
		}
		return r;
	...
	function _t(e, t) {
		(function(e) {
			if (null === e || "object" != typeof e) throw new dt("pathObject", "Object", e);
		})(t);
	...
	const wt = {
		resolve(...e) {
			...
			for (let r = e.length - 1; r >= -1; r--) {
				let o;
				if (r >= 0) {
					if (o = e[r], ut(o, `paths[${r}]`), 0 === o.length) continue;
				} else 0 === t.length ? o = rt() : (o = ot[`=${t}`] || rt(), (void 0 === o || o.slice(0, 2).toLowerCase() !== t.toLowerCase() && o.charCodeAt(2) === ct) && (o = `${t}\\`));
				const a = o.length;
				let s = 0, l = "", c = !1;
				const h = o.charCodeAt(0);
				if (1 === a) pt(h) && (s = 1, c = !0);
				else if (pt(h)) if (c = !0, pt(o.charCodeAt(1))) {
					let e = 2, t = e;
					for (; e < a && !pt(o.charCodeAt(e));) e++;
					if (e < a && e !== t) {
						const n = o.slice(t, e);
						for (t = e; e < a && pt(o.charCodeAt(e));) e++;
						if (e < a && e !== t) {
							for (t = e; e < a && !pt(o.charCodeAt(e));) e++;
				...
				else ft(h) && o.charCodeAt(1) === ht && (l = o.slice(0, 2), s = 2, a > 2 && pt(o.charCodeAt(2)) && (c = !0, s = 3));
				if (l.length > 0) if (t.length > 0) {
					if (l.toLowerCase() !== t.toLowerCase()) continue;
				} else t = l;
				if (i) {
					if (t.length > 0) break;
				} else if (n = `${o.slice(s)}\\${n}`, i = c, c && t.length > 0) break;
			}
			return n = bt(n, !i, "\\", pt), i ? `${t}\\${n}` : `${t}${n}` || ".";
		},
		normalize(e) {
			ut(e, "path");
			const t = e.length;
			...
			if (1 === t) return gt(o) ? "\\" : e;
			if (pt(o)) if (r = !0, pt(e.charCodeAt(1))) {
				let r = 2, o = r;
				for (; r < t && !pt(e.charCodeAt(r));) r++;
				if (r < t && r !== o) {
					const a = e.slice(o, r);
					for (o = r; r < t && pt(e.charCodeAt(r));) r++;
					if (r < t && r !== o) {
						for (o = r; r < t && !pt(e.charCodeAt(r));) r++;
			...
			else ft(o) && e.charCodeAt(1) === ht && (n = e.slice(0, 2), i = 2, t > 2 && pt(e.charCodeAt(2)) && (r = !0, i = 3));
			let a = i < t ? bt(e.slice(i), !r, "\\", pt) : "";
			if (0 !== a.length || r || (a = "."), a.length > 0 && pt(e.charCodeAt(t - 1)) && (a += "\\"), !r && void 0 === n && e.includes(":")) {
				if (a.length >= 2 && ft(a.charCodeAt(0)) && a.charCodeAt(1) === ht) return `.\\${a}`;
				let n = e.indexOf(":");
				do
					if (n === t - 1 || pt(e.charCodeAt(n + 1))) return `.\\${a}`;
				while (-1 !== (n = e.indexOf(":", n + 1)));
			}
			return void 0 === n ? r ? `\\${a}` : a : r ? `${n}\\${a}` : `${n}${a}`;
		},
		isAbsolute(e) {
			ut(e, "path");
			const t = e.length;
			...
			return pt(n) || t > 2 && ft(n) && e.charCodeAt(1) === ht && pt(e.charCodeAt(2));
		},
		join(...e) {
			...
			for (let o = 0; o < e.length; ++o) {
				const i = e[o];
				ut(i, "path"), i.length > 0 && (void 0 === t ? t = n = i : t += `\\${i}`);
			}
			if (void 0 === t) return ".";
			let i = !0, r = 0;
			if ("string" == typeof n && pt(n.charCodeAt(0))) {
				++r;
				const e = n.length;
				e > 1 && pt(n.charCodeAt(1)) && (++r, e > 2 && (pt(n.charCodeAt(2)) ? ++r : i = !1));
			}
			if (i) {
				for (; r < t.length && pt(t.charCodeAt(r));) r++;
				r >= 2 && (t = `\\${t.slice(r)}`);
			}
			return wt.normalize(t);
		},
		relative(e, t) {
			if (ut(e, "from"), ut(t, "to"), e === t) return "";
			const n = wt.resolve(e), i = wt.resolve(t);
			if (n === i) return "";
			...
			if (n.length !== e.length || i.length !== t.length) {
				...
				const r = e.length, o = t.length, a = r < o ? r : o;
				let s;
				for (s = 0; s < a && e[s].toLowerCase() === t[s].toLowerCase(); s++);
				return 0 === s ? i : s === a ? o > a ? t.slice(s).join("\\") : r > a ? "..\\".repeat(r - 1 - s) + ".." : "" : "..\\".repeat(r - s) + t.slice(s).join("\\");
			}
			let r = 0;
			for (; r < e.length && e.charCodeAt(r) === ct;) r++;
			let o = e.length;
			for (; o - 1 > r && e.charCodeAt(o - 1) === ct;) o--;
			const a = o - r;
			let s = 0;
			for (; s < t.length && t.charCodeAt(s) === ct;) s++;
			let l = t.length;
			for (; l - 1 > s && t.charCodeAt(l - 1) === ct;) l--;
			...
			if (u !== h) {
				...
				if (c > h) {
					if (t.charCodeAt(s + u) === ct) return i.slice(s + u + 1);
					if (2 === u) return i.slice(s + u);
				}
				a > h && (e.charCodeAt(r + u) === ct ? d = u : 2 === u && (d = 3)), -1 === d && (d = 0);
			}
			let m = "";
			for (u = r + d + 1; u <= o; ++u) u !== o && e.charCodeAt(u) !== ct || (m += 0 === m.length ? ".." : "\\..");
			return s += d, m.length > 0 ? `${m}${i.slice(s, l)}` : (i.charCodeAt(s) === ct && ++s, i.slice(s, l));
		},
		toNamespacedPath(e) {
			if ("string" != typeof e || 0 === e.length) return e;
			const t = wt.resolve(e);
			if (t.length <= 2) return e;
			if (t.charCodeAt(0) === ct) {
				if (t.charCodeAt(1) === ct) {
					const e = t.charCodeAt(2);
					if (63 !== e && e !== st) return `\\\\?\\UNC\\${t.slice(2)}`;
				}
			} else if (ft(t.charCodeAt(0)) && t.charCodeAt(1) === ht && t.charCodeAt(2) === ct) return `\\\\?\\${t}`;
			return t;
		},
		dirname(e) {
			ut(e, "path");
			...
			if (1 === t) return pt(r) ? e : ".";
			if (pt(r)) {
				if (n = i = 1, pt(e.charCodeAt(1))) {
					let r = 2, o = r;
					for (; r < t && !pt(e.charCodeAt(r));) r++;
					if (r < t && r !== o) {
						for (o = r; r < t && pt(e.charCodeAt(r));) r++;
			...
			} else ft(r) && e.charCodeAt(1) === ht && (n = t > 2 && pt(e.charCodeAt(2)) ? 3 : 2, i = n);
			let o = -1, a = !0;
			for (let s = t - 1; s >= i; --s) if (pt(e.charCodeAt(s))) {
				if (!a) {
					o = s;
					break;
				}
		...
		basename(e, t) {
			void 0 !== t && ut(t, "suffix"), ut(e, "path");
			let n, i = 0, r = -1, o = !0;
			if (e.length >= 2 && ft(e.charCodeAt(0)) && e.charCodeAt(1) === ht && (i = 2), void 0 !== t && t.length > 0 && t.length <= e.length) {
				if (t === e) return "";
				...
				for (n = e.length - 1; n >= i; --n) {
					...
					} else -1 === s && (o = !1, s = n + 1), a >= 0 && (l === t.charCodeAt(a) ? -1 === --a && (r = n) : (a = -1, r = s));
				}
				return i === r ? r = s : -1 === r && (r = e.length), e.slice(i, r);
			}
			for (n = e.length - 1; n >= i; --n) if (pt(e.charCodeAt(n))) {
				if (!o) {
					i = n + 1;
					break;
				}
		...
		extname(e) {
			ut(e, "path");
			let t = 0, n = -1, i = 0, r = -1, o = !0, a = 0;
			e.length >= 2 && e.charCodeAt(1) === ht && ft(e.charCodeAt(0)) && (t = i = 2);
			for (let s = e.length - 1; s >= t; --s) {
				...
				} else -1 === r && (o = !1, r = s + 1), t === st ? -1 === n ? n = s : 1 !== a && (a = 1) : -1 !== n && (a = -1);
			}
			return -1 === n || -1 === r || 0 === a || 1 === a && n === r - 1 && n === i + 1 ? "" : e.slice(n, r);
		},
		format: _t.bind(null, "\\"),
		parse(e) {
			ut(e, "path");
			...
			if (1 === n) return pt(r) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
			if (pt(r)) {
				if (i = 1, pt(e.charCodeAt(1))) {
					let t = 2, r = t;
					for (; t < n && !pt(e.charCodeAt(t));) t++;
					if (t < n && t !== r) {
						for (r = t; t < n && pt(e.charCodeAt(t));) t++;
						if (t < n && t !== r) {
							for (r = t; t < n && !pt(e.charCodeAt(t));) t++;
							t === n ? i = t : t !== r && (i = t + 1);
						}
			...
			} else if (ft(r) && e.charCodeAt(1) === ht) {
				if (n <= 2) return t.root = t.dir = e, t;
				if (i = 2, pt(e.charCodeAt(2))) {
					if (3 === n) return t.root = t.dir = e, t;
					i = 3;
				}
			}
			i > 0 && (t.root = e.slice(0, i));
			let o = -1, a = i, s = -1, l = !0, c = e.length - 1, h = 0;
			for (; c >= i; --c) if (r = e.charCodeAt(c), pt(r)) {
				if (!l) {
					a = c + 1;
					break;
				}
			} else -1 === s && (l = !1, s = c + 1), r === st ? -1 === o ? o = c : 1 !== h && (h = 1) : -1 !== o && (h = -1);
			return -1 !== s && (-1 === o || 0 === h || 1 === h && o === s - 1 && o === a + 1 ? t.base = t.name = e.slice(a, s) : (t.name = e.slice(a, o), t.base = e.slice(a, s), t.ext = e.slice(o, s))), t.dir = a > 0 && a !== i ? e.slice(0, a - 1) : t.root, t;
		},
		sep: "\\",
		delimiter: ";",
		win32: null,
		...
		resolve(...e) {
			...
			for (let i = e.length - 1; i >= 0 && !n; i--) {
				const r = e[i];
				ut(r, `paths[${i}]`), 0 !== r.length && (t = `${r}/${t}`, n = r.charCodeAt(0) === lt);
			}
			if (!n) {
				const e = vt();
				t = `${e}/${t}`, n = e.charCodeAt(0) === lt;
			}
			return t = bt(t, !n, "/", gt), n ? `/${t}` : t.length > 0 ? t : ".";
		},
		normalize(e) {
			if (ut(e, "path"), 0 === e.length) return ".";
			const t = e.charCodeAt(0) === lt, n = e.charCodeAt(e.length - 1) === lt;
			return 0 === (e = bt(e, !t, "/", gt)).length ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
		},
		isAbsolute: (e) => (ut(e, "path"), e.length > 0 && e.charCodeAt(0) === lt),
		join(...e) {
			if (0 === e.length) return ".";
			const t = [];
			for (let n = 0; n < e.length; ++n) {
				const i = e[n];
				ut(i, "path"), i.length > 0 && t.push(i);
			}
			return 0 === t.length ? "." : yt.normalize(t.join("/"));
		},
		relative(e, t) {
			if (ut(e, "from"), ut(t, "to"), e === t) return "";
			if ((e = yt.resolve(e)) === (t = yt.resolve(t))) return "";
			const n = e.length, i = n - 1, r = t.length - 1, o = i < r ? i : r;
			let a = -1, s = 0;
			for (; s < o; s++) {
			...
			if (s === o) if (r > o) {
				if (t.charCodeAt(1 + s) === lt) return t.slice(1 + s + 1);
				if (0 === s) return t.slice(1 + s);
			} else i > o && (e.charCodeAt(1 + s) === lt ? a = s : 0 === s && (a = 0));
			let l = "";
			for (s = 1 + a + 1; s <= n; ++s) s !== n && e.charCodeAt(s) !== lt || (l += 0 === l.length ? ".." : "/..");
			return `${l}${t.slice(1 + a)}`;
		},
		toNamespacedPath: (e) => e,
		dirname(e) {
			if (ut(e, "path"), 0 === e.length) return ".";
			const t = e.charCodeAt(0) === lt;
			let n = -1, i = !0;
			for (let r = e.length - 1; r >= 1; --r) if (e.charCodeAt(r) === lt) {
				if (!i) {
					n = r;
					break;
				}
		...
		basename(e, t) {
			...
			for (n = e.length - 1; n >= 0; --n) if (e.charCodeAt(n) === lt) {
				if (!o) {
					i = n + 1;
					break;
				}
		...
		extname(e) {
			ut(e, "path");
			let t = -1, n = 0, i = -1, r = !0, o = 0;
			for (let a = e.length - 1; a >= 0; --a) {
				const s = e[a];
				if ("/" !== s) -1 === i && (r = !1, i = a + 1), "." === s ? -1 === t ? t = a : 1 !== o && (o = 1) : -1 !== t && (o = -1);
				else if (!r) {
					n = a + 1;
					break;
				}
		...
		parse(e) {
			...
			if (0 === e.length) return t;
			const n = e.charCodeAt(0) === lt;
			let i;
			n ? (t.root = "/", i = 1) : i = 0;
			let r = -1, o = 0, a = -1, s = !0, l = e.length - 1, c = 0;
			for (; l >= i; --l) {
				const t = e.charCodeAt(l);
				if (t !== lt) -1 === a && (s = !1, a = l + 1), t === st ? -1 === r ? r = l : 1 !== c && (c = 1) : -1 !== r && (c = -1);
				else if (!s) {
					o = l + 1;
					break;
				}
			...
			if (-1 !== a) {
				const i = 0 === o && n ? 1 : o;
				-1 === r || 0 === c || 1 === c && r === a - 1 && r === o + 1 ? t.base = t.name = e.slice(i, a) : (t.name = e.slice(i, r), t.base = e.slice(i, a), t.ext = e.slice(r, a));
			}
	...
	yt.win32 = wt.win32 = wt, yt.posix = wt.posix = yt;
	const Tt = /^\w[\w\d+.-]*$/, kt = /^\//, St = /^\/\//, Lt = "", xt = "/", Ct = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
	var Et = class e {
		static isUri(t) {
		...
		constructor(e, t, n, i, r, o = !1) {
			"object" == typeof e ? (this.scheme = e.scheme || Lt, this.authority = e.authority || Lt, this.path = e.path || Lt, this.query = e.query || Lt, this.fragment = e.fragment || Lt) : (this.scheme = function(e, t) {
				return e || t ? e : "file";
			}(e, o), this.authority = t || Lt, this.path = function(e, t) {
				switch (e) {
					case "https":
					case "http":
					case "file": t ? t[0] !== xt && (t = xt + t) : t = xt;
				}
				return t;
			}(this.scheme, n || Lt), this.query = i || Lt, this.fragment = r || Lt, function(e, t) {
				...
				if (e.scheme && !Tt.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
				if (e.path) {
					if (e.authority) {
						if (!kt.test(e.path)) throw new Error("[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash (\"/\") character");
					} else if (St.test(e.path)) throw new Error("[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters (\"//\")");
				}
			}(this, o));
		}
		get fsPath() {
		...
		with(e) {
			...
			return void 0 === t ? t = this.scheme : null === t && (t = Lt), void 0 === n ? n = this.authority : null === n && (n = Lt), void 0 === i ? i = this.path : null === i && (i = Lt), void 0 === r ? r = this.query : null === r && (r = Lt), void 0 === o ? o = this.fragment : null === o && (o = Lt), t === this.scheme && n === this.authority && i === this.path && r === this.query && o === this.fragment ? this : new Rt(t, n, i, r, o);
		}
		static parse(e, t = !1) {
			const n = Ct.exec(e);
			return n ? new Rt(n[2] || Lt, Dt(n[4] || Lt), Dt(n[5] || Lt), Dt(n[7] || Lt), Dt(n[9] || Lt), t) : new Rt(Lt, Lt, Lt, Lt, Lt);
		}
		static file(e) {
			let t = Lt;
			if (F && (e = e.replace(/\\/g, xt)), e[0] === xt && e[1] === xt) {
				const n = e.indexOf(xt, 2);
				-1 === n ? (t = e.substring(2), e = xt) : (t = e.substring(2, n), e = e.substring(n) || xt);
			}
			return new Rt("file", t, e, Lt, Lt);
		}
		static from(e, t) {
			return new Rt(e.scheme, e.authority, e.path, e.query, e.fragment, t);
		}
		static joinPath(t, ...n) {
			if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
			let i;
			return i = F && "file" === t.scheme ? e.file(wt.join(zt(t, !0), ...n)).path : yt.join(t.path, ...n), t.with({ path: i });
		}
		toString(e = !1) {
			return Ot(this, e);
		}
		...
		static revive(t) {
			if (t) {
				...
				{
					const e = new Rt(t);
					return e._formatted = t.external ?? null, e._fsPath = t._sep === At ? t.fsPath ?? null : null, e;
				}
			}
			return t;
		}
	...
	var Rt = class extends Et {
		...
		toString(e = !1) {
			return e ? Ot(this, !0) : (this._formatted || (this._formatted = Ot(this, !1)), this._formatted);
		}
		toJSON() {
			const e = { $mid: 1 };
			return this._fsPath && (e.fsPath = this._fsPath, e._sep = At), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
		}
	};
	const Mt = {
		58: "%3A",
	...
	function Nt(e, t, n) {
		...
		for (let o = 0; o < e.length; o++) {
			...
			if (a >= 97 && a <= 122 || a >= 65 && a <= 90 || a >= 48 && a <= 57 || 45 === a || 46 === a || 95 === a || 126 === a || t && 47 === a || n && 91 === a || n && 93 === a || n && 58 === a) -1 !== r && (i += encodeURIComponent(e.substring(r, o)), r = -1), void 0 !== i && (i += e.charAt(o));
			else {
				void 0 === i && (i = e.substr(0, o));
				const t = Mt[a];
				void 0 !== t ? (-1 !== r && (i += encodeURIComponent(e.substring(r, o)), r = -1), i += t) : -1 === r && (r = o);
			}
		}
	...
	function It(e) {
		...
		for (let n = 0; n < e.length; n++) {
			const i = e.charCodeAt(n);
			35 === i || 63 === i ? (void 0 === t && (t = e.substr(0, n)), t += Mt[i]) : void 0 !== t && (t += e[n]);
		}
		return void 0 !== t ? t : e;
	}
	function zt(e, t) {
	...
	function Ot(e, t) {
		const n = t ? It : Nt;
		let i = "", { scheme: r, authority: o, path: a, query: s, fragment: l } = e;
		if (r && (i += r, i += ":"), (o || "file" === r) && (i += xt, i += xt), o) {
			let e = o.indexOf("@");
			if (-1 !== e) {
		...
		return s && (i += "?", i += n(s, !1, !1)), l && (i += "#", i += t ? l : Nt(l, !1, !1)), i;
	}
	function Ut(e) {
		try {
			return decodeURIComponent(e);
		} catch {
			return e.length > 3 ? e.substr(0, 3) + Ut(e.substr(3)) : e;
		}
	}
	const Ht = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function Dt(e) {
		return e.match(Ht) ? e.replace(Ht, (e) => Ut(e)) : e;
	}
	...
	const qt = {
		add: Pt("add", 6e4),
		plus: Pt("plus", 6e4),
		gistNew: Pt("gist-new", 6e4),
		repoCreate: Pt("repo-create", 6e4),
		lightbulb: Pt("lightbulb", 60001),
		lightBulb: Pt("light-bulb", 60001),
		repo: Pt("repo", 60002),
		repoDelete: Pt("repo-delete", 60002),
		gistFork: Pt("gist-fork", 60003),
		repoForked: Pt("repo-forked", 60003),
		gitPullRequest: Pt("git-pull-request", 60004),
		gitPullRequestAbandoned: Pt("git-pull-request-abandoned", 60004),
		recordKeys: Pt("record-keys", 60005),
		keyboard: Pt("keyboard", 60005),
		tag: Pt("tag", 60006),
		gitPullRequestLabel: Pt("git-pull-request-label", 60006),
		tagAdd: Pt("tag-add", 60006),
		tagRemove: Pt("tag-remove", 60006),
		person: Pt("person", 60007),
		personFollow: Pt("person-follow", 60007),
		personOutline: Pt("person-outline", 60007),
		personFilled: Pt("person-filled", 60007),
		sourceControl: Pt("source-control", 60008),
		mirror: Pt("mirror", 60009),
		mirrorPublic: Pt("mirror-public", 60009),
		star: Pt("star", 60010),
		starAdd: Pt("star-add", 60010),
		starDelete: Pt("star-delete", 60010),
		starEmpty: Pt("star-empty", 60010),
		comment: Pt("comment", 60011),
		commentAdd: Pt("comment-add", 60011),
		alert: Pt("alert", 60012),
		warning: Pt("warning", 60012),
		search: Pt("search", 60013),
		searchSave: Pt("search-save", 60013),
		logOut: Pt("log-out", 60014),
		signOut: Pt("sign-out", 60014),
		logIn: Pt("log-in", 60015),
		signIn: Pt("sign-in", 60015),
		eye: Pt("eye", 60016),
		eyeUnwatch: Pt("eye-unwatch", 60016),
		eyeWatch: Pt("eye-watch", 60016),
		circleFilled: Pt("circle-filled", 60017),
		primitiveDot: Pt("primitive-dot", 60017),
		closeDirty: Pt("close-dirty", 60017),
		debugBreakpoint: Pt("debug-breakpoint", 60017),
		debugBreakpointDisabled: Pt("debug-breakpoint-disabled", 60017),
		debugHint: Pt("debug-hint", 60017),
		terminalDecorationSuccess: Pt("terminal-decoration-success", 60017),
		primitiveSquare: Pt("primitive-square", 60018),
		edit: Pt("edit", 60019),
		pencil: Pt("pencil", 60019),
		info: Pt("info", 60020),
		issueOpened: Pt("issue-opened", 60020),
		gistPrivate: Pt("gist-private", 60021),
		gitForkPrivate: Pt("git-fork-private", 60021),
		lock: Pt("lock", 60021),
		mirrorPrivate: Pt("mirror-private", 60021),
		close: Pt("close", 60022),
		removeClose: Pt("remove-close", 60022),
		x: Pt("x", 60022),
		repoSync: Pt("repo-sync", 60023),
		sync: Pt("sync", 60023),
		clone: Pt("clone", 60024),
		desktopDownload: Pt("desktop-download", 60024),
		beaker: Pt("beaker", 60025),
		microscope: Pt("microscope", 60025),
		vm: Pt("vm", 60026),
		deviceDesktop: Pt("device-desktop", 60026),
		file: Pt("file", 60027),
		more: Pt("more", 60028),
		ellipsis: Pt("ellipsis", 60028),
		kebabHorizontal: Pt("kebab-horizontal", 60028),
		mailReply: Pt("mail-reply", 60029),
		reply: Pt("reply", 60029),
		organization: Pt("organization", 60030),
		organizationFilled: Pt("organization-filled", 60030),
		organizationOutline: Pt("organization-outline", 60030),
		newFile: Pt("new-file", 60031),
		fileAdd: Pt("file-add", 60031),
		newFolder: Pt("new-folder", 60032),
		fileDirectoryCreate: Pt("file-directory-create", 60032),
		trash: Pt("trash", 60033),
		trashcan: Pt("trashcan", 60033),
		history: Pt("history", 60034),
		clock: Pt("clock", 60034),
		folder: Pt("folder", 60035),
		fileDirectory: Pt("file-directory", 60035),
		symbolFolder: Pt("symbol-folder", 60035),
		logoGithub: Pt("logo-github", 60036),
		markGithub: Pt("mark-github", 60036),
		github: Pt("github", 60036),
		terminal: Pt("terminal", 60037),
		console: Pt("console", 60037),
		repl: Pt("repl", 60037),
		zap: Pt("zap", 60038),
		symbolEvent: Pt("symbol-event", 60038),
		error: Pt("error", 60039),
		stop: Pt("stop", 60039),
		variable: Pt("variable", 60040),
		symbolVariable: Pt("symbol-variable", 60040),
		array: Pt("array", 60042),
		symbolArray: Pt("symbol-array", 60042),
		symbolModule: Pt("symbol-module", 60043),
		symbolPackage: Pt("symbol-package", 60043),
		symbolNamespace: Pt("symbol-namespace", 60043),
		symbolObject: Pt("symbol-object", 60043),
		symbolMethod: Pt("symbol-method", 60044),
		symbolFunction: Pt("symbol-function", 60044),
		symbolConstructor: Pt("symbol-constructor", 60044),
		symbolBoolean: Pt("symbol-boolean", 60047),
		symbolNull: Pt("symbol-null", 60047),
		symbolNumeric: Pt("symbol-numeric", 60048),
		symbolNumber: Pt("symbol-number", 60048),
		symbolStructure: Pt("symbol-structure", 60049),
		symbolStruct: Pt("symbol-struct", 60049),
		symbolParameter: Pt("symbol-parameter", 60050),
		symbolTypeParameter: Pt("symbol-type-parameter", 60050),
		symbolKey: Pt("symbol-key", 60051),
		symbolText: Pt("symbol-text", 60051),
		symbolReference: Pt("symbol-reference", 60052),
		goToFile: Pt("go-to-file", 60052),
		symbolEnum: Pt("symbol-enum", 60053),
		symbolValue: Pt("symbol-value", 60053),
		symbolRuler: Pt("symbol-ruler", 60054),
		symbolUnit: Pt("symbol-unit", 60054),
		activateBreakpoints: Pt("activate-breakpoints", 60055),
		archive: Pt("archive", 60056),
		arrowBoth: Pt("arrow-both", 60057),
		arrowDown: Pt("arrow-down", 60058),
		arrowLeft: Pt("arrow-left", 60059),
		arrowRight: Pt("arrow-right", 60060),
		arrowSmallDown: Pt("arrow-small-down", 60061),
		arrowSmallLeft: Pt("arrow-small-left", 60062),
		arrowSmallRight: Pt("arrow-small-right", 60063),
		arrowSmallUp: Pt("arrow-small-up", 60064),
		arrowUp: Pt("arrow-up", 60065),
		bell: Pt("bell", 60066),
		bold: Pt("bold", 60067),
		book: Pt("book", 60068),
		bookmark: Pt("bookmark", 60069),
		debugBreakpointConditionalUnverified: Pt("debug-breakpoint-conditional-unverified", 60070),
		debugBreakpointConditional: Pt("debug-breakpoint-conditional", 60071),
		debugBreakpointConditionalDisabled: Pt("debug-breakpoint-conditional-disabled", 60071),
		debugBreakpointDataUnverified: Pt("debug-breakpoint-data-unverified", 60072),
		debugBreakpointData: Pt("debug-breakpoint-data", 60073),
		debugBreakpointDataDisabled: Pt("debug-breakpoint-data-disabled", 60073),
		debugBreakpointLogUnverified: Pt("debug-breakpoint-log-unverified", 60074),
		debugBreakpointLog: Pt("debug-breakpoint-log", 60075),
		debugBreakpointLogDisabled: Pt("debug-breakpoint-log-disabled", 60075),
		briefcase: Pt("briefcase", 60076),
		broadcast: Pt("broadcast", 60077),
		browser: Pt("browser", 60078),
		bug: Pt("bug", 60079),
		calendar: Pt("calendar", 60080),
		caseSensitive: Pt("case-sensitive", 60081),
		check: Pt("check", 60082),
		checklist: Pt("checklist", 60083),
		chevronDown: Pt("chevron-down", 60084),
		chevronLeft: Pt("chevron-left", 60085),
		chevronRight: Pt("chevron-right", 60086),
		chevronUp: Pt("chevron-up", 60087),
		chromeClose: Pt("chrome-close", 60088),
		chromeMaximize: Pt("chrome-maximize", 60089),
		chromeMinimize: Pt("chrome-minimize", 60090),
		chromeRestore: Pt("chrome-restore", 60091),
		circleOutline: Pt("circle-outline", 60092),
		circle: Pt("circle", 60092),
		debugBreakpointUnverified: Pt("debug-breakpoint-unverified", 60092),
		terminalDecorationIncomplete: Pt("terminal-decoration-incomplete", 60092),
		circleSlash: Pt("circle-slash", 60093),
		circuitBoard: Pt("circuit-board", 60094),
		clearAll: Pt("clear-all", 60095),
		clippy: Pt("clippy", 60096),
		closeAll: Pt("close-all", 60097),
		cloudDownload: Pt("cloud-download", 60098),
		cloudUpload: Pt("cloud-upload", 60099),
		code: Pt("code", 60100),
		collapseAll: Pt("collapse-all", 60101),
		colorMode: Pt("color-mode", 60102),
		commentDiscussion: Pt("comment-discussion", 60103),
		creditCard: Pt("credit-card", 60105),
		dash: Pt("dash", 60108),
		dashboard: Pt("dashboard", 60109),
		database: Pt("database", 60110),
		debugContinue: Pt("debug-continue", 60111),
		debugDisconnect: Pt("debug-disconnect", 60112),
		debugPause: Pt("debug-pause", 60113),
		debugRestart: Pt("debug-restart", 60114),
		debugStart: Pt("debug-start", 60115),
		debugStepInto: Pt("debug-step-into", 60116),
		debugStepOut: Pt("debug-step-out", 60117),
		debugStepOver: Pt("debug-step-over", 60118),
		debugStop: Pt("debug-stop", 60119),
		debug: Pt("debug", 60120),
		deviceCameraVideo: Pt("device-camera-video", 60121),
		deviceCamera: Pt("device-camera", 60122),
		deviceMobile: Pt("device-mobile", 60123),
		diffAdded: Pt("diff-added", 60124),
		diffIgnored: Pt("diff-ignored", 60125),
		diffModified: Pt("diff-modified", 60126),
		diffRemoved: Pt("diff-removed", 60127),
		diffRenamed: Pt("diff-renamed", 60128),
		diff: Pt("diff", 60129),
		diffSidebyside: Pt("diff-sidebyside", 60129),
		discard: Pt("discard", 60130),
		editorLayout: Pt("editor-layout", 60131),
		emptyWindow: Pt("empty-window", 60132),
		exclude: Pt("exclude", 60133),
		extensions: Pt("extensions", 60134),
		eyeClosed: Pt("eye-closed", 60135),
		fileBinary: Pt("file-binary", 60136),
		fileCode: Pt("file-code", 60137),
		fileMedia: Pt("file-media", 60138),
		filePdf: Pt("file-pdf", 60139),
		fileSubmodule: Pt("file-submodule", 60140),
		fileSymlinkDirectory: Pt("file-symlink-directory", 60141),
		fileSymlinkFile: Pt("file-symlink-file", 60142),
		fileZip: Pt("file-zip", 60143),
		files: Pt("files", 60144),
		filter: Pt("filter", 60145),
		flame: Pt("flame", 60146),
		foldDown: Pt("fold-down", 60147),
		foldUp: Pt("fold-up", 60148),
		fold: Pt("fold", 60149),
		folderActive: Pt("folder-active", 60150),
		folderOpened: Pt("folder-opened", 60151),
		gear: Pt("gear", 60152),
		gift: Pt("gift", 60153),
		gistSecret: Pt("gist-secret", 60154),
		gist: Pt("gist", 60155),
		gitCommit: Pt("git-commit", 60156),
		gitCompare: Pt("git-compare", 60157),
		compareChanges: Pt("compare-changes", 60157),
		gitMerge: Pt("git-merge", 60158),
		githubAction: Pt("github-action", 60159),
		githubAlt: Pt("github-alt", 60160),
		globe: Pt("globe", 60161),
		grabber: Pt("grabber", 60162),
		graph: Pt("graph", 60163),
		gripper: Pt("gripper", 60164),
		heart: Pt("heart", 60165),
		home: Pt("home", 60166),
		horizontalRule: Pt("horizontal-rule", 60167),
		hubot: Pt("hubot", 60168),
		inbox: Pt("inbox", 60169),
		issueReopened: Pt("issue-reopened", 60171),
		issues: Pt("issues", 60172),
		italic: Pt("italic", 60173),
		jersey: Pt("jersey", 60174),
		json: Pt("json", 60175),
		kebabVertical: Pt("kebab-vertical", 60176),
		key: Pt("key", 60177),
		law: Pt("law", 60178),
		lightbulbAutofix: Pt("lightbulb-autofix", 60179),
		linkExternal: Pt("link-external", 60180),
		link: Pt("link", 60181),
		listOrdered: Pt("list-ordered", 60182),
		listUnordered: Pt("list-unordered", 60183),
		liveShare: Pt("live-share", 60184),
		loading: Pt("loading", 60185),
		location: Pt("location", 60186),
		mailRead: Pt("mail-read", 60187),
		mail: Pt("mail", 60188),
		markdown: Pt("markdown", 60189),
		megaphone: Pt("megaphone", 60190),
		mention: Pt("mention", 60191),
		milestone: Pt("milestone", 60192),
		gitPullRequestMilestone: Pt("git-pull-request-milestone", 60192),
		mortarBoard: Pt("mortar-board", 60193),
		move: Pt("move", 60194),
		multipleWindows: Pt("multiple-windows", 60195),
		mute: Pt("mute", 60196),
		noNewline: Pt("no-newline", 60197),
		note: Pt("note", 60198),
		octoface: Pt("octoface", 60199),
		openPreview: Pt("open-preview", 60200),
		package: Pt("package", 60201),
		paintcan: Pt("paintcan", 60202),
		pin: Pt("pin", 60203),
		play: Pt("play", 60204),
		run: Pt("run", 60204),
		plug: Pt("plug", 60205),
		preserveCase: Pt("preserve-case", 60206),
		preview: Pt("preview", 60207),
		project: Pt("project", 60208),
		pulse: Pt("pulse", 60209),
		question: Pt("question", 60210),
		quote: Pt("quote", 60211),
		radioTower: Pt("radio-tower", 60212),
		reactions: Pt("reactions", 60213),
		references: Pt("references", 60214),
		refresh: Pt("refresh", 60215),
		regex: Pt("regex", 60216),
		remoteExplorer: Pt("remote-explorer", 60217),
		remote: Pt("remote", 60218),
		remove: Pt("remove", 60219),
		replaceAll: Pt("replace-all", 60220),
		replace: Pt("replace", 60221),
		repoClone: Pt("repo-clone", 60222),
		repoForcePush: Pt("repo-force-push", 60223),
		repoPull: Pt("repo-pull", 60224),
		repoPush: Pt("repo-push", 60225),
		report: Pt("report", 60226),
		requestChanges: Pt("request-changes", 60227),
		rocket: Pt("rocket", 60228),
		rootFolderOpened: Pt("root-folder-opened", 60229),
		rootFolder: Pt("root-folder", 60230),
		rss: Pt("rss", 60231),
		ruby: Pt("ruby", 60232),
		saveAll: Pt("save-all", 60233),
		saveAs: Pt("save-as", 60234),
		save: Pt("save", 60235),
		screenFull: Pt("screen-full", 60236),
		screenNormal: Pt("screen-normal", 60237),
		searchStop: Pt("search-stop", 60238),
		server: Pt("server", 60240),
		settingsGear: Pt("settings-gear", 60241),
		settings: Pt("settings", 60242),
		shield: Pt("shield", 60243),
		smiley: Pt("smiley", 60244),
		sortPrecedence: Pt("sort-precedence", 60245),
		splitHorizontal: Pt("split-horizontal", 60246),
		splitVertical: Pt("split-vertical", 60247),
		squirrel: Pt("squirrel", 60248),
		starFull: Pt("star-full", 60249),
		starHalf: Pt("star-half", 60250),
		symbolClass: Pt("symbol-class", 60251),
		symbolColor: Pt("symbol-color", 60252),
		symbolConstant: Pt("symbol-constant", 60253),
		symbolEnumMember: Pt("symbol-enum-member", 60254),
		symbolField: Pt("symbol-field", 60255),
		symbolFile: Pt("symbol-file", 60256),
		symbolInterface: Pt("symbol-interface", 60257),
		symbolKeyword: Pt("symbol-keyword", 60258),
		symbolMisc: Pt("symbol-misc", 60259),
		symbolOperator: Pt("symbol-operator", 60260),
		symbolProperty: Pt("symbol-property", 60261),
		wrench: Pt("wrench", 60261),
		wrenchSubaction: Pt("wrench-subaction", 60261),
		symbolSnippet: Pt("symbol-snippet", 60262),
		tasklist: Pt("tasklist", 60263),
		telescope: Pt("telescope", 60264),
		textSize: Pt("text-size", 60265),
		threeBars: Pt("three-bars", 60266),
		thumbsdown: Pt("thumbsdown", 60267),
		thumbsup: Pt("thumbsup", 60268),
		tools: Pt("tools", 60269),
		triangleDown: Pt("triangle-down", 60270),
		triangleLeft: Pt("triangle-left", 60271),
		triangleRight: Pt("triangle-right", 60272),
		triangleUp: Pt("triangle-up", 60273),
		twitter: Pt("twitter", 60274),
		unfold: Pt("unfold", 60275),
		unlock: Pt("unlock", 60276),
		unmute: Pt("unmute", 60277),
		unverified: Pt("unverified", 60278),
		verified: Pt("verified", 60279),
		versions: Pt("versions", 60280),
		vmActive: Pt("vm-active", 60281),
		vmOutline: Pt("vm-outline", 60282),
		vmRunning: Pt("vm-running", 60283),
		watch: Pt("watch", 60284),
		whitespace: Pt("whitespace", 60285),
		wholeWord: Pt("whole-word", 60286),
		window: Pt("window", 60287),
		wordWrap: Pt("word-wrap", 60288),
		zoomIn: Pt("zoom-in", 60289),
		zoomOut: Pt("zoom-out", 60290),
		listFilter: Pt("list-filter", 60291),
		listFlat: Pt("list-flat", 60292),
		listSelection: Pt("list-selection", 60293),
		selection: Pt("selection", 60293),
		listTree: Pt("list-tree", 60294),
		debugBreakpointFunctionUnverified: Pt("debug-breakpoint-function-unverified", 60295),
		debugBreakpointFunction: Pt("debug-breakpoint-function", 60296),
		debugBreakpointFunctionDisabled: Pt("debug-breakpoint-function-disabled", 60296),
		debugStackframeActive: Pt("debug-stackframe-active", 60297),
		circleSmallFilled: Pt("circle-small-filled", 60298),
		debugStackframeDot: Pt("debug-stackframe-dot", 60298),
		terminalDecorationMark: Pt("terminal-decoration-mark", 60298),
		debugStackframe: Pt("debug-stackframe", 60299),
		debugStackframeFocused: Pt("debug-stackframe-focused", 60299),
		debugBreakpointUnsupported: Pt("debug-breakpoint-unsupported", 60300),
		symbolString: Pt("symbol-string", 60301),
		debugReverseContinue: Pt("debug-reverse-continue", 60302),
		debugStepBack: Pt("debug-step-back", 60303),
		debugRestartFrame: Pt("debug-restart-frame", 60304),
		debugAlt: Pt("debug-alt", 60305),
		callIncoming: Pt("call-incoming", 60306),
		callOutgoing: Pt("call-outgoing", 60307),
		menu: Pt("menu", 60308),
		expandAll: Pt("expand-all", 60309),
		feedback: Pt("feedback", 60310),
		gitPullRequestReviewer: Pt("git-pull-request-reviewer", 60310),
		groupByRefType: Pt("group-by-ref-type", 60311),
		ungroupByRefType: Pt("ungroup-by-ref-type", 60312),
		account: Pt("account", 60313),
		gitPullRequestAssignee: Pt("git-pull-request-assignee", 60313),
		bellDot: Pt("bell-dot", 60314),
		debugConsole: Pt("debug-console", 60315),
		library: Pt("library", 60316),
		output: Pt("output", 60317),
		runAll: Pt("run-all", 60318),
		syncIgnored: Pt("sync-ignored", 60319),
		pinned: Pt("pinned", 60320),
		githubInverted: Pt("github-inverted", 60321),
		serverProcess: Pt("server-process", 60322),
		serverEnvironment: Pt("server-environment", 60323),
		pass: Pt("pass", 60324),
		issueClosed: Pt("issue-closed", 60324),
		stopCircle: Pt("stop-circle", 60325),
		playCircle: Pt("play-circle", 60326),
		record: Pt("record", 60327),
		debugAltSmall: Pt("debug-alt-small", 60328),
		vmConnect: Pt("vm-connect", 60329),
		cloud: Pt("cloud", 60330),
		merge: Pt("merge", 60331),
		export: Pt("export", 60332),
		graphLeft: Pt("graph-left", 60333),
		magnet: Pt("magnet", 60334),
		notebook: Pt("notebook", 60335),
		redo: Pt("redo", 60336),
		checkAll: Pt("check-all", 60337),
		pinnedDirty: Pt("pinned-dirty", 60338),
		passFilled: Pt("pass-filled", 60339),
		circleLargeFilled: Pt("circle-large-filled", 60340),
		circleLarge: Pt("circle-large", 60341),
		circleLargeOutline: Pt("circle-large-outline", 60341),
		combine: Pt("combine", 60342),
		gather: Pt("gather", 60342),
		table: Pt("table", 60343),
		variableGroup: Pt("variable-group", 60344),
		typeHierarchy: Pt("type-hierarchy", 60345),
		typeHierarchySub: Pt("type-hierarchy-sub", 60346),
		typeHierarchySuper: Pt("type-hierarchy-super", 60347),
		gitPullRequestCreate: Pt("git-pull-request-create", 60348),
		runAbove: Pt("run-above", 60349),
		runBelow: Pt("run-below", 60350),
		notebookTemplate: Pt("notebook-template", 60351),
		debugRerun: Pt("debug-rerun", 60352),
		workspaceTrusted: Pt("workspace-trusted", 60353),
		workspaceUntrusted: Pt("workspace-untrusted", 60354),
		workspaceUnknown: Pt("workspace-unknown", 60355),
		terminalCmd: Pt("terminal-cmd", 60356),
		terminalDebian: Pt("terminal-debian", 60357),
		terminalLinux: Pt("terminal-linux", 60358),
		terminalPowershell: Pt("terminal-powershell", 60359),
		terminalTmux: Pt("terminal-tmux", 60360),
		terminalUbuntu: Pt("terminal-ubuntu", 60361),
		terminalBash: Pt("terminal-bash", 60362),
		arrowSwap: Pt("arrow-swap", 60363),
		copy: Pt("copy", 60364),
		personAdd: Pt("person-add", 60365),
		filterFilled: Pt("filter-filled", 60366),
		wand: Pt("wand", 60367),
		debugLineByLine: Pt("debug-line-by-line", 60368),
		inspect: Pt("inspect", 60369),
		layers: Pt("layers", 60370),
		layersDot: Pt("layers-dot", 60371),
		layersActive: Pt("layers-active", 60372),
		compass: Pt("compass", 60373),
		compassDot: Pt("compass-dot", 60374),
		compassActive: Pt("compass-active", 60375),
		azure: Pt("azure", 60376),
		issueDraft: Pt("issue-draft", 60377),
		gitPullRequestClosed: Pt("git-pull-request-closed", 60378),
		gitPullRequestDraft: Pt("git-pull-request-draft", 60379),
		debugAll: Pt("debug-all", 60380),
		debugCoverage: Pt("debug-coverage", 60381),
		runErrors: Pt("run-errors", 60382),
		folderLibrary: Pt("folder-library", 60383),
		debugContinueSmall: Pt("debug-continue-small", 60384),
		beakerStop: Pt("beaker-stop", 60385),
		graphLine: Pt("graph-line", 60386),
		graphScatter: Pt("graph-scatter", 60387),
		pieChart: Pt("pie-chart", 60388),
		bracket: Pt("bracket", 60175),
		bracketDot: Pt("bracket-dot", 60389),
		bracketError: Pt("bracket-error", 60390),
		lockSmall: Pt("lock-small", 60391),
		azureDevops: Pt("azure-devops", 60392),
		verifiedFilled: Pt("verified-filled", 60393),
		newline: Pt("newline", 60394),
		layout: Pt("layout", 60395),
		layoutActivitybarLeft: Pt("layout-activitybar-left", 60396),
		layoutActivitybarRight: Pt("layout-activitybar-right", 60397),
		layoutPanelLeft: Pt("layout-panel-left", 60398),
		layoutPanelCenter: Pt("layout-panel-center", 60399),
		layoutPanelJustify: Pt("layout-panel-justify", 60400),
		layoutPanelRight: Pt("layout-panel-right", 60401),
		layoutPanel: Pt("layout-panel", 60402),
		layoutSidebarLeft: Pt("layout-sidebar-left", 60403),
		layoutSidebarRight: Pt("layout-sidebar-right", 60404),
		layoutStatusbar: Pt("layout-statusbar", 60405),
		layoutMenubar: Pt("layout-menubar", 60406),
		layoutCentered: Pt("layout-centered", 60407),
		target: Pt("target", 60408),
		indent: Pt("indent", 60409),
		recordSmall: Pt("record-small", 60410),
		errorSmall: Pt("error-small", 60411),
		terminalDecorationError: Pt("terminal-decoration-error", 60411),
		arrowCircleDown: Pt("arrow-circle-down", 60412),
		arrowCircleLeft: Pt("arrow-circle-left", 60413),
		arrowCircleRight: Pt("arrow-circle-right", 60414),
		arrowCircleUp: Pt("arrow-circle-up", 60415),
		layoutSidebarRightOff: Pt("layout-sidebar-right-off", 60416),
		layoutPanelOff: Pt("layout-panel-off", 60417),
		layoutSidebarLeftOff: Pt("layout-sidebar-left-off", 60418),
		blank: Pt("blank", 60419),
		heartFilled: Pt("heart-filled", 60420),
		map: Pt("map", 60421),
		mapHorizontal: Pt("map-horizontal", 60421),
		foldHorizontal: Pt("fold-horizontal", 60421),
		mapFilled: Pt("map-filled", 60422),
		mapHorizontalFilled: Pt("map-horizontal-filled", 60422),
		foldHorizontalFilled: Pt("fold-horizontal-filled", 60422),
		circleSmall: Pt("circle-small", 60423),
		bellSlash: Pt("bell-slash", 60424),
		bellSlashDot: Pt("bell-slash-dot", 60425),
		commentUnresolved: Pt("comment-unresolved", 60426),
		gitPullRequestGoToChanges: Pt("git-pull-request-go-to-changes", 60427),
		gitPullRequestNewChanges: Pt("git-pull-request-new-changes", 60428),
		searchFuzzy: Pt("search-fuzzy", 60429),
		commentDraft: Pt("comment-draft", 60430),
		send: Pt("send", 60431),
		sparkle: Pt("sparkle", 60432),
		insert: Pt("insert", 60433),
		mic: Pt("mic", 60434),
		thumbsdownFilled: Pt("thumbsdown-filled", 60435),
		thumbsupFilled: Pt("thumbsup-filled", 60436),
		coffee: Pt("coffee", 60437),
		snake: Pt("snake", 60438),
		game: Pt("game", 60439),
		vr: Pt("vr", 60440),
		chip: Pt("chip", 60441),
		piano: Pt("piano", 60442),
		music: Pt("music", 60443),
		micFilled: Pt("mic-filled", 60444),
		repoFetch: Pt("repo-fetch", 60445),
		copilot: Pt("copilot", 60446),
		lightbulbSparkle: Pt("lightbulb-sparkle", 60447),
		robot: Pt("robot", 60448),
		sparkleFilled: Pt("sparkle-filled", 60449),
		diffSingle: Pt("diff-single", 60450),
		diffMultiple: Pt("diff-multiple", 60451),
		surroundWith: Pt("surround-with", 60452),
		share: Pt("share", 60453),
		gitStash: Pt("git-stash", 60454),
		gitStashApply: Pt("git-stash-apply", 60455),
		gitStashPop: Pt("git-stash-pop", 60456),
		vscode: Pt("vscode", 60457),
		vscodeInsiders: Pt("vscode-insiders", 60458),
		codeOss: Pt("code-oss", 60459),
		runCoverage: Pt("run-coverage", 60460),
		runAllCoverage: Pt("run-all-coverage", 60461),
		coverage: Pt("coverage", 60462),
		githubProject: Pt("github-project", 60463),
		mapVertical: Pt("map-vertical", 60464),
		foldVertical: Pt("fold-vertical", 60464),
		mapVerticalFilled: Pt("map-vertical-filled", 60465),
		foldVerticalFilled: Pt("fold-vertical-filled", 60465),
		goToSearch: Pt("go-to-search", 60466),
		percentage: Pt("percentage", 60467),
		sortPercentage: Pt("sort-percentage", 60467),
		attach: Pt("attach", 60468),
		goToEditingSession: Pt("go-to-editing-session", 60469),
		editSession: Pt("edit-session", 60470),
		codeReview: Pt("code-review", 60471),
		copilotWarning: Pt("copilot-warning", 60472),
		python: Pt("python", 60473),
		copilotLarge: Pt("copilot-large", 60474),
		copilotWarningLarge: Pt("copilot-warning-large", 60475),
		keyboardTab: Pt("keyboard-tab", 60476),
		copilotBlocked: Pt("copilot-blocked", 60477),
		copilotNotConnected: Pt("copilot-not-connected", 60478),
		flag: Pt("flag", 60479),
		lightbulbEmpty: Pt("lightbulb-empty", 60480),
		symbolMethodArrow: Pt("symbol-method-arrow", 60481),
		copilotUnavailable: Pt("copilot-unavailable", 60482),
		repoPinned: Pt("repo-pinned", 60483),
		keyboardTabAbove: Pt("keyboard-tab-above", 60484),
		keyboardTabBelow: Pt("keyboard-tab-below", 60485),
		gitPullRequestDone: Pt("git-pull-request-done", 60486),
		mcp: Pt("mcp", 60487),
		extensionsLarge: Pt("extensions-large", 60488),
		layoutPanelDock: Pt("layout-panel-dock", 60489),
		layoutSidebarLeftDock: Pt("layout-sidebar-left-dock", 60490),
		layoutSidebarRightDock: Pt("layout-sidebar-right-dock", 60491),
		copilotInProgress: Pt("copilot-in-progress", 60492),
		copilotError: Pt("copilot-error", 60493),
		copilotSuccess: Pt("copilot-success", 60494),
		chatSparkle: Pt("chat-sparkle", 60495),
		searchSparkle: Pt("search-sparkle", 60496),
		editSparkle: Pt("edit-sparkle", 60497),
		copilotSnooze: Pt("copilot-snooze", 60498),
		sendToRemoteAgent: Pt("send-to-remote-agent", 60499),
		commentDiscussionSparkle: Pt("comment-discussion-sparkle", 60500),
		chatSparkleWarning: Pt("chat-sparkle-warning", 60501),
		chatSparkleError: Pt("chat-sparkle-error", 60502),
		collection: Pt("collection", 60503),
		newCollection: Pt("new-collection", 60504),
		thinking: Pt("thinking", 60505),
		build: Pt("build", 60506),
		commentDiscussionQuote: Pt("comment-discussion-quote", 60507),
		cursor: Pt("cursor", 60508),
		eraser: Pt("eraser", 60509),
		fileText: Pt("file-text", 60510),
		gitLens: Pt("git-lens", 60511),
		quotes: Pt("quotes", 60512),
		rename: Pt("rename", 60513),
		runWithDeps: Pt("run-with-deps", 60514),
		debugConnected: Pt("debug-connected", 60515),
		strikethrough: Pt("strikethrough", 60516),
		openInProduct: Pt("open-in-product", 60517),
		indexZero: Pt("index-zero", 60518),
		agent: Pt("agent", 60519),
		editCode: Pt("edit-code", 60520),
		repoSelected: Pt("repo-selected", 60521),
		skip: Pt("skip", 60522),
		mergeInto: Pt("merge-into", 60523),
		gitBranchChanges: Pt("git-branch-changes", 60524),
		gitBranchStagedChanges: Pt("git-branch-staged-changes", 60525),
		gitBranchConflicts: Pt("git-branch-conflicts", 60526),
		gitBranch: Pt("git-branch", 60527),
		gitBranchCreate: Pt("git-branch-create", 60527),
		gitBranchDelete: Pt("git-branch-delete", 60527),
		searchLarge: Pt("search-large", 60528),
		terminalGitBash: Pt("terminal-git-bash", 60529),
		dialogError: Pt("dialog-error", "error"),
		dialogWarning: Pt("dialog-warning", "warning"),
		dialogInfo: Pt("dialog-info", "info"),
		dialogClose: Pt("dialog-close", "close"),
		treeItemExpanded: Pt("tree-item-expanded", "chevron-down"),
		treeFilterOnTypeOn: Pt("tree-filter-on-type-on", "list-filter"),
		treeFilterOnTypeOff: Pt("tree-filter-on-type-off", "list-selection"),
		treeFilterClear: Pt("tree-filter-clear", "close"),
		treeItemLoading: Pt("tree-item-loading", "loading"),
		menuSelection: Pt("menu-selection", "check"),
		menuSubmenu: Pt("menu-submenu", "chevron-right"),
		menuBarMore: Pt("menubar-more", "more"),
		scrollbarButtonLeft: Pt("scrollbar-button-left", "triangle-left"),
		scrollbarButtonRight: Pt("scrollbar-button-right", "triangle-right"),
		scrollbarButtonUp: Pt("scrollbar-button-up", "triangle-up"),
		scrollbarButtonDown: Pt("scrollbar-button-down", "triangle-down"),
		toolBarMore: Pt("toolbar-more", "more"),
		quickInputBack: Pt("quick-input-back", "arrow-left"),
		dropDownButton: Pt("drop-down-button", 60084),
		symbolCustomColor: Pt("symbol-customcolor", 60252),
		exportIcon: Pt("export", 60332),
		workspaceUnspecified: Pt("workspace-unspecified", 60355),
		newLine: Pt("newline", 60394),
		thumbsDownFilled: Pt("thumbsdown-filled", 60435),
		thumbsUpFilled: Pt("thumbsup-filled", 60436),
		gitFetch: Pt("git-fetch", 60445),
		lightbulbSparkleAutofix: Pt("lightbulb-sparkle-autofix", 60447),
		debugBreakpointPending: Pt("debug-breakpoint-pending", 60377)
	};
	var Ft, Vt, Bt, Kt, jt, Gt, $t, Xt, Jt, Yt, Qt, Zt, en, tn, nn, rn, on, an, sn, ln, cn, hn, dn, un, mn, pn, gn, fn, bn, _n, wn, vn, yn, Tn, kn, Sn, Ln, xn, Cn, En, An, Rn, Mn, Nn, In, zn, On, Un, Hn, Dn, Wn, Pn, qn, Fn, Vn, Bn, Kn, jn, Gn, $n, Xn, Jn = class extends g {
		get isResolved() {
	...
	(function(e) {
		...
		const t = /* @__PURE__ */ new Map();
		t.set(0, qt.symbolMethod), t.set(1, qt.symbolFunction), t.set(2, qt.symbolConstructor), t.set(3, qt.symbolField), t.set(4, qt.symbolVariable), t.set(5, qt.symbolClass), t.set(6, qt.symbolStruct), t.set(7, qt.symbolInterface), t.set(8, qt.symbolModule), t.set(9, qt.symbolProperty), t.set(10, qt.symbolEvent), t.set(11, qt.symbolOperator), t.set(12, qt.symbolUnit), t.set(13, qt.symbolValue), t.set(15, qt.symbolEnum), t.set(14, qt.symbolConstant), t.set(15, qt.symbolEnum), t.set(16, qt.symbolEnumMember), t.set(17, qt.symbolKeyword), t.set(28, qt.symbolSnippet), t.set(18, qt.symbolText), t.set(19, qt.symbolColor), t.set(20, qt.symbolFile), t.set(21, qt.symbolReference), t.set(22, qt.symbolCustomColor), t.set(23, qt.symbolFolder), t.set(24, qt.symbolTypeParameter), t.set(25, qt.account), t.set(26, qt.issues), t.set(27, qt.tools), e.toIcon = function(e) {
			let n = t.get(e);
			return n || (console.info("No codicon found for CompletionItemKind " + e), n = qt.symbolProperty), n;
	...
	}(Xt || (Xt = {})), M(757, "array"), M(758, "boolean"), M(759, "class"), M(760, "constant"), M(761, "constructor"), M(762, "enumeration"), M(763, "enumeration member"), M(764, "event"), M(765, "field"), M(766, "file"), M(767, "function"), M(768, "interface"), M(769, "key"), M(770, "method"), M(771, "module"), M(772, "namespace"), M(773, "null"), M(774, "number"), M(775, "object"), M(776, "operator"), M(777, "package"), M(778, "property"), M(779, "string"), M(780, "struct"), M(781, "type parameter"), M(782, "variable"), function(e) {
		const t = /* @__PURE__ */ new Map();
		t.set(0, qt.symbolFile), t.set(1, qt.symbolModule), t.set(2, qt.symbolNamespace), t.set(3, qt.symbolPackage), t.set(4, qt.symbolClass), t.set(5, qt.symbolMethod), t.set(6, qt.symbolProperty), t.set(7, qt.symbolField), t.set(8, qt.symbolConstructor), t.set(9, qt.symbolEnum), t.set(10, qt.symbolInterface), t.set(11, qt.symbolFunction), t.set(12, qt.symbolVariable), t.set(13, qt.symbolConstant), t.set(14, qt.symbolString), t.set(15, qt.symbolNumber), t.set(16, qt.symbolBoolean), t.set(17, qt.symbolArray), t.set(18, qt.symbolObject), t.set(19, qt.symbolKey), t.set(20, qt.symbolNull), t.set(21, qt.symbolEnumMember), t.set(22, qt.symbolStruct), t.set(23, qt.symbolEvent), t.set(24, qt.symbolOperator), t.set(25, qt.symbolTypeParameter), e.toIcon = function(e) {
			let n = t.get(e);
			return n || (console.info("No codicon found for SymbolKind " + e), n = qt.symbolProperty), n;
		};
		const n = /* @__PURE__ */ new Map();
		n.set(0, 20), n.set(1, 8), n.set(2, 8), n.set(3, 8), n.set(4, 5), n.set(5, 0), n.set(6, 9), n.set(7, 3), n.set(8, 2), n.set(9, 15), n.set(10, 7), n.set(11, 1), n.set(12, 4), n.set(13, 14), n.set(14, 18), n.set(15, 13), n.set(16, 13), n.set(17, 13), n.set(18, 13), n.set(19, 17), n.set(20, 13), n.set(21, 16), n.set(22, 6), n.set(23, 10), n.set(24, 11), n.set(25, 24), e.toCompletionKind = function(e) {
			let t = n.get(e);
			return void 0 === t && (console.info("No completion kind found for SymbolKind " + e), t = 20), t;
		};
	}(Jt || (Jt = {})), class e {
		static {
	...
	var Yn, Qn, Zn, ei, ti, ni, ii = class {
		static {
			this.CtrlCmd = 2048;
		}
		static {
		...
		constructor(t, n) {
			if (this[Yn] = "ResourceMap", t instanceof e) this.map = new Map(t.map), this.toKey = n ?? e.defaultToKey;
			else if (function(e) {
		...
		set(e, t) {
			return this.map.set(this.toKey(e), new ri(e, t)), this;
		}
		get(e) {
		...
		*[(Yn = Symbol.toStringTag, Symbol.iterator)]() {
		...
		constructor() {
			this[Qn] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
		}
		clear() {
	...
	var ci = class {
		...
		next(e) {
			...
			do {
				...
				if (this._prevMatchStartIndex = i, this._prevMatchLength = r, !this._wordSeparators || li(this._wordSeparators, e, t, i, r)) return n;
			} while (n);
			return null;
		}
	};
	...
	function mi(e, t, n, r, o) {
		if (t = di(t), o || (o = i.first(ui)), n.length > o.maxLen) {
			let i = e - o.maxLen / 2;
			return i < 0 ? i = 0 : r += i, mi(e, t, n = n.substring(i, e + o.maxLen / 2), r, o);
		}
		const a = Date.now(), s = e - 1 - r;
		let l = -1, c = null;
		for (let i = 1; !(Date.now() - a >= o.timeBudget); i++) {
			const e = s - o.windowSize * i;
	...
	var gi = class {
		static computeUnicodeHighlights(e, t, n) {
			const i = n ? n.startLineNumber : 1, r = n ? n.endLineNumber : e.getLineCount(), o = new fi(t), a = o.getCandidateCodePoints();
			let l;
			var c;
			l = "allNonBasicAscii" === a ? /* @__PURE__ */ new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : new RegExp(`[${c = Array.from(a).map((e) => String.fromCodePoint(e)).join(""), c.replace(/[\\\{\}\*\+\?\|\^\$\.\[\]\(\)]/g, "\\$&")}]`, "g");
			const h = new ci(null, l), d = [];
			let u, m = !1, p = 0, g = 0, f = 0;
			e: for (let b = i, _ = r; b <= _; b++) {
				const t = e.getLineContent(b), n = t.length;
				h.reset(0);
				do
					if (u = h.next(t), u) {
						let e = u.index, i = u.index + u[0].length;
						e > 0 && Z(t.charCodeAt(e - 1)) && e--, i + 1 < n && Z(t.charCodeAt(i - 1)) && i++;
						const r = t.substring(e, i);
						let a = mi(e + 1, hi, t, 0);
						a && a.endColumn <= e + 1 && (a = null);
						const l = o.shouldHighlightNonBasicASCII(r, a ? a.word : null);
						if (0 !== l) {
							if (3 === l ? p++ : 2 === l ? g++ : 1 === l ? f++ : s(), d.length >= 1e3) {
								m = !0;
								break e;
							}
							d.push(new ze(b, e + 1, b, i + 1));
						}
					}
				while (u);
			}
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const i = e.codePointAt(0), r = n.ambiguousCharacters.getPrimaryConfusable(i), o = oe.getLocales().filter((e) => !oe.getInstance(new Set([...t.allowedLocales, e])).isAmbiguous(i));
					return {
						kind: 0,
		...
		getCandidateCodePoints() {
			...
			if (this.options.invisibleCharacters) for (const t of ae.codePoints) bi(String.fromCodePoint(t)) || e.add(t);
		...
		shouldHighlightNonBasicASCII(e, t) {
			...
			if (t) for (const o of t) {
				const e = o.codePointAt(0), t = re(o);
				i = i || t, t || this.ambiguousCharacters.isAmbiguous(e) || ae.isInvisibleCharacter(e) || (r = !0);
			}
			return !i && r ? 0 : this.options.invisibleCharacters && !bi(e) && ae.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0;
		}
	};
	function bi(e) {
		return " " === e || "\n" === e || "	" === e;
	...
	(class e {
		...
		findLastMaxBy(e) {
			let t, n = !0;
			return this.iterate((i) => ((n || _i.isGreaterThan(e(i, t))) && (n = !1, t = i), !0)), t;
		}
	});
	var ki = class e {
		static fromTo(t, n) {
		...
		static addRange(t, n) {
			...
			if (i === r) n.splice(i, 0, t);
				...
				const o = Math.min(t.start, n[i].start), a = Math.max(t.endExclusive, n[r - 1].endExclusive);
				n.splice(i, r - i, new e(o, a));
			}
		}
		...
		constructor(e, t) {
			if (this.start = e, this.endExclusive = t, e > t) throw new a(`Invalid range: ${this.toString()}`);
		}
		get isEmpty() {
		...
		clip(e) {
			if (this.isEmpty) throw new a(`Invalid clipping range: ${this.toString()}`);
		...
		joinRightTouching(t) {
			if (this.endExclusive !== t.start) throw new a(`Invalid join: ${this.toString()} and ${t.toString()}`);
	...
	function Li(e, t, n = 0, i = e.length) {
		let r = n, o = i;
		for (; r < o;) {
			const n = Math.floor((r + o) / 2);
			t(e[n]) ? r = n + 1 : o = n;
		}
		return r - 1;
	}
	...
	var Ci = class e {
		...
		findLastMonotonous(t) {
			...
			const n = Li(this._array, t, this._findLastMonotonousLastIdx);
		...
		static {
			this.compareByStart = yi((e) => e.startLineNumber, Ti);
		}
		static joinMany(e) {
			if (0 === e.length) return [];
			let t = new Ai(e[0].slice());
			for (let n = 1; n < e.length; n++) t = t.getUnion(new Ai(e[n].slice()));
			return t.ranges;
		}
		static join(t) {
			if (0 === t.length) throw new a("lineRanges cannot be empty");
		...
		constructor(e, t) {
			if (e > t) throw new a(`startLineNumber ${e} cannot be after endLineNumberExclusive ${t}`);
		...
		toInclusiveRange() {
			return this.isEmpty ? null : new ze(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER);
		}
		toExclusiveRange() {
			return new ze(this.startLineNumber, 1, this.endLineNumberExclusive, 1);
		}
		mapToLineArray(e) {
			const t = [];
		...
		toOffsetRange() {
			return new ki(this.startLineNumber - 1, this.endLineNumberExclusive - 1);
		}
		addMargin(t, n) {
		...
		addRange(e) {
			if (0 === e.length) return;
			const t = xi(this._normalizedRanges, (t) => t.endLineNumberExclusive >= e.startLineNumber), n = Li(this._normalizedRanges, (t) => t.startLineNumber <= e.endLineNumberExclusive) + 1;
			if (t === n) this._normalizedRanges.splice(t, 0, e);
			else if (t === n - 1) this._normalizedRanges[t] = this._normalizedRanges[t].join(e);
			else {
		...
		contains(e) {
			const t = Si(this._normalizedRanges, (t) => t.startLineNumber <= e);
			return !!t && t.endLineNumberExclusive > e;
		}
		intersects(e) {
			const t = Si(this._normalizedRanges, (t) => t.startLineNumber < e.endLineNumberExclusive);
		...
		getUnion(t) {
			...
			for (; i < this._normalizedRanges.length || r < t._normalizedRanges.length;) {
				...
				if (i < this._normalizedRanges.length && r < t._normalizedRanges.length) {
					const n = this._normalizedRanges[i], o = t._normalizedRanges[r];
					n.startLineNumber < o.startLineNumber ? (e = n, i++) : (e = o, r++);
				} else i < this._normalizedRanges.length ? (e = this._normalizedRanges[i], i++) : (e = t._normalizedRanges[r], r++);
				null === o ? o = e : o.endLineNumberExclusive >= e.startLineNumber ? o = new Ei(o.startLineNumber, Math.max(o.endLineNumberExclusive, e.endLineNumberExclusive)) : (n.push(o), o = e);
			}
			return null !== o && n.push(o), new e(n);
		}
		subtractFrom(t) {
			const n = xi(this._normalizedRanges, (e) => e.endLineNumberExclusive >= t.startLineNumber), i = Li(this._normalizedRanges, (e) => e.startLineNumber <= t.endLineNumberExclusive) + 1;
			if (n === i) return new e([t]);
			const r = [];
			let o = t.startLineNumber;
			for (let e = n; e < i; e++) {
				const t = this._normalizedRanges[e];
				t.startLineNumber > o && r.push(new Ei(o, t.startLineNumber)), o = t.endLineNumberExclusive;
			}
			return o < t.endLineNumberExclusive && r.push(new Ei(o, t.endLineNumberExclusive)), new e(r);
		}
		toString() {
		...
		getIntersection(t) {
			...
			let i = 0, r = 0;
			for (; i < this._normalizedRanges.length && r < t._normalizedRanges.length;) {
				const e = this._normalizedRanges[i], o = t._normalizedRanges[r], a = e.intersect(o);
				a && !a.isEmpty && n.push(a), e.endLineNumberExclusive < o.endLineNumberExclusive ? i++ : r++;
			}
			return new e(n);
		}
		getWithDelta(t) {
		...
		createRange(e) {
			return 0 === this.lineCount ? new ze(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount) : new ze(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1);
		}
		toRange() {
			return new ze(1, 1, this.lineCount + 1, this.columnCount + 1);
		}
		toLineRange() {
			return Ei.ofLength(1, this.lineCount + 1);
		}
		addToPosition(e) {
			return 0 === this.lineCount ? new Ie(e.lineNumber, e.column + this.columnCount) : new Ie(e.lineNumber + this.lineCount, this.columnCount + 1);
		}
		toString() {
		...
		getOffsetRange(e) {
			return new ki(this.getOffset(e.getStartPosition()), this.getOffset(e.getEndPosition()));
		}
		getRange(e) {
			return ze.fromPositions(this.getPosition(e.start), this.getPosition(e.endExclusive));
		}
		getStringReplacement(e) {
			return new Ni.deps.StringReplacement(this.getOffsetRange(e.range), e.text);
		}
		getTextReplacement(e) {
			return new Ni.deps.TextReplacement(this.getRange(e.replaceRange), e.newText);
		}
		getTextEdit(e) {
			const t = e.replacements.map((e) => this.getTextReplacement(e));
			return new Ni.deps.TextEdit(t);
		}
	}, Ni = class {
		static {
			this._deps = void 0;
		...
		_validatePosition(e) {
			if (e.lineNumber < 1) return new Ie(1, 1);
			const t = this.textLength.lineCount + 1;
			if (e.lineNumber > t) return new Ie(t, this.getLineLength(t) + 1);
			if (e.column < 1) return new Ie(e.lineNumber, 1);
			const n = this.getLineLength(e.lineNumber);
			return e.column - 1 > n ? new Ie(e.lineNumber, n + 1) : e;
		}
		getPosition(e) {
			const t = Li(this.lineStartOffsetByLineIdx, (t) => t <= e);
			return new Ie(t + 1, e - this.lineStartOffsetByLineIdx[t] + 1);
		}
		get textLength() {
			const e = this.lineStartOffsetByLineIdx.length - 1;
			return new Ni.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e]);
		}
		getLineLength(e) {
		...
		getLineLength(e) {
			return this.getValueOfRange(new ze(e, 1, e, Number.MAX_SAFE_INTEGER)).length;
		}
		getTransformer() {
			return this._transformer || (this._transformer = new Ii(this.getValue())), this._transformer;
		}
		getLineAt(e) {
			return this.getValueOfRange(new ze(e, 1, e, Number.MAX_SAFE_INTEGER));
		}
	}, Oi = class extends zi {
		constructor(e, t) {
			(function(e, t = "unexpected state") {
				if (!e) throw "string" == typeof t ? new a(`Assertion Failed: ${t}`) : t;
		...
		get length() {
			...
			return new Ri(this._lineCount - 1, e.length);
		}
	}, Ui = class extends Oi {
		constructor(e) {
		...
		static joinReplacements(t, n) {
			if (0 === t.length) throw new a();
			if (1 === t.length) return t[0];
			const i = t[0].range.getStartPosition(), r = t[t.length - 1].range.getEndPosition();
			let o = "";
			for (let e = 0; e < t.length; e++) {
				const i = t[e];
				if (o += i.text, e < t.length - 1) {
					const r = t[e + 1], a = ze.fromPositions(i.range.getEndPosition(), r.range.getStartPosition());
					o += n.getValueOfRange(a);
				}
			}
			return new e(ze.fromPositions(i, r), o);
		}
		...
		removeCommonPrefix(t) {
			const n = t.getValueOfRange(this.range).replaceAll("\r\n", "\n"), i = this.text.replaceAll("\r\n", "\n"), r = function(e, t) {
				...
				return n;
			}(n, i), o = Ri.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()), a = i.substring(r);
			return new e(ze.fromPositions(o, this.range.getEndPosition()), a);
		}
		removeCommonSuffix(t) {
			const n = t.getValueOfRange(this.range).replaceAll("\r\n", "\n"), i = this.text.replaceAll("\r\n", "\n"), r = function(e, t) {
				const n = Math.min(e.length, t.length);
				let i;
				const r = e.length - 1, o = t.length - 1;
				for (i = 0; i < n; i++) if (e.charCodeAt(r - i) !== t.charCodeAt(o - i)) return i;
				return n;
			}(n, i), o = Ri.ofText(n.substring(0, n.length - r)).addToPosition(this.range.getStartPosition()), a = i.substring(0, i.length - r);
			return new e(ze.fromPositions(this.range.getStartPosition(), o), a);
		}
		toString() {
		...
		static inverse(t, n, i) {
			...
			let o = 1, a = 1;
			for (const l of t) {
				const t = new e(new Ei(o, l.original.startLineNumber), new Ei(a, l.modified.startLineNumber));
				t.modified.isEmpty || r.push(t), o = l.original.endLineNumberExclusive, a = l.modified.endLineNumberExclusive;
			}
			const s = new e(new Ei(o, n + 1), new Ei(a, i + 1));
			return s.modified.isEmpty || r.push(s), r;
		}
		static clip(t, n, i) {
			const r = [];
			for (const o of t) {
				const t = o.original.intersect(n), a = o.modified.intersect(i);
				t && !t.isEmpty && a && !a.isEmpty && r.push(new e(t, a));
			}
			return r;
		}
		constructor(e, t) {
		...
		toRangeMapping() {
			...
			if (e && t) return new Fi(e, t);
			if (1 === this.original.startLineNumber || 1 === this.modified.startLineNumber) {
				if (1 !== this.modified.startLineNumber || 1 !== this.original.startLineNumber) throw new a("not a valid diff");
				return new Fi(new ze(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new ze(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			}
			return new Fi(new ze(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new ze(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
		}
		toRangeMapping2(e, t) {
			if (Pi(this.original.endLineNumberExclusive, e) && Pi(this.modified.endLineNumberExclusive, t)) return new Fi(new ze(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new ze(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			if (!this.original.isEmpty && !this.modified.isEmpty) return new Fi(ze.fromPositions(new Ie(this.original.startLineNumber, 1), Wi(new Ie(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), ze.fromPositions(new Ie(this.modified.startLineNumber, 1), Wi(new Ie(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
			if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new Fi(ze.fromPositions(Wi(new Ie(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e), Wi(new Ie(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), ze.fromPositions(Wi(new Ie(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Wi(new Ie(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)));
			throw new a();
		}
	};
	function Wi(e, t) {
		if (e.lineNumber < 1) return new Ie(1, 1);
		if (e.lineNumber > t.length) return new Ie(t.length, t[t.length - 1].length + 1);
	...
	var qi = class e extends Di {
		static fromRangeMappings(t) {
			return new e(Ei.join(t.map((e) => Ei.fromRangeInclusive(e.originalRange))), Ei.join(t.map((e) => Ei.fromRangeInclusive(e.modifiedRange))), t);
		}
		constructor(e, t, n) {
		...
		static assertSorted(e) {
			for (let t = 1; t < e.length; t++) {
				const n = e[t - 1], i = e[t];
				if (!n.originalRange.getEndPosition().isBeforeOrEqual(i.originalRange.getStartPosition()) || !n.modifiedRange.getEndPosition().isBeforeOrEqual(i.modifiedRange.getStartPosition())) throw new a("Range mappings must be sorted");
			}
		}
		constructor(e, t) {
	...
	var Bi = class {
		computeDiff(e, t, n) {
			...
			let o = null;
			for (const a of i.changes) {
				let e, t;
				e = 0 === a.originalEndLineNumber ? new Ei(a.originalStartLineNumber + 1, a.originalStartLineNumber + 1) : new Ei(a.originalStartLineNumber, a.originalEndLineNumber + 1), t = 0 === a.modifiedEndLineNumber ? new Ei(a.modifiedStartLineNumber + 1, a.modifiedStartLineNumber + 1) : new Ei(a.modifiedStartLineNumber, a.modifiedEndLineNumber + 1);
				let n = new qi(e, t, a.charChanges?.map((e) => new Fi(new ze(e.originalStartLineNumber, e.originalStartColumn, e.originalEndLineNumber, e.originalEndColumn), new ze(e.modifiedStartLineNumber, e.modifiedStartColumn, e.modifiedEndLineNumber, e.modifiedEndColumn))));
				o && (o.modified.endLineNumberExclusive !== n.modified.startLineNumber && o.original.endLineNumberExclusive !== n.original.startLineNumber || (n = new qi(o.original.join(n.original), o.modified.join(n.modified), o.innerChanges && n.innerChanges ? o.innerChanges.concat(n.innerChanges) : void 0), r.pop())), r.push(n), o = n;
			}
			return l(() => c(r, (e, t) => t.original.startLineNumber - e.original.endLineNumberExclusive === t.modified.startLineNumber - e.modified.endLineNumberExclusive && e.original.endLineNumberExclusive < t.original.startLineNumber && e.modified.endLineNumberExclusive < t.modified.startLineNumber)), new wi(r, [], i.quitEarly);
		}
	};
	function Ki(e, t, n, i) {
		return new Ne(e, t, n).ComputeDiff(i);
	}
	var ji = class {
		constructor(e) {
			const t = [], n = [];
			for (let i = 0, r = e.length; i < r; i++) t[i] = Yi(e[i], 1), n[i] = Qi(e[i], 1);
		...
		createCharSequence(e, t, n) {
			...
			let a = 0;
			for (let s = t; s <= n; s++) {
				const t = this.lines[s], l = e ? this._endColumns[s] : t.length + 1;
				for (let n = e ? this._startColumns[s] : 1; n < l; n++) i[a] = t.charCodeAt(n - 1), r[a] = s + 1, o[a] = n, a++;
				!e && s < n && (i[a] = 10, r[a] = s + 1, o[a] = t.length + 1, a++);
			}
			return new Gi(i, r, o);
		}
	}, Gi = class {
		...
		constructor(e, t, n, i, r, o, a, s) {
			this.originalStartLineNumber = e, this.originalStartColumn = t, this.originalEndLineNumber = n, this.originalEndColumn = i, this.modifiedStartLineNumber = r, this.modifiedStartColumn = o, this.modifiedEndLineNumber = a, this.modifiedEndColumn = s;
		}
		...
		static createFromDiffResult(t, n, i, r, o, a, s) {
			let l, c, h, d, u;
			if (0 === n.originalLength ? (l = i.getStartLineNumber(n.originalStart) - 1, c = 0) : (l = i.getStartLineNumber(n.originalStart), c = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), 0 === n.modifiedLength ? (h = r.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (h = r.getStartLineNumber(n.modifiedStart), d = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && o()) {
				const e = i.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1), a = r.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
				if (e.getElements().length > 0 && a.getElements().length > 0) {
					let t = Ki(e, a, o, !0).changes;
					s && (t = function(e) {
						...
						for (let i = 1, r = e.length; i < r; i++) {
							const r = e[i];
							Math.min(r.originalStart - (n.originalStart + n.originalLength), r.modifiedStart - (n.modifiedStart + n.modifiedLength)) < 3 ? (n.originalLength = r.originalStart + r.originalLength - n.originalStart, n.modifiedLength = r.modifiedStart + r.modifiedLength - n.modifiedStart) : (t.push(r), n = r);
						}
						return t;
					}(t)), u = [];
					for (let n = 0, i = t.length; n < i; n++) u.push($i.createFromDiffChange(t[n], e, a));
				}
			}
		...
		constructor(e, t, n) {
			this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = t, this.original = new ji(e), this.modified = new ji(t), this.continueLineDiff = Zi(n.maxComputationTime), this.continueCharDiff = Zi(0 === n.maxComputationTime ? 0 : Math.min(n.maxComputationTime, 5e3));
		}
		computeDiff() {
			...
			const e = Ki(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), t = e.changes, n = e.quitEarly;
			if (this.shouldIgnoreTrimWhitespace) {
				const e = [];
				for (let n = 0, i = t.length; n < i; n++) e.push(Xi.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[n], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
				return {
					quitEarly: n,
					changes: e
				};
			...
			for (let a = -1, s = t.length; a < s; a++) {
				const e = a + 1 < s ? t[a + 1] : null, n = e ? e.originalStart : this.originalLines.length, l = e ? e.modifiedStart : this.modifiedLines.length;
				for (; r < n && o < l;) {
					const e = this.originalLines[r], t = this.modifiedLines[o];
					if (e !== t) {
						{
							let n = Yi(e, 1), a = Yi(t, 1);
							for (; n > 1 && a > 1 && e.charCodeAt(n - 2) === t.charCodeAt(a - 2);) n--, a--;
							(n > 1 || a > 1) && this._pushTrimWhitespaceCharChange(i, r + 1, 1, n, o + 1, 1, a);
						}
						{
							let n = Qi(e, 1), a = Qi(t, 1);
							const s = e.length + 1, l = t.length + 1;
							for (; n < s && a < l && e.charCodeAt(n - 1) === e.charCodeAt(a - 1);) n++, a++;
							(n < s || a < l) && this._pushTrimWhitespaceCharChange(i, r + 1, n, s, o + 1, a, l);
						}
					}
					r++, o++;
				}
				e && (i.push(Xi.createFromDiffResult(this.shouldIgnoreTrimWhitespace, e, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), r += e.originalLength, o += e.modifiedLength);
			}
			return {
				quitEarly: n,
				changes: i
		...
		_pushTrimWhitespaceCharChange(e, t, n, i, r, o, a) {
			...
			let s;
			this.shouldComputeCharChanges && (s = [new $i(t, n, t, i, r, o, r, a)]), e.push(new Xi(t, t, r, r, s));
		}
		_mergeTrimWhitespaceCharChange(e, t, n, i, r, o, a) {
			const s = e.length;
			if (0 === s) return !1;
			const l = e[s - 1];
			return 0 !== l.originalEndLineNumber && 0 !== l.modifiedEndLineNumber && (l.originalEndLineNumber === t && l.modifiedEndLineNumber === r ? (this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new $i(t, n, t, i, r, o, r, a)), !0) : l.originalEndLineNumber + 1 === t && l.modifiedEndLineNumber + 1 === r && (l.originalEndLineNumber = t, l.modifiedEndLineNumber = r, this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new $i(t, n, t, i, r, o, r, a)), !0));
		}
	};
	function Yi(e, t) {
		const n = function(e) {
	...
	var er = class e {
		static trivial(t, n) {
			return new e([new tr(ki.ofLength(t.length), ki.ofLength(n.length))], !1);
		}
		static trivialTimedOut(t, n) {
			return new e([new tr(ki.ofLength(t.length), ki.ofLength(n.length))], !0);
		}
		constructor(e, t) {
		...
		static invert(t, n) {
			...
			return function(e, t) {
				...
				i.push(e.fromOffsetPairs(t ? t.getEndExclusives() : nr.zero, r ? r.getStarts() : new nr(n, (t ? t.seq2Range.endExclusive - t.seq1Range.endExclusive : 0) + n)));
			}), i;
		}
		static fromOffsetPairs(t, n) {
			return new e(new ki(t.offset1, n.offset1), new ki(t.offset2, n.offset2));
		}
		static assertSorted(e) {
			let t;
			for (const n of e) {
				if (t && !(t.seq1Range.endExclusive <= n.seq1Range.start && t.seq2Range.endExclusive <= n.seq2Range.start)) throw new a("Sequence diffs must be sorted");
				t = n;
			}
		}
		constructor(e, t) {
		...
		getStarts() {
			return new nr(this.seq1Range.start, this.seq2Range.start);
		}
		getEndExclusives() {
			return new nr(this.seq1Range.endExclusive, this.seq2Range.endExclusive);
		}
	}, nr = class e {
		static {
			this.zero = new e(0, 0);
		...
		constructor(e) {
			if (this.timeout = e, this.startTime = Date.now(), this.valid = !0, e <= 0) throw new a("timeout must be positive");
		}
		isValid() {
	...
	var sr = class e {
		...
		constructor(t, n, i) {
			...
			let r = 0;
			for (let o = t.startLineNumber - 1; o < t.endLineNumberExclusive - 1; o++) {
				const t = n[o];
				for (let n = 0; n < t.length; n++) {
					r++;
					const i = e.getKey(t[n]);
		...
		compute(e, t, n = ir.instance, i) {
			if (0 === e.length || 0 === t.length) return er.trivial(e, t);
			const r = new or(e.length, t.length), o = new or(e.length, t.length), a = new or(e.length, t.length);
			for (let m = 0; m < e.length; m++) for (let s = 0; s < t.length; s++) {
				if (!n.isValid()) return er.trivialTimedOut(e, t);
				const l = 0 === m ? 0 : r.get(m - 1, s), c = 0 === s ? 0 : r.get(m, s - 1);
				let h;
				e.getElement(m) === t.getElement(s) ? (h = 0 === m || 0 === s ? 0 : r.get(m - 1, s - 1), m > 0 && s > 0 && 3 === o.get(m - 1, s - 1) && (h += a.get(m - 1, s - 1)), h += i ? i(m, s) : 1) : h = -1;
				const d = Math.max(l, c, h);
				if (d === h) {
					const e = m > 0 && s > 0 ? a.get(m - 1, s - 1) : 0;
					a.set(m, s, e + 1), o.set(m, s, 3);
				} else d === l ? (a.set(m, s, 0), o.set(m, s, 1)) : d === c && (a.set(m, s, 0), o.set(m, s, 2));
				r.set(m, s, d);
			}
			const s = [];
			let l = e.length, c = t.length;
			function h(e, t) {
				e + 1 === l && t + 1 === c || s.push(new tr(new ki(e + 1, l), new ki(t + 1, c))), l = e, c = t;
			}
			let d = e.length - 1, u = t.length - 1;
			for (; d >= 0 && u >= 0;) 3 === o.get(d, u) ? (h(d, u), d--, u--) : 1 === o.get(d, u) ? d-- : u--;
			return h(-1, -1), s.reverse(), new er(s, !1);
		}
	}, cr = class {
		compute(e, t, n = ir.instance) {
			if (0 === e.length || 0 === t.length) return er.trivial(e, t);
			const i = e, r = t;
			function o(e, t) {
			...
			s.set(0, o(0, 0));
			const l = new ur();
			l.set(0, 0 === s.get(0) ? null : new hr(null, 0, 0, s.get(0)));
			let c = 0;
			e: for (;;) {
				if (a++, !n.isValid()) return er.trivialTimedOut(i, r);
				const e = -Math.min(a, r.length + a % 2), t = Math.min(a, i.length + a % 2);
				for (c = e; c <= t; c += 2) {
					const n = c === t ? -1 : s.get(c + 1), a = c === e ? -1 : s.get(c - 1) + 1, h = Math.min(Math.max(n, a), i.length), d = h - c;
					if (h > i.length || d > r.length) continue;
					const u = o(h, d);
					s.set(c, u);
					const m = l.get(h === n ? c + 1 : c - 1);
					if (l.set(c, u !== h ? new hr(m, h, d, u - h) : m), s.get(c) === i.length && s.get(c) - c === r.length) break e;
				}
			}
			let h = l.get(c);
			const d = [];
			...
			for (;;) {
				...
				if (e === u && t === m || d.push(new tr(new ki(e, u), new ki(t, m))), !h) break;
				u = h.x, m = h.y, h = h.prev;
			}
			return d.reverse(), new er(d, !1);
		}
	}, hr = class {
		constructor(e, t, n, i) {
		...
		get(e) {
			return e < 0 ? this.negativeArr[e = -e - 1] : this.positiveArr[e];
		}
		set(e, t) {
			if (e < 0) {
		...
		set(e, t) {
			e < 0 ? this.negativeArr[e = -e - 1] = t : this.positiveArr[e] = t;
		}
	}, mr = class {
		constructor(e, t, n) {
			...
			for (let i = this.range.startLineNumber; i <= this.range.endLineNumber; i++) {
				...
				if (!n) {
					const e = t.trimStart();
					o = t.length - e.length, t = e.trimEnd();
				}
				this.trimmedWsLengthsByLineIdx.push(o);
				const a = i === this.range.endLineNumber ? Math.min(this.range.endColumn - 1 - r - o, t.length) : t.length;
				for (let e = 0; e < a; e++) this.elements.push(t.charCodeAt(e));
		...
		get text() {
			return this.getText(new ki(0, this.length));
		}
		getText(e) {
		...
		getBoundaryScore(e) {
			const t = _r(e > 0 ? this.elements[e - 1] : -1), n = _r(e < this.elements.length ? this.elements[e] : -1);
			if (7 === t && 8 === n) return 0;
			if (8 === t) return 150;
			let i = 0;
			return t !== n && (i += 10, 0 === t && 1 === n && (i += 1)), i += br(t), i += br(n), i;
		}
		translateOffset(e, t = "right") {
			const n = Li(this.firstElementOffsetByLineIdx, (t) => t <= e), i = e - this.firstElementOffsetByLineIdx[n];
			return new Ie(this.range.startLineNumber + n, 1 + this.lineStartOffsets[n] + i + (0 === i && "left" === t ? 0 : this.trimmedWsLengthsByLineIdx[n]));
		}
		translateRange(e) {
			const t = this.translateOffset(e.start, "right"), n = this.translateOffset(e.endExclusive, "left");
			return n.isBefore(t) ? ze.fromPositions(n, n) : ze.fromPositions(t, n);
		}
		findWordContaining(e) {
			if (e < 0 || e >= this.elements.length) return;
			if (!pr(this.elements[e])) return;
			let t = e;
			for (; t > 0 && pr(this.elements[t - 1]);) t--;
			let n = e;
			for (; n < this.elements.length && pr(this.elements[n]);) n++;
			return new ki(t, n);
		}
		findSubWordContaining(e) {
			...
			if (!pr(this.elements[e])) return;
			let t = e;
			for (; t > 0 && pr(this.elements[t - 1]) && !gr(this.elements[t]);) t--;
			let n = e;
			for (; n < this.elements.length && pr(this.elements[n]) && !gr(this.elements[n]);) n++;
			return new ki(t, n);
		}
		countLinesIn(e) {
		...
		extendToFullLines(e) {
			return new ki(Si(this.firstElementOffsetByLineIdx, (t) => t <= e.start) ?? 0, function(t) {
				const n = xi(t, (t) => e.endExclusive <= t);
				return n === t.length ? void 0 : t[n];
			}(this.firstElementOffsetByLineIdx) ?? this.elements.length);
		}
	};
	function pr(e) {
	...
	function _r(e) {
		return 10 === e ? 8 : 13 === e ? 7 : ar(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : -1 === e ? 3 : 44 === e || 59 === e ? 5 : 4;
	}
	function wr(e, t, n) {
		if (e.trim() === t.trim()) return !0;
		if (e.length > 300 && t.length > 300) return !1;
		const i = new cr().compute(new mr([e], new ze(1, 1, 1, e.length), !1), new mr([t], new ze(1, 1, 1, t.length), !1), n);
		let r = 0;
		const o = tr.invert(i.diffs, e.length);
		for (const s of o) s.seq1Range.forEach((t) => {
			ar(e.charCodeAt(t)) || r++;
		});
		const a = function(t) {
			let n = 0;
			for (let i = 0; i < e.length; i++) ar(t.charCodeAt(i)) || n++;
			return n;
	...
	function vr(e, t, n) {
		let i = n;
		return i = yr(e, t, i), i = yr(e, t, i), i = function(e, t, n) {
			if (!e.getBoundaryScore || !t.getBoundaryScore) return n;
			for (let i = 0; i < n.length; i++) {
				const r = i > 0 ? n[i - 1] : void 0, o = n[i], a = i + 1 < n.length ? n[i + 1] : void 0, s = new ki(r ? r.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : e.length), l = new ki(r ? r.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : t.length);
				o.seq1Range.isEmpty ? n[i] = Tr(o, e, t, s, l) : o.seq2Range.isEmpty && (n[i] = Tr(o.swap(), t, e, l, s).swap());
			}
			return n;
		}(e, t, i), i;
	}
	function yr(e, t, n) {
		...
		for (let o = 1; o < n.length; o++) {
			...
			if (a.seq1Range.isEmpty || a.seq2Range.isEmpty) {
				const n = a.seq1Range.start - r.seq1Range.endExclusive;
				let o;
				for (o = 1; o <= n && e.getElement(a.seq1Range.start - o) === e.getElement(a.seq1Range.endExclusive - o) && t.getElement(a.seq2Range.start - o) === t.getElement(a.seq2Range.endExclusive - o); o++);
				if (o--, o === n) {
					i[i.length - 1] = new tr(new ki(r.seq1Range.start, a.seq1Range.endExclusive - n), new ki(r.seq2Range.start, a.seq2Range.endExclusive - n));
					continue;
				}
				a = a.delta(-o);
			}
		...
		for (let o = 0; o < i.length - 1; o++) {
			...
			let a = i[o];
			if (a.seq1Range.isEmpty || a.seq2Range.isEmpty) {
				const r = n.seq1Range.start - a.seq1Range.endExclusive;
				let s;
				for (s = 0; s < r && e.isStronglyEqual(a.seq1Range.start + s, a.seq1Range.endExclusive + s) && t.isStronglyEqual(a.seq2Range.start + s, a.seq2Range.endExclusive + s); s++);
				if (s === r) {
					i[o + 1] = new tr(new ki(a.seq1Range.start + r, n.seq1Range.endExclusive), new ki(a.seq2Range.start + r, n.seq2Range.endExclusive));
					continue;
				}
				s > 0 && (a = a.delta(s));
			}
	...
	function Tr(e, t, n, i, r) {
		let o = 1;
		for (; e.seq1Range.start - o >= i.start && e.seq2Range.start - o >= r.start && n.isStronglyEqual(e.seq2Range.start - o, e.seq2Range.endExclusive - o) && o < 100;) o++;
		o--;
		let a = 0;
		for (; e.seq1Range.start + a < i.endExclusive && e.seq2Range.endExclusive + a < r.endExclusive && n.isStronglyEqual(e.seq2Range.start + a, e.seq2Range.endExclusive + a) && a < 100;) a++;
		if (0 === o && 0 === a) return e;
		let s = 0, l = -1;
		for (let c = -o; c <= a; c++) {
			const i = e.seq2Range.start + c, r = e.seq2Range.endExclusive + c, o = t.getBoundaryScore(e.seq1Range.start + c) + n.getBoundaryScore(i) + n.getBoundaryScore(r);
			o > l && (l = o, s = c);
		}
		return e.delta(s);
	}
	function kr(e, t, n, i, r = !1) {
		const o = tr.invert(n, e.length), a = [];
		let s = new nr(0, 0);
		function l(n, l) {
			...
			for (; o.length > 0;) {
				...
				const r = new tr(i(e, n.seq1Range.start), i(t, n.seq2Range.start)), a = r.intersect(n);
				if (m += a.seq1Range.length, p += a.seq2Range.length, d = d.join(r), !(d.seq1Range.endExclusive >= n.seq1Range.endExclusive)) break;
				o.shift();
			}
			(r && m + p < d.seq1Range.length + d.seq2Range.length || m + p < 2 * (d.seq1Range.length + d.seq2Range.length) / 3) && a.push(d), s = d.getEndExclusives();
		}
		for (; o.length > 0;) {
			const e = o.shift();
		...
		return function(e, t) {
			...
			for (; e.length > 0 || t.length > 0;) {
				const i = e[0], r = t[0];
				let o;
				o = i && (!r || i.seq1Range.start < r.seq1Range.start) ? e.shift() : t.shift(), n.length > 0 && n[n.length - 1].seq1Range.endExclusive >= o.seq1Range.start ? n[n.length - 1] = n[n.length - 1].join(o) : n.push(o);
			}
			return n;
		}(n, a);
	}
	var Sr = class {
		...
		getBoundaryScore(e) {
			return 1e3 - ((0 === e ? 0 : Lr(this.lines[e - 1])) + (e === this.lines.length ? 0 : Lr(this.lines[e])));
		}
		getText(e) {
	...
	var xr = class {
		constructor() {
			this.dynamicProgrammingDiffing = new lr(), this.myersDiffingAlgorithm = new cr();
		}
		computeDiff(e, t, n) {
			if (e.length <= 1 && function(e, t, n = (e, t) => e === t) {
				...
				return !0;
			}(e, t, (e, t) => e === t)) return new wi([], [], !1);
			if (1 === e.length && 0 === e[0].length || 1 === t.length && 0 === t[0].length) return new wi([new qi(new Ei(1, e.length + 1), new Ei(1, t.length + 1), [new Fi(new ze(1, 1, e.length, e[e.length - 1].length + 1), new ze(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
			const i = 0 === n.maxComputationTimeMs ? ir.instance : new rr(n.maxComputationTimeMs), r = !n.ignoreTrimWhitespace, o = /* @__PURE__ */ new Map();
			function a(e) {
				let t = o.get(e);
				return void 0 === t && (t = o.size, o.set(e, t)), t;
			}
			const s = e.map((e) => a(e.trim())), c = t.map((e) => a(e.trim())), h = new Sr(s, e), d = new Sr(c, t), u = (() => h.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, d, i, (n, i) => e[n] === t[i] ? 0 === t[i].length ? .1 : 1 + Math.log(1 + t[i].length) : .99) : this.myersDiffingAlgorithm.compute(h, d, i))();
			let m = u.diffs, p = u.hitTimeout;
			m = vr(h, d, m), m = function(e, t, n) {
				let i = n;
				...
				do {
					...
					for (let s = 1; s < i.length; s++) {
						const l = i[s], c = a[a.length - 1];
						function h(t, n) {
							const i = new ki(c.seq1Range.endExclusive, l.seq1Range.start);
							return e.getText(i).replace(/\s/g, "").length <= 4 && (t.seq1Range.length + t.seq2Range.length > 5 || n.seq1Range.length + n.seq2Range.length > 5);
						}
						h(c, l) ? (r = !0, a[a.length - 1] = a[a.length - 1].join(l)) : a.push(l);
					}
					i = a;
				} while (o++ < 10 && r);
				return i;
			...
			const g = [], f = (o) => {
				if (r) for (let a = 0; a < o; a++) {
					const o = b + a, s = _ + a;
					if (e[o] !== t[s]) {
						const a = this.refineDiff(e, t, new tr(new ki(o, o + 1), new ki(s, s + 1)), i, r, n);
			...
			for (const y of m) {
				...
				const o = this.refineDiff(e, t, y, i, r, n);
				o.hitTimeout && (p = !0);
				for (const e of o.mappings) g.push(e);
			}
			f(e.length - b);
			const w = Vi(g, new Ui(e), new Ui(t));
			let v = [];
			return n.computeMoves && (v = this.computeMoves(w, e, t, s, c, i, r, n)), l(() => {
				function n(e, t) {
					return !(e.lineNumber < 1 || e.lineNumber > t.length || e.column < 1 || e.column > t[e.lineNumber - 1].length + 1);
				}
				function i(e, t) {
		...
		computeMoves(e, t, n, i, r, o, a, s) {
			return function(e, t, n, i, r, o) {
				let { moves: a, excludedChanges: s } = function(e, t, n, i) {
					const r = [], o = e.filter((e) => e.modified.isEmpty && e.original.length >= 3).map((e) => new sr(e.original, t, e)), a = new Set(e.filter((e) => e.original.isEmpty && e.modified.length >= 3).map((e) => new sr(e.modified, n, e))), s = /* @__PURE__ */ new Set();
					for (const l of o) {
						let e, t = -1;
						for (const n of a) {
						...
						if (t > .9 && e && (a.delete(e), r.push(new Di(l.range, e.range)), s.add(l.source), s.add(e.source)), !i.isValid()) return {
							moves: r,
							excludedChanges: s
						};
					}
				...
				const l = function(e, t, n, i, r, o) {
					const a = [], s = new si();
					for (const m of e) for (let e = m.original.startLineNumber; e < m.original.endLineNumberExclusive - 2; e++) s.add(`${t[e - 1]}:${t[e + 1 - 1]}:${t[e + 2 - 1]}`, { range: new Ei(e, e + 3) });
					const l = [];
					e.sort(yi((e) => e.modified.startLineNumber, Ti));
					for (const m of e) {
						let e = [];
						for (let t = m.modified.startLineNumber; t < m.modified.endLineNumberExclusive - 2; t++) {
							const i = `${n[t - 1]}:${n[t + 1 - 1]}:${n[t + 2 - 1]}`, r = new Ei(t, t + 3), o = [];
							s.forEach(i, ({ range: t }) => {
								for (const i of e) if (i.originalLineRange.endLineNumberExclusive + 1 === t.endLineNumberExclusive && i.modifiedLineRange.endLineNumberExclusive + 1 === r.endLineNumberExclusive) return i.originalLineRange = new Ei(i.originalLineRange.startLineNumber, t.endLineNumberExclusive), i.modifiedLineRange = new Ei(i.modifiedLineRange.startLineNumber, r.endLineNumberExclusive), void o.push(i);
								const n = {
									modifiedLineRange: r,
									originalLineRange: t
								};
					...
					var c;
					l.sort((c = yi((e) => e.modifiedLineRange.length, Ti), (e, t) => -c(e, t)));
					const h = new Ai(), d = new Ai();
					for (const m of l) {
						...
						for (const r of i.ranges) {
							...
							a.push(new Di(n, t)), h.addRange(t), d.addRange(n);
						}
					}
					a.sort(yi((e) => e.original.startLineNumber, Ti));
					const u = new Ci(e);
					for (let m = 0; m < a.length; m++) {
						const t = a[m], n = u.findLastMonotonous((e) => e.original.startLineNumber <= t.original.startLineNumber), s = Si(e, (e) => e.modified.startLineNumber <= t.modified.startLineNumber), l = Math.max(t.original.startLineNumber - n.original.startLineNumber, t.modified.startLineNumber - s.modified.startLineNumber), c = u.findLastMonotonous((e) => e.original.startLineNumber < t.original.endLineNumberExclusive), p = Si(e, (e) => e.modified.startLineNumber < t.modified.endLineNumberExclusive), g = Math.max(c.original.endLineNumberExclusive - t.original.endLineNumberExclusive, p.modified.endLineNumberExclusive - t.modified.endLineNumberExclusive);
						let f, b;
						for (f = 0; f < l; f++) {
							...
							if (!wr(i[e - 1], r[n - 1], o)) break;
						}
						for (f > 0 && (d.addRange(new Ei(t.original.startLineNumber - f, t.original.startLineNumber)), h.addRange(new Ei(t.modified.startLineNumber - f, t.modified.startLineNumber))), b = 0; b < g; b++) {
							const e = t.original.endLineNumberExclusive + b, n = t.modified.endLineNumberExclusive + b;
							if (e > i.length || n > r.length) break;
							if (h.contains(n) || d.contains(e)) break;
							if (!wr(i[e - 1], r[n - 1], o)) break;
						}
						b > 0 && (d.addRange(new Ei(t.original.endLineNumberExclusive, t.original.endLineNumberExclusive + b)), h.addRange(new Ei(t.modified.endLineNumberExclusive, t.modified.endLineNumberExclusive + b))), (f > 0 || b > 0) && (a[m] = new Di(new Ei(t.original.startLineNumber - f, t.original.endLineNumberExclusive + b), new Ei(t.modified.startLineNumber - f, t.modified.endLineNumberExclusive + b)));
					}
					return a;
				}(e.filter((e) => !s.has(e)), i, r, t, n, o);
				return function(e, t) {
					for (const n of t) e.push(n);
				}(a, l), a = function(e) {
					if (0 === e.length) return e;
					e.sort(yi((e) => e.original.startLineNumber, Ti));
					const t = [e[0]];
					for (let n = 1; n < e.length; n++) {
						const i = t[t.length - 1], r = e[n], o = r.original.startLineNumber - i.original.endLineNumberExclusive, a = r.modified.startLineNumber - i.modified.endLineNumberExclusive;
						o >= 0 && a >= 0 && o + a <= 2 ? t[t.length - 1] = i.join(r) : t.push(r);
					}
					return t;
				}(a), a = a.filter((e) => {
					...
					const n = new Ci(e);
					return t.filter((t) => (n.findLastMonotonous((e) => e.original.startLineNumber < t.original.endLineNumberExclusive) || new Di(new Ei(1, 1), new Ei(1, 1))) !== Si(e, (e) => e.modified.startLineNumber < t.modified.endLineNumberExclusive));
				}(e, a), a;
			}(e, t, n, i, r, o).map((e) => new vi(e, Vi(this.refineDiff(t, n, new tr(e.original.toOffsetRange(), e.modified.toOffsetRange()), o, a, s).mappings, new Ui(t), new Ui(n), !0)));
		}
		refineDiff(e, t, n, i, r, o) {
			const a = (s = n, new Di(new Ei(s.seq1Range.start + 1, s.seq1Range.endExclusive + 1), new Ei(s.seq2Range.start + 1, s.seq2Range.endExclusive + 1))).toRangeMapping2(e, t);
			var s;
			const l = new mr(e, a.originalRange, r), c = new mr(t, a.modifiedRange, r), h = l.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(l, c, i) : this.myersDiffingAlgorithm.compute(l, c, i);
			let d = h.diffs;
			return d = vr(l, c, d), d = kr(l, c, d, (e, t) => e.findWordContaining(t)), o.extendToSubwords && (d = kr(l, c, d, (e, t) => e.findSubWordContaining(t), !0)), d = function(e, t, n) {
				const i = [];
				for (const r of n) {
					const e = i[i.length - 1];
					e && (r.seq1Range.start - e.seq1Range.endExclusive <= 2 || r.seq2Range.start - e.seq2Range.endExclusive <= 2) ? i[i.length - 1] = new tr(e.seq1Range.join(r.seq1Range), e.seq2Range.join(r.seq2Range)) : i.push(r);
				}
				return i;
				...
				do {
					...
					for (let l = 1; l < i.length; l++) {
						...
						function d(n, i) {
							const r = new ki(h.seq1Range.endExclusive, c.seq1Range.start);
							if (e.countLinesIn(r) > 5 || r.length > 500) return !1;
							const o = e.getText(r).trim();
							if (o.length > 20 || o.split(/\r\n|\r|\n/).length > 1) return !1;
							const a = e.countLinesIn(n.seq1Range), s = n.seq1Range.length, l = t.countLinesIn(n.seq2Range), d = n.seq2Range.length, u = e.countLinesIn(i.seq1Range), m = i.seq1Range.length, p = t.countLinesIn(i.seq2Range), g = i.seq2Range.length;
							function f(e) {
								return Math.min(e, 130);
							}
							return Math.pow(Math.pow(f(40 * a + s), 1.5) + Math.pow(f(40 * l + d), 1.5), 1.5) + Math.pow(Math.pow(f(40 * u + m), 1.5) + Math.pow(f(40 * p + g), 1.5), 1.5) > 74184.96480721243;
						}
				...
				return function(e, t) {
					...
					const s = e.extendToFullLines(n.seq1Range), l = e.getText(new ki(s.start, n.seq1Range.start));
					o(l) && (r = r.deltaStart(-l.length));
					const c = e.getText(new ki(n.seq1Range.endExclusive, s.endExclusive));
					o(c) && (r = r.deltaEnd(c.length));
					const h = tr.fromOffsetPairs(t ? t.getEndExclusives() : nr.zero, i ? i.getStarts() : nr.max), d = r.intersect(h);
					a.length > 0 && d.getStarts().equals(a[a.length - 1].getEndExclusives()) ? a[a.length - 1] = a[a.length - 1].join(d) : a.push(d);
				}), a;
			}(l, c, d), {
				mappings: d.map((e) => new Fi(l.translateRange(e.seq1Range), c.translateRange(e.seq2Range))),
	...
	var Er = class {
		constructor(e, t, n, i = 1) {
			this._rgbaBrand = void 0, this.r = 0 | Math.min(255, Math.max(0, e)), this.g = 0 | Math.min(255, Math.max(0, t)), this.b = 0 | Math.min(255, Math.max(0, n)), this.a = Cr(Math.max(Math.min(1, i), 0), 3);
		}
		static equals(e, t) {
		...
		constructor(e, t, n, i) {
			this._hslaBrand = void 0, this.h = 0 | Math.max(Math.min(360, e), 0), this.s = Cr(Math.max(Math.min(1, t), 0), 3), this.l = Cr(Math.max(Math.min(1, n), 0), 3), this.a = Cr(Math.max(Math.min(1, i), 0), 3);
		}
		static equals(e, t) {
			return e.h === t.h && e.s === t.s && e.l === t.l && e.a === t.a;
		}
		static fromRGBA(t) {
			const n = t.r / 255, i = t.g / 255, r = t.b / 255, o = t.a, a = Math.max(n, i, r), s = Math.min(n, i, r);
			let l = 0, c = 0;
			const h = (s + a) / 2, d = a - s;
			if (d > 0) {
				switch (c = Math.min(h <= .5 ? d / (2 * h) : d / (2 - 2 * h), 1), a) {
					case n:
						l = (i - r) / d + (i < r ? 6 : 0);
						break;
					case i:
			...
			return new e(l, c, h, o);
		}
		static _hue2rgb(e, t, n) {
			return n < 0 && (n += 1), n > 1 && (n -= 1), n < 1 / 6 ? e + 6 * (t - e) * n : n < .5 ? t : n < 2 / 3 ? e + (t - e) * (2 / 3 - n) * 6 : e;
		}
		static toRGBA(t) {
			const n = t.h / 360, { s: i, l: r, a: o } = t;
			let a, s, l;
			if (0 === i) a = s = l = r;
			else {
				const t = r < .5 ? r * (1 + i) : r + i - r * i, o = 2 * r - t;
				a = e._hue2rgb(o, t, n + 1 / 3), s = e._hue2rgb(o, t, n), l = e._hue2rgb(o, t, n - 1 / 3);
			}
			return new Er(Math.round(255 * a), Math.round(255 * s), Math.round(255 * l), o);
		}
	}, Rr = class e {
		constructor(e, t, n, i) {
			this._hsvaBrand = void 0, this.h = 0 | Math.max(Math.min(360, e), 0), this.s = Cr(Math.max(Math.min(1, t), 0), 3), this.v = Cr(Math.max(Math.min(1, n), 0), 3), this.a = Cr(Math.max(Math.min(1, i), 0), 3);
		}
		static equals(e, t) {
			return e.h === t.h && e.s === t.s && e.v === t.v && e.a === t.a;
		}
		static fromRGBA(t) {
			const n = t.r / 255, i = t.g / 255, r = t.b / 255, o = Math.max(n, i, r), a = o - Math.min(n, i, r), s = 0 === o ? 0 : a / o;
			let l;
			return l = 0 === a ? 0 : o === n ? ((i - r) / a % 6 + 6) % 6 : o === i ? (r - n) / a + 2 : (n - i) / a + 4, new e(Math.round(60 * l), s, o, t.a);
		}
		static toRGBA(e) {
			const { h: t, s: n, v: i, a: r } = e, o = i * n, a = o * (1 - Math.abs(t / 60 % 2 - 1)), s = i - o;
			let [l, c, h] = [
				0,
				0,
				0
			];
			return t < 60 ? (l = o, c = a) : t < 120 ? (l = a, c = o) : t < 180 ? (c = o, h = a) : t < 240 ? (c = a, h = o) : t < 300 ? (l = a, h = o) : t <= 360 && (l = o, h = a), l = Math.round(255 * (l + s)), c = Math.round(255 * (c + s)), h = Math.round(255 * (h + s)), new Er(l, c, h, r);
		}
	}, Mr = class e {
		static fromHex(t) {
		...
		get hsla() {
			return this._hsla ? this._hsla : Ar.fromRGBA(this.rgba);
		}
		get hsva() {
			return this._hsva ? this._hsva : Rr.fromRGBA(this.rgba);
		}
		constructor(e) {
			if (!e) throw new Error("Color needs a value");
			if (e instanceof Er) this.rgba = e;
			else if (e instanceof Ar) this._hsla = e, this.rgba = Ar.toRGBA(e);
			else {
				if (!(e instanceof Rr)) throw new Error("Invalid color ctor argument");
				this._hsva = e, this.rgba = Rr.toRGBA(e);
			}
		}
		equals(e) {
			return !!e && Er.equals(this.rgba, e.rgba) && Ar.equals(this.hsla, e.hsla) && Rr.equals(this.hsva, e.hsva);
		}
		getRelativeLuminance() {
			return Cr(.2126 * e._relativeLuminanceForComponent(this.rgba.r) + .7152 * e._relativeLuminanceForComponent(this.rgba.g) + .0722 * e._relativeLuminanceForComponent(this.rgba.b), 4);
		}
		...
		lighten(t) {
			return new e(new Ar(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
		}
		darken(t) {
			return new e(new Ar(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
		}
		transparent(t) {
			const { r: n, g: i, b: r, a: o } = this.rgba;
			return new e(new Er(n, i, r, o * t));
		}
		isTransparent() {
		...
		mix(t, n = .5) {
			const i = Math.min(Math.max(n, 0), 1), r = this.rgba, o = t.rgba;
			return new e(new Er(r.r + (o.r - r.r) * i, r.g + (o.g - r.g) * i, r.b + (o.b - r.b) * i, r.a + (o.a - r.a) * i));
		}
		makeOpaque(t) {
			if (this.isOpaque() || 1 !== t.rgba.a) return this;
			const { r: n, g: i, b: r, a: o } = this.rgba;
			return new e(new Er(t.rgba.r - o * (t.rgba.r - n), t.rgba.g - o * (t.rgba.g - i), t.rgba.b - o * (t.rgba.b - r), 1));
		}
		toString() {
		...
		static getLighterColor(e, t, n) {
			...
			return e.lighten(n = n * (r - i) / r);
		}
		static getDarkerColor(e, t, n) {
			if (e.isDarkerThan(t)) return e;
			n = n || .5;
			const i = e.getRelativeLuminance(), r = t.getRelativeLuminance();
			return e.darken(n = n * (i - r) / i);
		}
		static {
			this.white = new e(new Er(255, 255, 255, 1));
		}
		static {
			this.black = new e(new Er(0, 0, 0, 1));
		}
		static {
			this.red = new e(new Er(255, 0, 0, 1));
		}
		static {
			this.blue = new e(new Er(0, 0, 255, 1));
		}
		static {
			this.green = new e(new Er(0, 255, 0, 1));
		}
		static {
			this.cyan = new e(new Er(0, 255, 255, 1));
		}
		static {
			this.lightgrey = new e(new Er(211, 211, 211, 1));
		}
		static {
			this.transparent = new e(new Er(0, 0, 0, 0));
		}
	};
	function Nr(e) {
		const t = [];
	...
	function Or(e, t) {
		if (!e) return;
		const n = Mr.Format.CSS.parseHex(t);
		return n ? {
			range: e,
	...
	function Ur(e, t, n) {
		...
		const i = Nr(t[0].values());
		return {
			range: e,
			color: Ir(i[0], i[1], i[2], n ? i[3] : 1)
		};
	}
	function Hr(e, t, n) {
		if (!e || 1 !== t.length) return;
		const i = Nr(t[0].values()), r = new Mr(new Ar(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
		return {
			range: e,
			color: Ir(r.rgba.r, r.rgba.g, r.rgba.b, r.rgba.a)
		};
	}
	function Dr(e, t) {
	...
	(function(e) {
		...
		(function(t) {
			...
			function i(t) {
				...
				if (7 === n) return new e(new Er(16 * r(t.charCodeAt(1)) + r(t.charCodeAt(2)), 16 * r(t.charCodeAt(3)) + r(t.charCodeAt(4)), 16 * r(t.charCodeAt(5)) + r(t.charCodeAt(6)), 1));
				if (9 === n) return new e(new Er(16 * r(t.charCodeAt(1)) + r(t.charCodeAt(2)), 16 * r(t.charCodeAt(3)) + r(t.charCodeAt(4)), 16 * r(t.charCodeAt(5)) + r(t.charCodeAt(6)), (16 * r(t.charCodeAt(7)) + r(t.charCodeAt(8))) / 255));
				if (4 === n) {
					const n = r(t.charCodeAt(1)), i = r(t.charCodeAt(2)), o = r(t.charCodeAt(3));
					return new e(new Er(16 * n + n, 16 * i + i, 16 * o + o));
				}
				if (5 === n) {
					const n = r(t.charCodeAt(1)), i = r(t.charCodeAt(2)), o = r(t.charCodeAt(3)), a = r(t.charCodeAt(4));
					return new e(new Er(16 * n + n, 16 * i + i, 16 * o + o, (16 * a + a) / 255));
				}
				return null;
			}
			function r(e) {
			...
			t.formatRGB = function(t) {
				...
				if (t.startsWith("rgba(")) {
					...
					return new e(new Er(parseInt(n.groups?.r ?? "0"), parseInt(n.groups?.g ?? "0"), parseInt(n.groups?.b ?? "0"), parseFloat(n.groups?.a ?? "0")));
				}
				if (t.startsWith("rgb(")) {
					const n = t.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
					if (!n) throw new Error("Invalid color format " + t);
					return new e(new Er(parseInt(n.groups?.r ?? "0"), parseInt(n.groups?.g ?? "0"), parseInt(n.groups?.b ?? "0")));
				}
				return function(t) {
					switch (t) {
						case "aliceblue": return new e(new Er(240, 248, 255, 1));
						case "antiquewhite": return new e(new Er(250, 235, 215, 1));
						case "aqua":
						case "cyan": return new e(new Er(0, 255, 255, 1));
						case "aquamarine": return new e(new Er(127, 255, 212, 1));
						case "azure": return new e(new Er(240, 255, 255, 1));
						case "beige": return new e(new Er(245, 245, 220, 1));
						case "bisque": return new e(new Er(255, 228, 196, 1));
						case "black": return new e(new Er(0, 0, 0, 1));
						case "blanchedalmond": return new e(new Er(255, 235, 205, 1));
						case "blue": return new e(new Er(0, 0, 255, 1));
						case "blueviolet": return new e(new Er(138, 43, 226, 1));
						case "brown": return new e(new Er(165, 42, 42, 1));
						case "burlywood": return new e(new Er(222, 184, 135, 1));
						case "cadetblue": return new e(new Er(95, 158, 160, 1));
						case "chartreuse": return new e(new Er(127, 255, 0, 1));
						case "chocolate": return new e(new Er(210, 105, 30, 1));
						case "coral": return new e(new Er(255, 127, 80, 1));
						case "cornflowerblue": return new e(new Er(100, 149, 237, 1));
						case "cornsilk": return new e(new Er(255, 248, 220, 1));
						case "crimson": return new e(new Er(220, 20, 60, 1));
						case "darkblue": return new e(new Er(0, 0, 139, 1));
						case "darkcyan": return new e(new Er(0, 139, 139, 1));
						case "darkgoldenrod": return new e(new Er(184, 134, 11, 1));
						case "darkgray":
						case "darkgrey": return new e(new Er(169, 169, 169, 1));
						case "darkgreen": return new e(new Er(0, 100, 0, 1));
						case "darkkhaki": return new e(new Er(189, 183, 107, 1));
						case "darkmagenta": return new e(new Er(139, 0, 139, 1));
						case "darkolivegreen": return new e(new Er(85, 107, 47, 1));
						case "darkorange": return new e(new Er(255, 140, 0, 1));
						case "darkorchid": return new e(new Er(153, 50, 204, 1));
						case "darkred": return new e(new Er(139, 0, 0, 1));
						case "darksalmon": return new e(new Er(233, 150, 122, 1));
						case "darkseagreen": return new e(new Er(143, 188, 143, 1));
						case "darkslateblue": return new e(new Er(72, 61, 139, 1));
						case "darkslategray":
						case "darkslategrey": return new e(new Er(47, 79, 79, 1));
						case "darkturquoise": return new e(new Er(0, 206, 209, 1));
						case "darkviolet": return new e(new Er(148, 0, 211, 1));
						case "deeppink": return new e(new Er(255, 20, 147, 1));
						case "deepskyblue": return new e(new Er(0, 191, 255, 1));
						case "dimgray":
						case "dimgrey": return new e(new Er(105, 105, 105, 1));
						case "dodgerblue": return new e(new Er(30, 144, 255, 1));
						case "firebrick": return new e(new Er(178, 34, 34, 1));
						case "floralwhite": return new e(new Er(255, 250, 240, 1));
						case "forestgreen": return new e(new Er(34, 139, 34, 1));
						case "fuchsia":
						case "magenta": return new e(new Er(255, 0, 255, 1));
						case "gainsboro": return new e(new Er(220, 220, 220, 1));
						case "ghostwhite": return new e(new Er(248, 248, 255, 1));
						case "gold": return new e(new Er(255, 215, 0, 1));
						case "goldenrod": return new e(new Er(218, 165, 32, 1));
						case "gray":
						case "grey": return new e(new Er(128, 128, 128, 1));
						case "green": return new e(new Er(0, 128, 0, 1));
						case "greenyellow": return new e(new Er(173, 255, 47, 1));
						case "honeydew": return new e(new Er(240, 255, 240, 1));
						case "hotpink": return new e(new Er(255, 105, 180, 1));
						case "indianred": return new e(new Er(205, 92, 92, 1));
						case "indigo": return new e(new Er(75, 0, 130, 1));
						case "ivory": return new e(new Er(255, 255, 240, 1));
						case "khaki": return new e(new Er(240, 230, 140, 1));
						case "lavender": return new e(new Er(230, 230, 250, 1));
						case "lavenderblush": return new e(new Er(255, 240, 245, 1));
						case "lawngreen": return new e(new Er(124, 252, 0, 1));
						case "lemonchiffon": return new e(new Er(255, 250, 205, 1));
						case "lightblue": return new e(new Er(173, 216, 230, 1));
						case "lightcoral": return new e(new Er(240, 128, 128, 1));
						case "lightcyan": return new e(new Er(224, 255, 255, 1));
						case "lightgoldenrodyellow": return new e(new Er(250, 250, 210, 1));
						case "lightgray":
						case "lightgrey": return new e(new Er(211, 211, 211, 1));
						case "lightgreen": return new e(new Er(144, 238, 144, 1));
						case "lightpink": return new e(new Er(255, 182, 193, 1));
						case "lightsalmon": return new e(new Er(255, 160, 122, 1));
						case "lightseagreen": return new e(new Er(32, 178, 170, 1));
						case "lightskyblue": return new e(new Er(135, 206, 250, 1));
						case "lightslategray":
						case "lightslategrey": return new e(new Er(119, 136, 153, 1));
						case "lightsteelblue": return new e(new Er(176, 196, 222, 1));
						case "lightyellow": return new e(new Er(255, 255, 224, 1));
						case "lime": return new e(new Er(0, 255, 0, 1));
						case "limegreen": return new e(new Er(50, 205, 50, 1));
						case "linen": return new e(new Er(250, 240, 230, 1));
						case "maroon": return new e(new Er(128, 0, 0, 1));
						case "mediumaquamarine": return new e(new Er(102, 205, 170, 1));
						case "mediumblue": return new e(new Er(0, 0, 205, 1));
						case "mediumorchid": return new e(new Er(186, 85, 211, 1));
						case "mediumpurple": return new e(new Er(147, 112, 219, 1));
						case "mediumseagreen": return new e(new Er(60, 179, 113, 1));
						case "mediumslateblue": return new e(new Er(123, 104, 238, 1));
						case "mediumspringgreen": return new e(new Er(0, 250, 154, 1));
						case "mediumturquoise": return new e(new Er(72, 209, 204, 1));
						case "mediumvioletred": return new e(new Er(199, 21, 133, 1));
						case "midnightblue": return new e(new Er(25, 25, 112, 1));
						case "mintcream": return new e(new Er(245, 255, 250, 1));
						case "mistyrose": return new e(new Er(255, 228, 225, 1));
						case "moccasin": return new e(new Er(255, 228, 181, 1));
						case "navajowhite": return new e(new Er(255, 222, 173, 1));
						case "navy": return new e(new Er(0, 0, 128, 1));
						case "oldlace": return new e(new Er(253, 245, 230, 1));
						case "olive": return new e(new Er(128, 128, 0, 1));
						case "olivedrab": return new e(new Er(107, 142, 35, 1));
						case "orange": return new e(new Er(255, 165, 0, 1));
						case "orangered": return new e(new Er(255, 69, 0, 1));
						case "orchid": return new e(new Er(218, 112, 214, 1));
						case "palegoldenrod": return new e(new Er(238, 232, 170, 1));
						case "palegreen": return new e(new Er(152, 251, 152, 1));
						case "paleturquoise": return new e(new Er(175, 238, 238, 1));
						case "palevioletred": return new e(new Er(219, 112, 147, 1));
						case "papayawhip": return new e(new Er(255, 239, 213, 1));
						case "peachpuff": return new e(new Er(255, 218, 185, 1));
						case "peru": return new e(new Er(205, 133, 63, 1));
						case "pink": return new e(new Er(255, 192, 203, 1));
						case "plum": return new e(new Er(221, 160, 221, 1));
						case "powderblue": return new e(new Er(176, 224, 230, 1));
						case "purple": return new e(new Er(128, 0, 128, 1));
						case "rebeccapurple": return new e(new Er(102, 51, 153, 1));
						case "red": return new e(new Er(255, 0, 0, 1));
						case "rosybrown": return new e(new Er(188, 143, 143, 1));
						case "royalblue": return new e(new Er(65, 105, 225, 1));
						case "saddlebrown": return new e(new Er(139, 69, 19, 1));
						case "salmon": return new e(new Er(250, 128, 114, 1));
						case "sandybrown": return new e(new Er(244, 164, 96, 1));
						case "seagreen": return new e(new Er(46, 139, 87, 1));
						case "seashell": return new e(new Er(255, 245, 238, 1));
						case "sienna": return new e(new Er(160, 82, 45, 1));
						case "silver": return new e(new Er(192, 192, 192, 1));
						case "skyblue": return new e(new Er(135, 206, 235, 1));
						case "slateblue": return new e(new Er(106, 90, 205, 1));
						case "slategray":
						case "slategrey": return new e(new Er(112, 128, 144, 1));
						case "snow": return new e(new Er(255, 250, 250, 1));
						case "springgreen": return new e(new Er(0, 255, 127, 1));
						case "steelblue": return new e(new Er(70, 130, 180, 1));
						case "tan": return new e(new Er(210, 180, 140, 1));
						case "teal": return new e(new Er(0, 128, 128, 1));
						case "thistle": return new e(new Er(216, 191, 216, 1));
						case "tomato": return new e(new Er(255, 99, 71, 1));
						case "turquoise": return new e(new Er(64, 224, 208, 1));
						case "violet": return new e(new Er(238, 130, 238, 1));
						case "wheat": return new e(new Er(245, 222, 179, 1));
						case "white": return new e(new Er(255, 255, 255, 1));
						case "whitesmoke": return new e(new Er(245, 245, 245, 1));
						case "yellow": return new e(new Er(255, 255, 0, 1));
						case "yellowgreen": return new e(new Er(154, 205, 50, 1));
						default: return null;
					}
				}(t);
			}, t.parseHex = i;
	...
	var Kr = class {
		...
		_ensureNoFinalValue() {
			if (this._finalValue) throw new a("ProducerConsumer: cannot produce after final value has been set");
		}
		...
		constructor(e, t) {
			this._onReturn = t, this._producerConsumer = new Kr(), this._iterator = {
		...
		setValue(e, t) {
			return e = Ue(e), t = Ue(t), this.values[e] !== t && (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0);
		}
		removeValues(e, t) {
			e = Ue(e), t = Ue(t);
		...
		getIndexOf(e) {
			...
			let t = 0, n = this.values.length - 1, i = 0, r = 0, o = 0;
			for (; t <= n;) if (i = t + (n - t) / 2 | 0, r = this.prefixSum[i], o = r - this.values[i], e < o) n = i - 1;
			else {
				if (!(e >= r)) break;
				t = i + 1;
			}
		...
		onEvents(e) {
			...
			const t = e.changes;
			for (const n of t) this._acceptDeleteRange(n.range), this._acceptInsertText(new Ie(n.range.startLineNumber, n.range.startColumn), n.text);
		...
		$acceptNewModel(e) {
			this._models[e.url] = new Jr(Et.parse(e.url), e.lines, e.EOL, e.versionId);
		}
		...
		findMatches(e) {
			...
			for (let n = 0; n < this._lines.length; n++) {
				const i = this._lines[n], r = this.offsetAt(new Ie(n + 1, 1)), o = i.matchAll(e);
		...
		getWordAtPosition(e, t) {
			const n = mi(e.column, di(t), this._lines[e.lineNumber - 1], 0);
		...
		positionAt(e) {
			...
			return {
				...
				column: 1 + Math.min(t.remainder, this._lines[t.index].length)
			};
		}
		_validateRange(e) {
		...
		constructor(e = null) {
			this._foreignModule = e, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new Xr();
		}
		dispose() {}
		async $ping() {
			return "pong";
		...
		async $computeUnicodeHighlights(e, t, n) {
			...
			return i ? gi.computeUnicodeHighlights(i, t, n) : {
				ranges: [],
				hasMore: !1,
				...
				if (t.findMarkSectionHeaders) {
					const i = function(e, t) {
						...
						const r = function(e) {
							...
							return !1;
						}(t.markSectionHeaderRegex), o = new RegExp(t.markSectionHeaderRegex, "gdm" + (r ? "s" : ""));
						if ("^" !== (a = o).source && "^$" !== a.source && "$" !== a.source && "^\\s*$" !== a.source && a.exec("") && 0 === a.lastIndex) return n;
						var a;
						for (let s = 1; s <= i; s += 95) {
							const t = Math.min(s + 100 - 1, i), r = [];
							for (let n = s; n <= t; n++) r.push(e.getLineContent(n));
							const a = r.join("\n");
							let l;
							for (o.lastIndex = 0; null !== (l = o.exec(a));) {
								const e = a.substring(0, l.index), t = s + (e.match(/\n/g) || []).length, i = l[0].split("\n"), r = i.length, c = t + r - 1, h = e.lastIndexOf("\n") + 1, d = l.index - h + 1, u = {
									range: {
										startLineNumber: t,
										startColumn: d,
										endLineNumber: c,
										endColumn: 1 === r ? d + l[0].length : i[i.length - 1].length + 1
									},
									text: (l.groups ?? {}).label ?? "",
									hasSeparatorLine: "" !== ((l.groups ?? {}).separator ?? ""),
									shouldBeInComments: !0
								};
								(u.text || u.hasSeparatorLine) && (0 === n.length || n[n.length - 1].range.endLineNumber < u.range.startLineNumber) && n.push(u), o.lastIndex = l.index + l[0].length;
							}
						}
						return n;
					}(e, t);
		...
		async $computeDiff(t, n, i, r) {
			const o = this._getModel(t), a = this._getModel(n);
			return o && a ? e.computeDiff(o, a, i, r) : null;
		}
		static computeDiff(e, t, n, i) {
			const r = "advanced" === i ? new xr() : new Bi(), o = e.getLinesContent(), a = t.getLinesContent(), s = r.computeDiff(o, a, n);
			function l(e) {
				return e.map((e) => [
		...
		async $computeMoreMinimalEdits(t, n, i) {
			...
			const o = [];
			let a;
			n = n.slice(0).sort((e, t) => e.range && t.range ? ze.compareRangesUsingStarts(e.range, t.range) : (e.range ? 0 : 1) - (t.range ? 0 : 1));
			let s = 0;
			for (let e = 1; e < n.length; e++) ze.getEndPosition(n[s].range).equals(ze.getStartPosition(n[e].range)) ? (n[s].range = ze.fromPositions(ze.getStartPosition(n[s].range), ze.getEndPosition(n[e].range)), n[s].text += n[e].text) : (s++, n[s] = n[e]);
			n.length = s + 1;
			for (let { range: l, text: c, eol: h } of n) {
				if ("number" == typeof h && (a = h), ze.isEmpty(l) && !c) continue;
				...
				const n = Ee(t, c, i), s = r.offsetAt(ze.lift(l).getStartPosition());
				for (const e of n) {
					...
					r.getValueInRange(i.range) !== i.text && o.push(i);
				}
			}
			return "number" == typeof a && o.push({
				eol: a,
				text: "",
				range: {
					startLineNumber: 0,
		...
		async $computeLinks(e) {
			...
			return t ? function(e) {
				return e && "function" == typeof e.getLineCount && "function" == typeof e.getLineContent ? Fe.computeLinks(e) : [];
			}(t) : null;
		}
		async $computeDefaultDocumentColors(e) {
			...
			return t ? function(e) {
				return e && "function" == typeof e.getValue && "function" == typeof e.positionAt ? function(e) {
					const t = [], n = Dr(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|^(#)([A-Fa-f0-9]{3})\b|^(#)([A-Fa-f0-9]{4})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b|(?<=['"\s])(#)([A-Fa-f0-9]{3})\b|(?<=['"\s])(#)([A-Fa-f0-9]{4})\b|(?<=['"\s])(#)([A-Fa-f0-9]{6})\b|(?<=['"\s])(#)([A-Fa-f0-9]{8})\b/gm);
					if (n.length > 0) for (const i of n) {
						const n = i.filter((e) => void 0 !== e), r = n[1], o = n[2];
						if (!o) continue;
						let a;
						"rgb" === r ? a = Ur(zr(e, i), Dr(o, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm), !1) : "rgba" === r ? a = Ur(zr(e, i), Dr(o, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm), !0) : "hsl" === r ? a = Hr(zr(e, i), Dr(o, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm), !1) : "hsla" === r ? a = Hr(zr(e, i), Dr(o, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm), !0) : "#" === r && (a = Or(zr(e, i), r + o)), a && t.push(a);
					}
					return t;
				}(e) : [];
			}(t) : null;
		...
		async $textualSuggest(t, n, i, r) {
			const o = new v(), a = new RegExp(i, r), s = /* @__PURE__ */ new Set();
			e: for (const l of t) {
				const t = this._getModel(l);
				if (t) {
					for (const i of t.words(a)) if (i !== n && isNaN(Number(i)) && (s.add(i), s.size > e._suggestionsLimit)) break e;
				}
			}
			return {
				words: Array.from(s),
		...
		async $computeWordRanges(e, t, n, i) {
			...
			const o = new RegExp(n, i), a = Object.create(null);
			for (let s = t.startLineNumber; s < t.endLineNumber; s++) {
				const e = r.getLineWords(s, o);
				for (const t of e) {
					if (!isNaN(Number(t.word))) continue;
					let e = a[t.word];
					e || (e = [], a[t.word] = e), e.push({
						startLineNumber: s,
		...
		async $navigateValueSet(e, t, n, i, r) {
			...
			const s = o.getValueInRange(t), l = o.getWordAtPosition({
				lineNumber: t.startLineNumber,
				column: t.startColumn
			}, a);
			if (!l) return null;
			const c = o.getValueInRange(l);
			return Ve.INSTANCE.navigateValueSet(t, s, l, c, n);
		}
		$fmr(e, t) {
	...
	"function" == typeof importScripts && (globalThis.monaco = {
		...
		CancellationTokenSource: class {
			...
			cancel() {
				this._token ? this._token instanceof je && this._token.cancel() : this._token = Ke.Cancelled;
			}
			dispose(e = !1) {
				e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof je && this._token.dispose() : this._token = Ke.None;
			}
		},
		Emitter: C,
		KeyCode: Sn,
		...
		Selection: class e extends ze {
			...
			static createWithDirection(t, n, i, r, o) {
				return 0 === o ? new e(t, n, i, r) : new e(i, r, t, n);
			}
		},
	...
	function eo(...e) {
		...
		return o = i, a = r, 0 === Object.keys(a).length ? o : o.replace(Ca, (e, t) => a[t] ?? e);
		var o, a;
	}
	var to, no, io, ro, oo, ao, so, lo, co, ho, uo, mo, po, go, fo, bo, _o, wo, vo, yo, To, ko, So, Lo, xo, Co, Eo, Ao, Ro, Mo, No, Io, zo, Oo, Uo, Ho, Do, Wo, Po, qo, Fo, Vo, Bo, Ko, jo, Go, $o, Xo, Jo, Yo, Qo, Zo, ea, ta, na, ia, ra, oa, aa, sa, la, ca, ha, da, ua, ma, pa, ga, fa, ba, _a, wa, va, ya, Ta, ka, Sa, La, xa, Ca = /{([^}]+)}/g;
	(function(e) {
		e.is = function(e) {
		...
		e.create = function(e, t) {
			return e === Number.MAX_VALUE && (e = ro.MAX_VALUE), t === Number.MAX_VALUE && (t = ro.MAX_VALUE), {
				line: e,
				character: t
			};
		}, e.is = function(e) {
			let t = e;
			return Ea.objectLiteral(t) && Ea.uinteger(t.line) && Ea.uinteger(t.character);
		};
	}(oo || (oo = {})), function(e) {
		e.create = function(e, t, n, i) {
			if (Ea.uinteger(e) && Ea.uinteger(t) && Ea.uinteger(n) && Ea.uinteger(i)) return {
				start: oo.create(e, t),
				end: oo.create(n, i)
			};
			if (oo.is(e) && oo.is(t)) return {
				start: e,
				end: t
			};
			...
			let t = e;
			return Ea.objectLiteral(t) && oo.is(t.start) && oo.is(t.end);
		};
	}(ao || (ao = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			let t = e;
			return Ea.objectLiteral(t) && ao.is(t.range) && (Ea.string(t.uri) || Ea.undefined(t.uri));
		};
	}(so || (so = {})), function(e) {
		e.create = function(e, t, n, i) {
			return {
			...
			let t = e;
			return Ea.objectLiteral(t) && ao.is(t.targetRange) && Ea.string(t.targetUri) && ao.is(t.targetSelectionRange) && (ao.is(t.originSelectionRange) || Ea.undefined(t.originSelectionRange));
		};
	}(lo || (lo = {})), function(e) {
		e.create = function(e, t, n, i) {
			return {
			...
			const t = e;
			return Ea.objectLiteral(t) && Ea.numberRange(t.red, 0, 1) && Ea.numberRange(t.green, 0, 1) && Ea.numberRange(t.blue, 0, 1) && Ea.numberRange(t.alpha, 0, 1);
		};
	}(co || (co = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			const t = e;
			return Ea.objectLiteral(t) && ao.is(t.range) && co.is(t.color);
		};
	}(ho || (ho = {})), function(e) {
		e.create = function(e, t, n) {
			...
			const t = e;
			return Ea.objectLiteral(t) && Ea.string(t.label) && (Ea.undefined(t.textEdit) || yo.is(t)) && (Ea.undefined(t.additionalTextEdits) || Ea.typedArray(t.additionalTextEdits, yo.is));
		};
	}(uo || (uo = {})), function(e) {
		...
		e.create = function(e, t, n, i, r, o) {
			...
			return Ea.defined(n) && (a.startCharacter = n), Ea.defined(i) && (a.endCharacter = i), Ea.defined(r) && (a.kind = r), Ea.defined(o) && (a.collapsedText = o), a;
		}, e.is = function(e) {
			const t = e;
			return Ea.objectLiteral(t) && Ea.uinteger(t.startLine) && Ea.uinteger(t.startLine) && (Ea.undefined(t.startCharacter) || Ea.uinteger(t.startCharacter)) && (Ea.undefined(t.endCharacter) || Ea.uinteger(t.endCharacter)) && (Ea.undefined(t.kind) || Ea.string(t.kind));
		};
	}(po || (po = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			let t = e;
			return Ea.defined(t) && so.is(t.location) && Ea.string(t.message);
		};
	}(go || (go = {})), function(e) {
		...
		e.is = function(e) {
			const t = e;
			return Ea.objectLiteral(t) && Ea.string(t.href);
		};
	}(_o || (_o = {})), function(e) {
		e.create = function(e, t, n, i, r, o) {
			let a = {
			...
			return Ea.defined(n) && (a.severity = n), Ea.defined(i) && (a.code = i), Ea.defined(r) && (a.source = r), Ea.defined(o) && (a.relatedInformation = o), a;
		}, e.is = function(e) {
			var t;
			let n = e;
			return Ea.defined(n) && ao.is(n.range) && Ea.string(n.message) && (Ea.number(n.severity) || Ea.undefined(n.severity)) && (Ea.integer(n.code) || Ea.string(n.code) || Ea.undefined(n.code)) && (Ea.undefined(n.codeDescription) || Ea.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) && (Ea.string(n.source) || Ea.undefined(n.source)) && (Ea.undefined(n.relatedInformation) || Ea.typedArray(n.relatedInformation, go.is));
		};
	}(wo || (wo = {})), function(e) {
		e.create = function(e, t, ...n) {
			let i = {
			...
			return Ea.defined(n) && n.length > 0 && (i.arguments = n), i;
		}, e.is = function(e) {
			let t = e;
			return Ea.defined(t) && Ea.string(t.title) && Ea.string(t.command);
		};
	}(vo || (vo = {})), function(e) {
		e.replace = function(e, t) {
			...
			const t = e;
			return Ea.objectLiteral(t) && Ea.string(t.newText) && ao.is(t.range);
		};
	}(yo || (yo = {})), function(e) {
		e.create = function(e, t, n) {
			const i = { label: e };
			...
			const t = e;
			return Ea.objectLiteral(t) && Ea.string(t.label) && (Ea.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) && (Ea.string(t.description) || void 0 === t.description);
		};
	}(To || (To = {})), function(e) {
		e.is = function(e) {
			return Ea.string(e);
		...
		e.replace = function(e, t, n) {
			...
			const t = e;
			return yo.is(t) && (To.is(t.annotationId) || ko.is(t.annotationId));
		};
	}(So || (So = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			let t = e;
			return Ea.defined(t) && No.is(t.textDocument) && Array.isArray(t.edits);
		};
	}(Lo || (Lo = {})), function(e) {
		e.create = function(e, t, n) {
			let i = {
			...
			let t = e;
			return t && "create" === t.kind && Ea.string(t.uri) && (void 0 === t.options || (void 0 === t.options.overwrite || Ea.boolean(t.options.overwrite)) && (void 0 === t.options.ignoreIfExists || Ea.boolean(t.options.ignoreIfExists))) && (void 0 === t.annotationId || ko.is(t.annotationId));
		};
	}(xo || (xo = {})), function(e) {
		e.create = function(e, t, n, i) {
			let r = {
			...
			let t = e;
			return t && "rename" === t.kind && Ea.string(t.oldUri) && Ea.string(t.newUri) && (void 0 === t.options || (void 0 === t.options.overwrite || Ea.boolean(t.options.overwrite)) && (void 0 === t.options.ignoreIfExists || Ea.boolean(t.options.ignoreIfExists))) && (void 0 === t.annotationId || ko.is(t.annotationId));
		};
	}(Co || (Co = {})), function(e) {
		e.create = function(e, t, n) {
			let i = {
			...
			let t = e;
			return t && "delete" === t.kind && Ea.string(t.uri) && (void 0 === t.options || (void 0 === t.options.recursive || Ea.boolean(t.options.recursive)) && (void 0 === t.options.ignoreIfNotExists || Ea.boolean(t.options.ignoreIfNotExists))) && (void 0 === t.annotationId || ko.is(t.annotationId));
		};
	}(Eo || (Eo = {})), function(e) {
		e.is = function(e) {
			return e && (void 0 !== e.changes || void 0 !== e.documentChanges) && (void 0 === e.documentChanges || e.documentChanges.every((e) => Ea.string(e.kind) ? xo.is(e) || Co.is(e) || Eo.is(e) : Lo.is(e)));
		};
	}(Ao || (Ao = {})), function(e) {
		e.create = function(e) {
			return { uri: e };
			...
			let t = e;
			return Ea.defined(t) && Ea.string(t.uri);
		};
	}(Ro || (Ro = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			let t = e;
			return Ea.defined(t) && Ea.string(t.uri) && Ea.integer(t.version);
		};
	}(Mo || (Mo = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			let t = e;
			return Ea.defined(t) && Ea.string(t.uri) && (null === t.version || Ea.integer(t.version));
		};
	}(No || (No = {})), function(e) {
		e.create = function(e, t, n, i) {
			return {
			...
			let t = e;
			return Ea.defined(t) && Ea.string(t.uri) && Ea.string(t.languageId) && Ea.integer(t.version) && Ea.string(t.text);
		};
	}(Io || (Io = {})), function(e) {
		...
		e.is = function(e) {
			const t = e;
			return Ea.objectLiteral(e) && zo.is(t.kind) && Ea.string(t.value);
		};
	}(Oo || (Oo = {})), function(e) {
		...
		e.create = function(e, t, n) {
			...
			const t = e;
			return t && Ea.string(t.newText) && ao.is(t.insert) && ao.is(t.replace);
		};
	}(Wo || (Wo = {})), function(e) {
		...
		e.is = function(e) {
			const t = e;
			return t && (Ea.string(t.detail) || void 0 === t.detail) && (Ea.string(t.description) || void 0 === t.description);
		};
	}(qo || (qo = {})), function(e) {
		e.create = function(e) {
			return { label: e };
		...
		e.fromPlainText = function(e) {
			...
			const t = e;
			return Ea.string(t) || Ea.objectLiteral(t) && Ea.string(t.language) && Ea.string(t.value);
		};
	}(Bo || (Bo = {})), function(e) {
		e.is = function(e) {
			let t = e;
			return !!t && Ea.objectLiteral(t) && (Oo.is(t.contents) || Bo.is(t.contents) || Ea.typedArray(t.contents, Bo.is)) && (void 0 === e.range || ao.is(e.range));
		};
	}(Ko || (Ko = {})), function(e) {
		e.create = function(e, t) {
			return t ? {
		...
		e.create = function(e, t, ...n) {
			let i = { label: e };
			return Ea.defined(t) && (i.documentation = t), i.parameters = Ea.defined(n) ? n : [], i;
		};
	}(Go || (Go = {})), function(e) {
		...
		e.create = function(e, t, n, i, r, o) {
			...
			let t = e;
			return t && Ea.string(t.name) && Ea.number(t.kind) && ao.is(t.range) && ao.is(t.selectionRange) && (void 0 === t.detail || Ea.string(t.detail)) && (void 0 === t.deprecated || Ea.boolean(t.deprecated)) && (void 0 === t.children || Array.isArray(t.children)) && (void 0 === t.tags || Array.isArray(t.tags));
		};
	}(ea || (ea = {})), function(e) {
		...
		e.create = function(e, t, n) {
			...
			let t = e;
			return Ea.defined(t) && Ea.typedArray(t.diagnostics, wo.is) && (void 0 === t.only || Ea.typedArray(t.only, Ea.string)) && (void 0 === t.triggerKind || t.triggerKind === na.Invoked || t.triggerKind === na.Automatic);
		};
	}(ia || (ia = {})), function(e) {
		e.create = function(e, t, n) {
			let i = { title: e }, r = !0;
			return "string" == typeof t ? (r = !1, i.kind = t) : vo.is(t) ? i.command = t : i.edit = t, r && void 0 !== n && (i.kind = n), i;
		}, e.is = function(e) {
			let t = e;
			return t && Ea.string(t.title) && (void 0 === t.diagnostics || Ea.typedArray(t.diagnostics, wo.is)) && (void 0 === t.kind || Ea.string(t.kind)) && (void 0 !== t.edit || void 0 !== t.command) && (void 0 === t.command || vo.is(t.command)) && (void 0 === t.isPreferred || Ea.boolean(t.isPreferred)) && (void 0 === t.edit || Ao.is(t.edit));
		};
	}(ra || (ra = {})), function(e) {
		e.create = function(e, t) {
			let n = { range: e };
			return Ea.defined(t) && (n.data = t), n;
		}, e.is = function(e) {
			let t = e;
			return Ea.defined(t) && ao.is(t.range) && (Ea.undefined(t.command) || vo.is(t.command));
		};
	}(oa || (oa = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			let t = e;
			return Ea.defined(t) && Ea.uinteger(t.tabSize) && Ea.boolean(t.insertSpaces);
		};
	}(aa || (aa = {})), function(e) {
		e.create = function(e, t, n) {
			return {
			...
			let t = e;
			return Ea.defined(t) && ao.is(t.range) && (Ea.undefined(t.target) || Ea.string(t.target));
		};
	}(sa || (sa = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			let n = t;
			return Ea.objectLiteral(n) && ao.is(n.range) && (void 0 === n.parent || e.is(n.parent));
		};
	}(la || (la = {})), function(e) {
		...
		e.is = function(e) {
			const t = e;
			return Ea.objectLiteral(t) && (void 0 === t.resultId || "string" == typeof t.resultId) && Array.isArray(t.data) && (0 === t.data.length || "number" == typeof t.data[0]);
		};
	}(da || (da = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			const t = e;
			return null != t && ao.is(t.range) && Ea.string(t.text);
		};
	}(ua || (ua = {})), function(e) {
		e.create = function(e, t, n) {
			return {
			...
			const t = e;
			return null != t && ao.is(t.range) && Ea.boolean(t.caseSensitiveLookup) && (Ea.string(t.variableName) || void 0 === t.variableName);
		};
	}(ma || (ma = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			const t = e;
			return null != t && ao.is(t.range) && (Ea.string(t.expression) || void 0 === t.expression);
		};
	}(pa || (pa = {})), function(e) {
		e.create = function(e, t) {
			return {
			...
			return Ea.defined(e) && ao.is(e.stoppedLocation);
		};
	}(ga || (ga = {})), function(e) {
		...
		e.create = function(e) {
			...
			const t = e;
			return Ea.objectLiteral(t) && (void 0 === t.tooltip || Ea.string(t.tooltip) || Oo.is(t.tooltip)) && (void 0 === t.location || so.is(t.location)) && (void 0 === t.command || vo.is(t.command));
		};
	}(ba || (ba = {})), function(e) {
		e.create = function(e, t, n) {
			const i = {
			...
			const t = e;
			return Ea.objectLiteral(t) && oo.is(t.position) && (Ea.string(t.label) || Ea.typedArray(t.label, ba.is)) && (void 0 === t.kind || fa.is(t.kind)) && void 0 === t.textEdits || Ea.typedArray(t.textEdits, yo.is) && (void 0 === t.tooltip || Ea.string(t.tooltip) || Oo.is(t.tooltip)) && (void 0 === t.paddingLeft || Ea.boolean(t.paddingLeft)) && (void 0 === t.paddingRight || Ea.boolean(t.paddingRight));
		};
	}(_a || (_a = {})), function(e) {
		...
		e.is = function(e) {
			const t = e;
			return Ea.objectLiteral(t) && no.is(t.uri) && Ea.string(t.name);
		};
	}(La || (La = {})), function(e) {
		function t(e, n) {
			if (e.length <= 1) return e;
			const i = e.length / 2 | 0, r = e.slice(0, i), o = e.slice(i);
			t(r, n), t(o, n);
			let a = 0, s = 0, l = 0;
			for (; a < r.length && s < o.length;) n(r[a], o[s]) <= 0 ? e[l++] = r[a++] : e[l++] = o[s++];
			for (; a < r.length;) e[l++] = r[a++];
			for (; s < o.length;) e[l++] = o[s++];
			return e;
		}
		e.create = function(e, t, n, i) {
			return new Aa(e, t, n, i);
		}, e.is = function(e) {
			let t = e;
			return !!(Ea.defined(t) && Ea.string(t.uri) && (Ea.undefined(t.languageId) || Ea.string(t.languageId)) && Ea.uinteger(t.lineCount) && Ea.func(t.getText) && Ea.func(t.positionAt) && Ea.func(t.offsetAt));
			...
			for (let t = r.length - 1; t >= 0; t--) {
				let n = r[t], a = e.offsetAt(n.range.start), s = e.offsetAt(n.range.end);
				if (!(s <= o)) throw new Error("Overlapping edit");
				i = i.substring(0, a) + n.newText + i.substring(s, i.length), o = a;
			}
			return i;
		};
	}(xa || (xa = {}));
	var Ea, Aa = class {
		...
		positionAt(e) {
			...
			if (0 === i) return oo.create(0, e);
			for (; n < i;) {
				let r = Math.floor((n + i) / 2);
				t[r] > e ? i = r : n = r + 1;
			}
			let r = n - 1;
			return oo.create(r, e - t[r]);
		}
		offsetAt(e) {
	...
	var Ra, Ma, Na, Ia, za, Oa = class e {
		...
		update(t, n) {
			for (let i of t) if (e.isIncremental(i)) {
				const e = Da(i.range), t = this.offsetAt(e.start), n = this.offsetAt(e.end);
				this._content = this._content.substring(0, t) + i.text + this._content.substring(n, this._content.length);
				const r = Math.max(e.start.line, 0), o = Math.max(e.end.line, 0);
				let a = this._lineOffsets;
				const s = Ha(i.text, !1, t);
				if (o - r === s.length) for (let i = 0, c = s.length; i < c; i++) a[i + r + 1] = s[i];
				else s.length < 1e4 ? a.splice(r + 1, o - r, ...s) : this._lineOffsets = a = a.slice(0, r + 1).concat(s, a.slice(o + 1));
				const l = i.text.length - (n - t);
				if (0 !== l) for (let i = r + 1 + s.length, c = a.length; i < c; i++) a[i] = a[i] + l;
			} else {
		...
		getLineOffsets() {
			return void 0 === this._lineOffsets && (this._lineOffsets = Ha(this._content, !0)), this._lineOffsets;
		}
		positionAt(e) {
			e = Math.max(Math.min(e, this._content.length), 0);
			let t = this.getLineOffsets(), n = 0, i = t.length;
	...
	function Ua(e, t) {
		...
		Ua(i, t), Ua(r, t);
		let o = 0, a = 0, s = 0;
		for (; o < i.length && a < r.length;) t(i[o], r[a]) <= 0 ? e[s++] = i[o++] : e[s++] = r[a++];
	...
	(function(e) {
		e.create = function(e, t, n, i) {
			return new Oa(e, t, n, i);
		}, e.update = function(e, t, n) {
			if (e instanceof Oa) return e.update(t, n), e;
			throw new Error("TextDocument.update: document must be created by TextDocument.create");
		}, e.applyEdits = function(e, t) {
			let n = e.getText(), i = Ua(t.map(Wa), (e, t) => {
				let n = e.range.start.line - t.range.start.line;
				return 0 === n ? e.range.start.character - t.range.start.character : n;
			}), r = 0;
			const o = [];
			for (const a of i) {
				let t = e.offsetAt(a.range.start);
				if (t < r) throw new Error("Overlapping edit");
				t > r && o.push(n.substring(r, t)), a.newText.length && o.push(a.newText), r = e.offsetAt(a.range.end);
			}
		...
		e.LATEST = { textDocument: {
			completion: { completionItem: { documentationFormat: [zo.Markdown, zo.PlainText] } },
			hover: { contentFormat: [zo.Markdown, zo.PlainText] }
		} };
	}(Ia || (Ia = {})), function(e) {
	...
	var Pa = class {
		...
		skipWhitespace() {
			return this.advanceWhileChar((e) => e === Qa || e === Za || e === Xa || e === Ya || e === Ja) > 0;
		}
		advanceWhileChar(e) {
	...
	const qa = "!".charCodeAt(0), Fa = "-".charCodeAt(0), Va = "<".charCodeAt(0), Ba = ">".charCodeAt(0), Ka = "/".charCodeAt(0), ja = "=".charCodeAt(0), Ga = "\"".charCodeAt(0), $a = "'".charCodeAt(0), Xa = "\n".charCodeAt(0), Ja = "\r".charCodeAt(0), Ya = "\f".charCodeAt(0), Qa = " ".charCodeAt(0), Za = "	".charCodeAt(0), es = {
		"text/x-handlebars-template": !0,
		"text/html": !0
	};
	function ts(e, t = 0, n = Na.WithinContent, i = !1) {
		const r = new Pa(e, t);
		let o, a, s, l, c, h = n, d = 0, u = Ma.Unknown;
		function m() {
			return r.advanceIfRegExp(/^[_:\w][_:\w-.\d]*/).toLowerCase();
		}
		function p(e, t, n) {
			return u = t, d = e, o = n, t;
		}
		function g() {
			const e = r.pos();
			if (r.eos()) return p(e, Ma.EOS);
			let t;
			switch (h) {
				case Na.WithinComment: return r.advanceIfChars([
					Fa,
					Fa,
					Ba
				]) ? (h = Na.WithinContent, p(e, Ma.EndCommentTag)) : (r.advanceUntilChars([
					Fa,
					Fa,
					Ba
				]), p(e, Ma.Comment));
				case Na.WithinDoctype: return r.advanceIfChar(Ba) ? (h = Na.WithinContent, p(e, Ma.EndDoctypeTag)) : (r.advanceUntilChar(Ba), p(e, Ma.Doctype));
				case Na.WithinContent:
					if (r.advanceIfChar(Va)) {
						if (!r.eos() && r.peekChar() === qa) {
							if (r.advanceIfChars([
								qa,
								Fa,
								Fa
							])) return h = Na.WithinComment, p(e, Ma.StartCommentTag);
							if (r.advanceIfRegExp(/^!doctype/i)) return h = Na.WithinDoctype, p(e, Ma.StartDoctypeTag);
						}
						return r.advanceIfChar(Ka) ? (h = Na.AfterOpeningEndTag, p(e, Ma.EndTagOpen)) : (h = Na.AfterOpeningStartTag, p(e, Ma.StartTagOpen));
					}
					return r.advanceUntilChar(Va), p(e, Ma.Content);
				case Na.AfterOpeningEndTag: return m().length > 0 ? (h = Na.WithinEndTag, p(e, Ma.EndTag)) : r.skipWhitespace() ? p(e, Ma.Whitespace, eo("Tag name must directly follow the open bracket.")) : (h = Na.WithinEndTag, r.advanceUntilChar(Ba), e < r.pos() ? p(e, Ma.Unknown, eo("End tag name expected.")) : g());
				case Na.WithinEndTag:
					if (r.skipWhitespace()) return p(e, Ma.Whitespace);
					if (r.advanceIfChar(Ba)) return h = Na.WithinContent, p(e, Ma.EndTagClose);
					if (i && r.peekChar() === Va) return h = Na.WithinContent, p(e, Ma.EndTagClose, eo("Closing bracket missing."));
					t = eo("Closing bracket expected.");
					break;
				case Na.AfterOpeningStartTag: return s = m(), c = void 0, l = void 0, s.length > 0 ? (a = !1, h = Na.WithinTag, p(e, Ma.StartTag)) : r.skipWhitespace() ? p(e, Ma.Whitespace, eo("Tag name must directly follow the open bracket.")) : (h = Na.WithinTag, r.advanceUntilChar(Ba), e < r.pos() ? p(e, Ma.Unknown, eo("Start tag name expected.")) : g());
				case Na.WithinTag: return r.skipWhitespace() ? (a = !0, p(e, Ma.Whitespace)) : a && (l = r.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase(), l.length > 0) ? (h = Na.AfterAttributeName, a = !1, p(e, Ma.AttributeName)) : r.advanceIfChars([Ka, Ba]) ? (h = Na.WithinContent, p(e, Ma.StartTagSelfClose)) : r.advanceIfChar(Ba) ? (h = "script" === s ? c && es[c] ? Na.WithinContent : Na.WithinScriptContent : "style" === s ? Na.WithinStyleContent : Na.WithinContent, p(e, Ma.StartTagClose)) : i && r.peekChar() === Va ? (h = Na.WithinContent, p(e, Ma.StartTagClose, eo("Closing bracket missing."))) : (r.advance(1), p(e, Ma.Unknown, eo("Unexpected character in tag.")));
				case Na.AfterAttributeName: return r.skipWhitespace() ? (a = !0, p(e, Ma.Whitespace)) : r.advanceIfChar(ja) ? (h = Na.BeforeAttributeValue, p(e, Ma.DelimiterAssign)) : (h = Na.WithinTag, g());
				case Na.BeforeAttributeValue:
					if (r.skipWhitespace()) return p(e, Ma.Whitespace);
					let n = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
					if (n.length > 0 && (r.peekChar() === Ba && r.peekChar(-1) === Ka && (r.goBack(1), n = n.substring(0, n.length - 1)), "type" === l && (c = n), n.length > 0)) return h = Na.WithinTag, a = !1, p(e, Ma.AttributeValue);
					const o = r.peekChar();
					return o === $a || o === Ga ? (r.advance(1), r.advanceUntilChar(o) && r.advance(1), "type" === l && (c = r.getSource().substring(e + 1, r.pos() - 1)), h = Na.WithinTag, a = !1, p(e, Ma.AttributeValue)) : (h = Na.WithinTag, a = !1, g());
				case Na.WithinScriptContent:
					let d = 1;
					for (; !r.eos();) {
						const t = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
						if (0 === t.length) return r.goToEnd(), p(e, Ma.Script);
						if ("<!--" === t) 1 === d && (d = 2);
						else if ("-->" === t) d = 1;
						else if ("/" !== t[1]) 2 === d && (d = 3);
						else {
					...
					return h = Na.WithinContent, e < r.pos() ? p(e, Ma.Script) : g();
				case Na.WithinStyleContent: return r.advanceUntilRegExp(/<\/style/i), h = Na.WithinContent, e < r.pos() ? p(e, Ma.Styles) : g();
			}
			return r.advance(1), h = Na.WithinContent, p(e, Ma.Unknown, t);
		}
		return {
			scan: function() {
				const e = r.pos(), t = h, n = g();
				return n === Ma.EOS || e !== r.pos() || i && (n === Ma.StartTagClose || n === Ma.EndTagClose) ? n : (console.warn("Scanner.scan has not advanced at offset " + e + ", state before: " + t + " after: " + h), r.advance(1), p(e, Ma.Unknown));
			},
			getTokenType: () => u,
			getTokenOffset: () => d,
	...
	var is = class {
		...
		findNodeBefore(e) {
			const t = ns(this.children, (t) => e <= t.start) - 1;
			if (t >= 0) {
		...
		parse(e, t) {
			const n = ts(e, void 0, void 0, !0), i = new is(0, e.length, [], void 0);
			let r, o = i, a = -1, s = null, l = n.scan();
			for (; l !== Ma.EOS;) {
				switch (l) {
					case Ma.StartTagOpen:
						const i = new is(n.getTokenOffset(), e.length, [], o);
						o.children.push(i), o = i;
						break;
					case Ma.StartTag:
						o.tag = n.getTokenText();
						break;
					case Ma.StartTagClose:
						o.parent && (o.end = n.getTokenEnd(), n.getTokenLength() ? (o.startTagEnd = n.getTokenEnd(), o.tag && this.dataManager.isVoidElement(o.tag, t) && (o.closed = !0, o = o.parent)) : o = o.parent);
						break;
					case Ma.StartTagSelfClose:
						o.parent && (o.closed = !0, o.end = n.getTokenEnd(), o.startTagEnd = n.getTokenEnd(), o = o.parent);
						break;
					case Ma.EndTagOpen:
						a = n.getTokenOffset(), r = void 0;
						break;
					case Ma.EndTag:
					...
					case Ma.EndTagClose:
						...
						if (l.parent) {
							for (; o !== l;) o.end = a, o.closed = !1, o = o.parent;
							o.closed = !0, o.endTagStart = a, o.end = n.getTokenEnd(), o = o.parent;
						}
						break;
					case Ma.AttributeName: {
						s = n.getTokenText();
						let e = o.attributes;
						e || (o.attributes = e = {}), e[s] = null;
						break;
					}
					case Ma.AttributeValue: {
						const e = n.getTokenText(), t = o.attributes;
						t && s && (t[s] = e, s = null);
						break;
					}
				}
			...
			for (; o.parent;) o.end = e.length, o.closed = !1, o = o.parent;
			return {
				roots: i.children,
	...
	const cs = "a".charCodeAt(0), hs = "z".charCodeAt(0), ds = "A".charCodeAt(0), us = "Z".charCodeAt(0), ms = "0".charCodeAt(0), ps = "9".charCodeAt(0);
	function gs(e, t) {
		const n = e.charCodeAt(t);
		return cs <= n && n <= hs || ds <= n && n <= us || ms <= n && n <= ps;
	}
	function fs(e) {
		return void 0 !== e;
	}
	...
	var ws = class {
		...
		async computeCompletions(e, t) {
			...
			for (const i of this.atributeCompletions) {
				const r = ys(e.getText(i.range));
				if (Ts(r)) if ("." === r || ".." === r) n.isIncomplete = !0;
				else {
					const o = ks(i.value, r, i.range), a = await this.providePathSuggestions(i.value, o, e, t);
					for (const e of a) n.items.push(e);
				}
			}
			return n;
		}
		async providePathSuggestions(e, t, n, i) {
			...
			let o = i.resolveReference(r || ".", n.uri);
			if (o) try {
				const e = [], n = await this.readDirectory(o);
				for (const [i, r] of n) i.charCodeAt(0) !== vs && e.push(Ss(i, r === za.Directory, t));
				return e;
			} catch (dl) {}
			return [];
		}
	};
	const vs = ".".charCodeAt(0);
	function ys(e) {
		return as(e, "'") || as(e, "\"") ? e.slice(1, -1) : e;
	}
	function Ts(e) {
		return !(as(e, "http") || as(e, "https") || as(e, "//"));
	}
	function ks(e, t, n) {
		let i;
		const r = e.lastIndexOf("/");
		if (-1 === r) i = function(e) {
			const t = Ls(e.start, 1), n = Ls(e.end, -1);
			return ao.create(t, n);
		}(n);
		else {
			const e = t.slice(r + 1), o = Ls(n.end, -1 - e.length), a = e.indexOf(" ");
			let s;
			s = -1 !== a ? Ls(o, a) : Ls(n.end, -1), i = ao.create(o, s);
		}
		return i;
	}
	function Ss(e, t, n) {
	...
	function Ls(e, t) {
		return oo.create(e.line, e.character + t);
	}
	var xs = class {
		constructor(e, t) {
		...
		async doComplete2(e, t, n, i, r) {
			...
			const o = new ws(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), a = this.completionParticipants;
			this.completionParticipants = [o].concat(a);
			const s = this.doComplete(e, t, n, r);
			try {
				const t = await o.computeCompletions(e, i);
				return {
		...
		_doComplete(e, t, n, i) {
			const r = {
				isIncomplete: !1,
				items: []
			}, o = this.completionParticipants, a = this.dataManager.getDataProviders().filter((t) => t.isApplicable(e.languageId) && (!i || !1 !== i[t.getId()])), s = this.dataManager.getVoidElements(a), l = this.doesSupportMarkdown(), c = e.getText(), h = e.offsetAt(t), d = n.findNodeBefore(h);
			if (!d) return r;
			const u = ts(c, d.start);
			let m, p = "";
			function g(t, n = h) {
				return t > h && (t = h), {
				...
				return a.forEach((e) => {
					e.provideTags().forEach((e) => {
						r.items.push({
							label: e.name,
							kind: Uo.Property,
							documentation: _s(e, void 0, l),
							textEdit: yo.replace(n, e.name),
							insertTextFormat: Ho.PlainText
						});
					});
				}), r;
			}
			...
			function _(e, t, n = h) {
				const i = g(e, n), o = Es(c, n, Na.WithinEndTag, Ma.EndTagClose) ? "" : ">";
				let s = d;
				for (t && (s = s.parent); s;) {
					const t = s.tag;
					if (t && (!s.closed || s.endTagStart && s.endTagStart > h)) {
						const n = {
							...
							kind: Uo.Property,
							filterText: "/" + t,
							textEdit: yo.replace(i, "/" + t + o),
							insertTextFormat: Ho.PlainText
						}, a = b(s.start), l = b(e - 1);
						if (null !== a && null !== l && a !== l) {
							const i = a + "</" + t + o;
							n.textEdit = yo.replace(g(e - 1 - l.length), i), n.filterText = l + "</" + t;
						}
				...
				return t || a.forEach((e) => {
					e.provideTags().forEach((e) => {
						r.items.push({
							...
							documentation: _s(e, void 0, l),
							filterText: "/" + e.name + o,
							textEdit: yo.replace(i, "/" + e.name + o),
							insertTextFormat: Ho.PlainText
						});
					});
				}), r;
			...
			const w = (t, n) => {
				...
				if (!this.dataManager.isVoidElement(n, s)) {
					...
					r.items.push({
						...
						kind: Uo.Property,
						filterText: "</" + n + ">",
						textEdit: yo.insert(i, "$0</" + n + ">"),
						insertTextFormat: Ho.Snippet
					});
				}
				return r;
			};
			...
			function y(e, t = h) {
				let o = h;
				for (; o < t && "<" !== c[o];) o++;
				const s = c.substring(e, t), u = g(e, o);
				let m = "";
				if (!Es(c, t, Na.AfterAttributeName, Ma.DelimiterAssign)) {
				...
				return f[s] = !1, a.forEach((e) => {
					e.provideAttributes(p).forEach((e) => {
						...
						"v" !== e.valueSet && m.length && (n += m, (e.valueSet || "style" === e.name) && (t = {
							...
							label: e.name,
							kind: "handler" === e.valueSet ? Uo.Function : Uo.Value,
							documentation: _s(e, void 0, l),
							textEdit: yo.replace(u, n),
							insertTextFormat: Ho.Snippet,
							command: t
						});
					});
					...
					function a(e) {
						e.attributeNames.forEach((e) => {
							!as(e, i) || o[e] || t[e] || (o[e] = e + "=\"$1\"");
						}), e.children.forEach((e) => a(e));
					}
					o[i] = `${i}$1="$2"`, n && n.roots.forEach((e) => a(e)), Object.keys(o).forEach((t) => r.items.push({
						label: t,
						kind: Uo.Value,
						textEdit: yo.replace(e, o[t]),
						insertTextFormat: Ho.Snippet
					}));
				}(u, f), r;
			}
			function T(n, i = h) {
				...
				if (o.length > 0) {
					const r = p.toLowerCase(), a = m.toLowerCase(), s = g(n, i);
					for (const n of o) n.onHtmlAttributeValue && n.onHtmlAttributeValue({
						document: e,
						position: t,
						tag: r,
						attribute: a,
			...
			function S() {
				for (const n of o) n.onHtmlContent && n.onHtmlContent({
					document: e,
					position: t
				});
				return L();
			...
			function L() {
				...
				for (; e >= 0 && gs(c, e);) e--, n--;
				if (e >= 0 && "&" === c[e]) {
					const e = ao.create(oo.create(t.line, n - 1), t);
					for (const t in os) if (ss(t, ";")) {
						const n = "&" + t;
						r.items.push({
							label: n,
							kind: Uo.Keyword,
							documentation: eo("Character entity representing '{0}'", os[t]),
							textEdit: yo.replace(e, n),
							insertTextFormat: Ho.PlainText
						});
					}
				}
			...
			function x(e, t) {
				...
				r.items.push({
					...
					textEdit: yo.replace(n, "!DOCTYPE html>"),
					insertTextFormat: Ho.PlainText
				});
			}
			let C = u.scan();
			for (; C !== Ma.EOS && u.getTokenOffset() <= h;) {
				switch (C) {
					case Ma.StartTagOpen:
						if (u.getTokenEnd() === h) {
							const e = k(Ma.StartTag);
					...
					case Ma.AttributeName:
						...
						m = u.getTokenText();
						break;
					case Ma.DelimiterAssign:
						if (u.getTokenEnd() === h) return T(h, k(Ma.AttributeValue));
						break;
					case Ma.AttributeValue:
					...
					case Ma.Whitespace:
						if (h <= u.getTokenEnd()) switch (u.getScannerState()) {
							case Na.AfterOpeningStartTag: return v(u.getTokenOffset(), k(Ma.StartTag));
							case Na.WithinTag:
							case Na.AfterAttributeName: return y(u.getTokenEnd());
							case Na.BeforeAttributeValue: return T(u.getTokenEnd());
							case Na.AfterOpeningEndTag: return _(u.getTokenOffset() - 1, !1);
							case Na.WithinContent: return S();
						}
						break;
					case Ma.EndTagOpen:
						if (h <= u.getTokenEnd()) return _(u.getTokenOffset() + 1, !1, k(Ma.EndTag));
						break;
					case Ma.EndTag:
						if (h <= u.getTokenEnd()) {
		...
		doQuoteComplete(e, t, n, i) {
			...
			if (r <= 0) return null;
			const o = i?.attributeDefaultValue ?? "doublequotes";
			if ("empty" === o) return null;
			if ("=" !== e.getText().charAt(r - 1)) return null;
			const a = "doublequotes" === o ? "\"$1\"" : "'$1'", s = n.findNodeBefore(r);
			if (s && s.attributes && s.start < r && (!s.endTagStart || s.endTagStart > r)) {
				const t = ts(e.getText(), s.start);
				let n = t.scan();
				for (; n !== Ma.EOS && t.getTokenEnd() <= r;) {
					if (n === Ma.AttributeName && t.getTokenEnd() === r - 1) return n = t.scan(), n !== Ma.DelimiterAssign ? null : (n = t.scan(), n === Ma.Unknown || n === Ma.AttributeValue ? null : a);
					n = t.scan();
				}
			}
			return null;
		...
		doTagComplete(e, t, n) {
			...
			if (">" === r) {
				...
				if (r && r.tag && !this.dataManager.isVoidElement(r.tag, t) && r.start < i && (!r.endTagStart || r.endTagStart > i)) {
					const t = ts(e.getText(), r.start);
					let n = t.scan();
					for (; n !== Ma.EOS && t.getTokenEnd() <= i;) {
						if (n === Ma.StartTagClose && t.getTokenEnd() === i) return `$0</${r.tag}>`;
						n = t.scan();
					}
				}
			} else if ("/" === r) {
				...
				if (t && t.tag) {
					const n = ts(e.getText(), t.start);
					let r = n.scan();
					for (; r !== Ma.EOS && n.getTokenEnd() <= i;) {
						if (r === Ma.EndTagOpen && n.getTokenEnd() === i) return ">" !== e.getText().charAt(i) ? `${t.tag}>` : t.tag;
						r = n.scan();
					}
				}
			}
		...
		doesSupportMarkdown() {
			if (!fs(this.supportsMarkdown)) {
				if (!fs(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
				const e = this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat;
				this.supportsMarkdown = Array.isArray(e) && -1 !== e.indexOf(zo.Markdown);
			}
	...
	var As, Rs, Ms = class {
		...
		doHover(e, t, n, i) {
			const r = this.convertContents.bind(this), o = this.doesSupportMarkdown(), a = e.offsetAt(t), s = n.findNodeAt(a), l = e.getText();
			if (!s || !s.tag) return null;
			const c = this.dataManager.getDataProviders().filter((t) => t.isApplicable(e.languageId));
			function h(e, t, n) {
				for (const a of c) {
					let n = null;
					if (a.provideTags().forEach((r) => {
			...
			function d(t, n) {
				const i = ts(e.getText(), n);
				let r = i.scan();
				for (; r !== Ma.EOS && (i.getTokenEnd() < a || i.getTokenEnd() === a && r !== t);) r = i.scan();
				return r === t && a <= i.getTokenEnd() ? {
					start: e.positionAt(i.getTokenOffset()),
					end: e.positionAt(i.getTokenEnd())
				} : null;
			}
			if (s.endTagStart && a >= s.endTagStart) {
				const e = d(Ma.EndTag, s.endTagStart);
				return e ? h(s.tag, e) : null;
			}
			const u = d(Ma.StartTag, s.start);
			if (u) return h(s.tag, u);
			const m = d(Ma.AttributeName, s.start);
			if (m) return function(e, t, n) {
				for (const a of c) {
					let s = null;
					if (a.provideAttributes(e).forEach((e) => {
			...
			const p = function() {
				let e = a - 1, n = t.character;
				for (; e >= 0 && gs(l, e);) e--, n--;
				let i = e + 1, r = n;
				for (; gs(l, i);) i++, r++;
				if (e >= 0 && "&" === l[e]) {
					let e = null;
					return e = ao.create(oo.create(t.line, n), oo.create(t.line, ";" === l[i] ? r + 1 : r)), e;
				}
				return null;
			}();
			if (p) return function(e, t) {
				let n = function(e) {
					let t = a - 1, n = "&";
					for (; t >= 0 && gs(e, t);) t--;
					for (t += 1; gs(e, t);) n += e[t], t += 1;
					return n += ";", n;
				}(e);
				for (const i in os) {
					let e = null;
					if (n === "&" + i) {
						let n = os[i].charCodeAt(0).toString(16).toUpperCase(), r = "U+";
						if (n.length < 4) {
							const e = 4 - n.length;
							let t = 0;
							for (; t < e;) r += "0", t += 1;
						...
						r += n;
						const o = eo("Character entity representing '{0}', unicode equivalent '{1}'", os[i], r);
						e = o ? {
							contents: o,
							range: t
						} : null;
			...
			const g = d(Ma.AttributeValue, s.start);
			if (g) {
				const t = s.tag, n = (f = e.getText(g)).length <= 1 ? f.replace(/['"]/, "") : ("'" !== f[0] && "\"" !== f[0] || (f = f.slice(1)), "'" !== f[f.length - 1] && "\"" !== f[f.length - 1] || (f = f.slice(0, -1)), f), a = function(t, n) {
					const i = ts(e.getText(), t);
					let r, o = i.scan();
					for (; o !== Ma.EOS && i.getTokenEnd() <= n;) o = i.scan(), o === Ma.AttributeName && (r = i.getTokenText());
					return r;
				}(s.start, e.offsetAt(g.start));
				if (a) return function(e, t, n, a) {
					for (const s of c) {
						let l = null;
	...
	As = [
		...
		function(e) {
			...
			t.prototype.clone_empty = function() {
				...
				return e < 0 && (n = 0), (n += e * this.__indent_size) + (t || 0);
			}, n.prototype.get_indent_string = function(e, t) {
				var n = this.__base_string;
				return t = t || 0, e < 0 && (e = 0, n = ""), this.__ensure_cache(t += e * this.__indent_size), n + this.__cache[t];
				...
				return this.next_line.set_indent(e = e || 0, t = t || 0), this.__lines.length > 1 ? (this.current_line.set_indent(e, t), !0) : (this.current_line.set_indent(), !1);
		...
		function(e) {
			...
			t.prototype._get_array = function(e, t) {
				...
				if (!this._is_valid_selection(n = n || [t[0]], t)) throw new Error("Invalid Default Value!");
		...
		function(e, t, n) {
			var i = n(17).Options, r = n(2).Output, o = n(8).InputScanner, a = new (n(13)).Directives(/\/\*/, /\*\//), s = /\r\n|[\r\n]/, l = /\s/, c = /(?:\s|\n)+/g, h = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g, d = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
			function u(e, t) {
			...
			u.prototype.eatString = function(e) {
				...
				return t;
			}, u.prototype.eatWhitespace = function(e) {
				...
				var n = (e = e.replace(/\r\n|[\r\n]/g, "\n")).match(/^[\t ]*/)[0];
				this._output = new r(this._options, n), this._input = new o(e), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
				for (var i, u, m = 0, p = !1, g = !1, f = !1, b = !1, _ = !1, w = this._ch, v = !1; i = "" !== this._input.read(c), u = w, this._ch = this._input.next(), "\\" === this._ch && this._input.hasNext() && (this._ch += this._input.next()), w = this._ch, this._ch;) if ("/" === this._ch && "*" === this._input.peek()) {
					this._output.add_new_line(), this._input.back();
					var y = this._input.read(h), T = a.get_directives(y);
					T && "start" === T.ignore && (y += a.readIgnored(this._input)), this.print_string(y), this.eatWhitespace(!0), this._output.add_new_line();
				} else if ("/" === this._ch && "/" === this._input.peek()) this._output.space_before_token = !0, this._input.back(), this.print_string(this._input.read(d)), this.eatWhitespace(!0);
				else if ("$" === this._ch) {
					this.preserveSingleSpace(i), this.print_string(this._ch);
					var k = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
					k.match(/[ :]$/) && (k = this.eatString(": ").replace(/\s+$/, ""), this.print_string(k), this._output.space_before_token = !0), 0 === m && -1 !== k.indexOf(":") && (g = !0, this.indent());
					...
					S.match(/[ :]$/) && (S = this.eatString(": ").replace(/\s+$/, ""), this.print_string(S), this._output.space_before_token = !0), 0 === m && -1 !== S.indexOf(":") ? (g = !0, this.indent()) : S in this.NESTED_AT_RULE ? (this._nestedLevel += 1, S in this.CONDITIONAL_GROUP_RULE && (f = !0)) : 0 !== m || g || (b = !0);
				}
				else if ("#" === this._ch && "{" === this._input.peek()) this.preserveSingleSpace(i), this.print_string(this._ch + this.eatString("}"));
				else if ("{" === this._ch) g && (g = !1, this.outdent()), b = !1, f ? (f = !1, p = this._indentLevel >= this._nestedLevel) : p = this._indentLevel >= this._nestedLevel - 1, this._options.newline_between_rules && p && this._output.previous_line && "{" !== this._output.previous_line.item(-1) && this._output.ensure_empty_line_above("/", ","), this._output.space_before_token = !0, "expand" === this._options.brace_style ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : ("(" === u ? this._output.space_before_token = !1 : "," !== u && this.indent(), this.print_string(this._ch)), this.eatWhitespace(!0), this._output.add_new_line();
				else if ("}" === this._ch) this.outdent(), this._output.add_new_line(), "{" === u && this._output.trim(!0), g && (this.outdent(), g = !1), this.print_string(this._ch), p = !1, this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && "}" !== this._input.peek() && this._output.add_new_line(!0), ")" === this._input.peek() && (this._output.trim(!0), "expand" === this._options.brace_style && this._output.add_new_line(!0));
				else if (":" === this._ch) {
					for (var L = 0; L < this.NON_SEMICOLON_NEWLINE_PROPERTY.length; L++) if (this._input.lookBack(this.NON_SEMICOLON_NEWLINE_PROPERTY[L])) {
						v = !0;
						break;
					}
					!p && !f || this._input.lookBack("&") || this.foundNestedPseudoClass() || this._input.lookBack("(") || b || 0 !== m ? (this._input.lookBack(" ") && (this._output.space_before_token = !0), ":" === this._input.peek() ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":")) : (this.print_string(":"), g || (g = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent()));
				} else if ("\"" === this._ch || "'" === this._ch) this.preserveSingleSpace("\"" === u || "'" === u || i), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
				else if (";" === this._ch) v = !1, 0 === m ? (g && (this.outdent(), g = !1), b = !1, this.print_string(this._ch), this.eatWhitespace(!0), "/" !== this._input.peek() && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
				else if ("(" === this._ch) if (this._input.lookBack("url")) this.print_string(this._ch), this.eatWhitespace(), m++, this.indent(), this._ch = this._input.next(), ")" === this._ch || "\"" === this._ch || "'" === this._ch ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), m && (m--, this.outdent()));
				else {
					var x = !1;
					this._input.lookBack("with") && (x = !0), this.preserveSingleSpace(i || x), this.print_string(this._ch), g && "$" === u && this._options.selector_separator_newline ? (this._output.add_new_line(), _ = !0) : (this.eatWhitespace(), m++, this.indent());
				}
				else ")" === this._ch ? (m && (m--, this.outdent()), _ && ";" === this._input.peek() && this._options.selector_separator_newline && (_ = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch)) : "," === this._ch ? (this.print_string(this._ch), this.eatWhitespace(!0), !this._options.selector_separator_newline || g && !_ || 0 !== m || b ? this._output.space_before_token = !0 : this._output.add_new_line()) : ">" !== this._ch && "+" !== this._ch && "~" !== this._ch || g || 0 !== m ? "]" === this._ch ? this.print_string(this._ch) : "[" === this._ch ? (this.preserveSingleSpace(i), this.print_string(this._ch)) : "=" === this._ch ? (this.eatWhitespace(), this.print_string("="), l.test(this._ch) && (this._ch = "")) : "!" !== this._ch || this._input.lookBack("\\") ? (this.preserveSingleSpace("\"" === u || "'" === u || i), this.print_string(this._ch), !this._output.just_added_newline() && "\n" === this._input.peek() && v && this._output.add_new_line()) : (this._output.space_before_token = !0, this.print_string(this._ch)) : this._options.space_around_combinator ? (this._output.space_before_token = !0, this.print_string(this._ch), this._output.space_before_token = !0) : (this.print_string(this._ch), this.eatWhitespace(), this._ch && l.test(this._ch) && (this._ch = ""));
		...
		function(e, t, n) {
			...
			function r(e) {
				...
				for (var r = 0; r < n.length; r++) this.brace_style = "expand" !== n[r] ? "collapse" : n[r];
			}
			r.prototype = new i(), e.exports.Options = r;
		}
	], Rs = {};
	var Is, zs, Os = function e(t) {
		var n = Rs[t];
		if (void 0 !== n) return n.exports;
		var i = Rs[t] = { exports: {} };
		return As[t](i, i.exports, e), i.exports;
	}(15);
	function Us(e, t, n) {
		let i = e.getText(), r = !0, o = 0;
		const a = n.tabSize || 4;
		if (t) {
			let a = e.offsetAt(t.start), s = a;
			for (; s > 0 && qs(i, s - 1);) s--;
			0 === s || Ps(i, s - 1) ? a = s : s < a && (a = s + 1);
			let l = e.offsetAt(t.end), c = l;
			for (; c < i.length && qs(i, c);) c++;
			(c === i.length || Ps(i, c)) && (l = c), t = ao.create(e.positionAt(a), e.positionAt(l));
			const h = i.substring(0, a);
			if ((/* @__PURE__ */ new RegExp(/.*[<][^>]*$/)).test(h)) return i = i.substring(a, l), [{
				range: t,
				newText: i
			}];
			if (r = l === i.length, i = i.substring(a, l), 0 !== a) {
				const i = e.offsetAt(oo.create(t.start.line, 0));
				o = function(e, t, n) {
					let i = t, r = 0;
					const o = n.tabSize || 4;
					for (; i < e.length;) {
		...
		} else t = ao.create(oo.create(0, 0), e.positionAt(i.length));
		const s = {
			indent_size: a,
			indent_char: n.insertSpaces ? " " : "	",
			indent_empty_lines: Hs(n, "indentEmptyLines", !1),
			wrap_line_length: Hs(n, "wrapLineLength", 120),
			unformatted: Ds(n, "unformatted", void 0),
			content_unformatted: Ds(n, "contentUnformatted", void 0),
			indent_inner_html: Hs(n, "indentInnerHtml", !1),
			preserve_newlines: Hs(n, "preserveNewLines", !0),
			max_preserve_newlines: Hs(n, "maxPreserveNewLines", 32786),
			indent_handlebars: Hs(n, "indentHandlebars", !1),
			end_with_newline: r && Hs(n, "endWithNewline", !1),
			extra_liners: Ds(n, "extraLiners", void 0),
			wrap_attributes: Hs(n, "wrapAttributes", "auto"),
			wrap_attributes_indent_size: Hs(n, "wrapAttributesIndentSize", void 0),
			eol: "\n",
			indent_scripts: Hs(n, "indentScripts", "normal"),
			templating: Ws(n, "all"),
			unformatted_content_delimiter: Hs(n, "unformattedContentDelimiter", "")
		};
		let l = function(e, t) {
			return Is(e, t, Ns, Os);
		}(i.replace(/^\s+/, ""), s);
		if (o > 0) {
			const e = n.insertSpaces ? ls(" ", a * o) : ls("	", o);
	...
	(function() {
		var e = [
			...
			function(e, t, n) {
				var i = n(8).InputScanner, r = n(3).Token, o = n(10).TokenStream, a = n(11).WhitespacePattern, s = {
					START: "TK_START",
					RAW: "TK_RAW",
					EOF: "TK_EOF"
				}, l = function(e, t) {
					this._input = new i(e), this._options = t || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new a(this._input);
				};
				l.prototype.tokenize = function() {
					var e;
					this._input.restart(), this.__tokens = new o(), this._reset();
					for (var t = new r(s.START, ""), n = null, i = [], a = new o(); t.type !== s.EOF;) {
						for (e = this._get_next_token(t, n); this._is_comment(e);) a.add(e), e = this._get_next_token(t, n);
						a.isEmpty() || (e.comments_before = a, a = new o()), e.parent = n, this._is_opening(e) ? (i.push(n), n = e) : n && this._is_closing(e, n) && (e.opened = n, n.closed = e, n = i.pop(), e.parent = n), e.previous = t, t.next = e, this.__tokens.add(e), t = e;
					}
			...
			function(e, t, n) {
				...
				(r.prototype = new i()).__set_whitespace_patterns = function(e, t) {
					...
					return i.push(n < t.length ? t.substring(n, t.length) : ""), i;
			...
			function(e, t, n) {
				...
				(o.prototype = new i())._create = function() {
					...
					for (var t = this._read_template(); t;) e += t += this._match_pattern ? this._input.read(this._match_pattern) : this._input.readUntil(this.__template_pattern), t = this._read_template();
			...
			function(e, t, n) {
				var i = n(20).Options, r = n(2).Output, o = n(21).Tokenizer, a = n(21).TOKEN, s = /\r\n|[\r\n]/, l = function(e, t) {
				...
				l.prototype.current_line_has_match = function(e) {
					...
					var n = (e = e.replace(/\r\n|[\r\n]/g, "\n")).match(/^[\t ]*/)[0], i = {
						text: "",
						type: ""
					}, r = new m(), c = new l(this._options, n), h = new o(e, this._options).tokenize();
					this._tag_stack = new d(c);
					for (var u = null, p = h.next(); p.type !== a.EOF;) p.type === a.TAG_OPEN || p.type === a.COMMENT ? r = u = this._handle_tag_open(c, p, r, i, h) : p.type === a.ATTRIBUTE || p.type === a.EQUALS || p.type === a.VALUE || p.type === a.TEXT && !r.tag_complete ? u = this._handle_inside_tag(c, p, r, i) : p.type === a.TAG_CLOSE ? u = this._handle_tag_close(c, p, r) : p.type === a.TEXT ? u = this._handle_text(c, p, r) : p.type === a.CONTROL_FLOW_OPEN ? u = this._handle_control_flow_open(c, p) : p.type === a.CONTROL_FLOW_CLOSE ? u = this._handle_control_flow_close(c, p) : c.add_raw_token(p), i = u, p = h.next();
					return c._output.get_code(t);
				}, u.prototype._handle_control_flow_open = function(e, t) {
					var n = {
						text: t.text,
						type: t.type
					};
				...
				}, u.prototype._handle_control_flow_close = function(e, t) {
					var n = {
						text: t.text,
						type: t.type
					};
				...
				}, u.prototype._handle_tag_close = function(e, t, n) {
					var i = {
						text: t.text,
						type: t.type
					};
				...
				}, u.prototype._print_custom_beatifier_text = function(e, t, n) {
					var i = this;
					if ("" !== t.text) {
						var r, o = t.text, a = 1, s = "", l = "";
				...
				var m = function(e, t) {
					if (this.parent = e || null, this.text = "", this.type = "TK_TAG_OPEN", this.tag_name = "", this.is_inline_element = !1, this.is_unformatted = !1, this.is_content_unformatted = !1, this.is_empty_element = !1, this.is_start_tag = !1, this.is_end_tag = !1, this.indent_content = !1, this.multiline_content = !1, this.custom_beautifier_name = null, this.start_tag_token = null, this.attr_count = 0, this.has_wrapped_attrs = !1, this.alignment_size = 0, this.tag_complete = !1, this.tag_start_char = "", this.tag_check = "", t) {
						var n;
						this.tag_start_char = t.text[0], this.text = t.text, "<" === this.tag_start_char ? (n = t.text.match(/^<([^\s>]*)/), this.tag_check = n ? n[1] : "") : (n = t.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/), this.tag_check = n ? n[1] : "", (t.text.startsWith("{{#>") || t.text.startsWith("{{~#>")) && ">" === this.tag_check[0] && (this.tag_check = ">" === this.tag_check && null !== t.next ? t.next.text.split(" ")[0] : t.text.split(">")[1])), this.tag_check = this.tag_check.toLowerCase(), t.type === a.COMMENT && (this.tag_complete = !0), this.is_start_tag = "/" !== this.tag_check.charAt(0), this.tag_name = this.is_start_tag ? this.tag_check : this.tag_check.substr(1), this.is_end_tag = !this.is_start_tag || t.closed && "/>" === t.closed.text;
						var i = 2;
				...
				u.prototype._get_tag_open_token = function(e) {
				...
				}, u.prototype._set_tag_position = function(e, t, n, i, r) {
					...
					}(n.tag_check, t)))), c(n.tag_check, this._options.extra_liners) && (e.print_newline(!1), e._output.just_added_blankline() || e.print_newline(!0)), n.is_empty_element) "{" === n.tag_start_char && "else" === n.tag_check && (this._tag_stack.indent_to_tag([
						"if",
						"unless",
						"each"
					]), n.indent_content = !0, e.current_line_has_match(/{{#if/) || e.print_newline(!1)), "!--" === n.tag_name && r.type === a.TAG_CLOSE && i.is_end_tag && -1 === n.text.indexOf("\n") || (n.is_inline_element || n.is_unformatted || e.print_newline(!1), this._calcluate_parent_multiline(e, n));
					else if (n.is_end_tag) {
						var o = !1;
						o = (o = n.start_tag_token && n.start_tag_token.multiline_content) || !n.is_inline_element && !(i.is_inline_element || i.is_unformatted) && !(r.type === a.TAG_CLOSE && n.start_tag_token === i) && "TK_CONTENT" !== r.type, (n.is_content_unformatted || n.is_unformatted) && (o = !1), o && e.print_newline(!1);
				...
				}, u.prototype._calcluate_parent_multiline = function(e, t) {
				...
				u.prototype._do_optional_end_element = function(e) {
					var t = null;
					if (!e.is_empty_element && e.is_start_tag && e.parent) {
						...
						else if ("p" === e.parent.tag_name && -1 !== p.indexOf(e.tag_name)) {
							var n = e.parent.parent;
							n && -1 !== g.indexOf(n.tag_name) || (t = t || this._tag_stack.try_pop("p"));
			...
			function(e, t, n) {
				var i = n(9).Tokenizer, r = n(9).TOKEN, o = n(13).Directives, a = n(14).TemplatablePattern, s = n(12).Pattern, l = {
					...
					RAW: r.RAW,
					EOF: r.EOF
				}, c = new o(/<\!--/, /-->/), h = function(e, t) {
					i.call(this, e, t), this._current_tag_name = "";
					var n = new a(this._input).read_options(this._options), r = new s(this._input);
					if (this.__patterns = {
						word: n.until(/[\n\r\t <]/),
						...
						this.__patterns.unformatted_content_delimiter = r.matching(o).until_after(o);
					}
				};
				(h.prototype = new i())._is_comment = function(e) {
					...
					if ("@" === e) {
						...
						for (var r = n.endsWith("(") ? 1 : 0, o = 0; !n.endsWith("{") || r !== o;) {
					...
					if (n && "<" === n.text[0]) if ("=" === e) i = this._create_token(l.EQUALS, this._input.next());
						...
						o += "\"" === e ? this.__patterns.double_quote.read() : this.__patterns.single_quote.read(), i = this._create_token(l.VALUE, o);
					} else (r = this.__patterns.attribute.read()) && (i = this._create_token(t.type === l.EQUALS ? l.VALUE : l.ATTRIBUTE, r));
					return i;
		...
		var e = { 470: (e) => {
			...
			function n(e, t) {
				for (var n, i = "", r = 0, o = -1, a = 0, s = 0; s <= e.length; ++s) {
					...
					if (47 === n) {
						if (o === s - 1 || 1 === a);
							...
							if (i.length < 2 || 2 !== r || 46 !== i.charCodeAt(i.length - 1) || 46 !== i.charCodeAt(i.length - 2)) {
								if (i.length > 2) {
									var l = i.lastIndexOf("/");
									if (l !== i.length - 1) {
										-1 === l ? (i = "", r = 0) : r = (i = i.slice(0, l)).length - 1 - i.lastIndexOf("/"), o = s, a = 0;
										continue;
									}
						...
						} else i.length > 0 ? i += "/" + e.slice(o + 1, s) : i = e.slice(o + 1, s), r = s - o - 1;
						o = s, a = 0;
					} else 46 === n && -1 !== a ? ++a : a = -1;
				}
				return i;
			...
			var i = {
				resolve: function() {
					for (var e, i = "", r = !1, o = arguments.length - 1; o >= -1 && !r; o--) {
						var a;
						o >= 0 ? a = arguments[o] : (void 0 === e && (e = process.cwd()), a = e), t(a), 0 !== a.length && (i = a + "/" + i, r = 47 === a.charCodeAt(0));
					}
				...
				relative: function(e, n) {
					...
					for (var l = n.length - s, c = a < l ? a : l, h = -1, d = 0; d <= c; ++d) {
						if (d === c) {
							if (l > c) {
								if (47 === n.charCodeAt(s + d)) return n.slice(s + d + 1);
								if (0 === d) return n.slice(s + d);
							} else a > c && (47 === e.charCodeAt(r + d) ? h = d : 0 === d && (h = 0));
							break;
						}
					...
					var m = "";
					for (d = r + h + 1; d <= o; ++d) d !== o && 47 !== e.charCodeAt(d) || (m += 0 === m.length ? ".." : "/..");
					return m.length > 0 ? m + n.slice(s + h) : (47 === n.charCodeAt(s += h) && ++s, n.slice(s));
				},
				...
				dirname: function(e) {
					if (t(e), 0 === e.length) return ".";
					for (var n = e.charCodeAt(0), i = 47 === n, r = -1, o = !0, a = e.length - 1; a >= 1; --a) if (47 === (n = e.charCodeAt(a))) {
						if (!o) {
							r = a;
							break;
						}
				...
				basename: function(e, n) {
					...
					if (void 0 !== n && n.length > 0 && n.length <= e.length) {
						...
						for (i = e.length - 1; i >= 0; --i) {
							...
							} else -1 === l && (a = !1, l = i + 1), s >= 0 && (c === n.charCodeAt(s) ? -1 == --s && (o = i) : (s = -1, o = l));
						}
				...
				extname: function(e) {
					t(e);
					for (var n = -1, i = 0, r = -1, o = !0, a = 0, s = e.length - 1; s >= 0; --s) {
						var l = e.charCodeAt(s);
						if (47 !== l) -1 === r && (o = !1, r = s + 1), 46 === l ? -1 === n ? n = s : 1 !== a && (a = 1) : -1 !== n && (a = -1);
						else if (!o) {
							i = s + 1;
							break;
						}
				...
				parse: function(e) {
					...
					var i, r = e.charCodeAt(0), o = 47 === r;
					o ? (n.root = "/", i = 1) : i = 0;
					for (var a = -1, s = 0, l = -1, c = !0, h = e.length - 1, d = 0; h >= i; --h) if (47 !== (r = e.charCodeAt(h))) -1 === l && (c = !1, l = h + 1), 46 === r ? -1 === a ? a = h : 1 !== d && (d = 1) : -1 !== a && (d = -1);
					else if (!c) {
						s = h + 1;
						break;
					}
					return -1 === a || -1 === l || 0 === d || 1 === d && a === l - 1 && a === s + 1 ? -1 !== l && (n.base = n.name = e.slice(0 === s && o ? 1 : s, l)) : (0 === s && o ? (n.name = e.slice(1, a), n.base = e.slice(1, l)) : (n.name = e.slice(s, a), n.base = e.slice(s, l)), n.ext = e.slice(a, l)), s > 0 ? n.dir = e.slice(0, s - 1) : o && (n.dir = "/"), n;
				},
				sep: "/",
				delimiter: ":",
				win32: null,
		...
		}, n.o = (e, t) => ({}).hasOwnProperty.call(e, t), n.r = (e) => {
		...
		(() => {
			...
			class h {
				...
				constructor(e, t, n, i, r, o = !1) {
					"object" == typeof e ? (this.scheme = e.scheme || s, this.authority = e.authority || s, this.path = e.path || s, this.query = e.query || s, this.fragment = e.fragment || s) : (this.scheme = function(e, t) {
						return e || t ? e : "file";
					}(e, o), this.authority = t || s, this.path = function(e, t) {
						switch (e) {
							case "https":
							case "http":
						...
						return t;
					}(this.scheme, n || s), this.query = i || s, this.fragment = r || s, a(this, o));
				}
				get fsPath() {
					return f(this);
				}
				with(e) {
					if (!e) return this;
					let { scheme: t, authority: n, path: i, query: r, fragment: o } = e;
					return void 0 === t ? t = this.scheme : null === t && (t = s), void 0 === n ? n = this.authority : null === n && (n = s), void 0 === i ? i = this.path : null === i && (i = s), void 0 === r ? r = this.query : null === r && (r = s), void 0 === o ? o = this.fragment : null === o && (o = s), t === this.scheme && n === this.authority && i === this.path && r === this.query && o === this.fragment ? this : new u(t, n, i, r, o);
				}
				static parse(e, t = !1) {
					const n = c.exec(e);
			...
			function b(e, t) {
				const n = t ? g : p;
				let i = "", { scheme: r, authority: o, path: a, query: s, fragment: c } = e;
				if (r && (i += r, i += ":"), (o || "file" === r) && (i += l, i += l), o) {
					let e = o.indexOf("@");
					if (-1 !== e) {
						const t = o.substr(0, e);
						o = o.substr(e + 1), e = t.lastIndexOf(":"), -1 === e ? i += n(t, !1, !1) : (i += n(t.substr(0, e), !1, !1), i += ":", i += n(t.substr(e + 1), !1, !0)), i += "@";
	...
	function Bs(e, t, n, i, r, o) {
		const a = Vs(n);
		if (!(s = a).length || "handlebars" === e.languageId && /{{|}}/.test(s) || !/\b(w[\w\d+.-]*:\/\/)?[^\s()<>]+(?:\([\w\d]+\)|([^[:punct:]\s]|\/?))/.test(s)) return;
		var s;
		...
		const l = function(e, t, n, i) {
			...
			return /^\#/i.test(t) ? e + t : /^\/\//i.test(t) ? (as(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "") : n ? n.resolveReference(t, i || e) : t;
		}(e.uri, a, t, o);
		if (!l) return;
		const c = function(e, t) {
			try {
				let n = Fs.parse(e);
				return "file" === n.scheme && n.query && (n = n.with({ query: null }), e = n.toString(!0)), "file" !== n.scheme || !n.fragment || e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === Ks ? e : n.with({ fragment: null }).toString(!0);
			} catch (dl) {
				return;
			}
		}(l, e);
		return {
			range: ao.create(e.positionAt(i), e.positionAt(r)),
			target: c
		};
	}
	const Ks = "#".charCodeAt(0);
	var js = class {
		constructor(e) {
			this.dataManager = e;
		}
		findDocumentLinks(e, t) {
			const n = [], i = ts(e.getText(), 0);
			let r, o, a, s = i.scan(), l = !1;
			const c = {};
			for (; s !== Ma.EOS;) {
				switch (s) {
					case Ma.StartTag:
						o = i.getTokenText().toLowerCase(), a || (l = "base" === o);
						break;
					case Ma.AttributeName:
						r = i.getTokenText().toLowerCase();
						break;
					case Ma.AttributeValue: if (o && r && this.dataManager.isPathAttribute(o, r)) {
						const o = i.getTokenText();
						if (!l) {
							const r = Bs(e, t, o, i.getTokenOffset(), i.getTokenEnd(), a);
							r && n.push(r);
						}
						l && void 0 === a && (a = Vs(o), a && t && (a = t.resolveReference(a, e.uri))), l = !1, r = void 0;
					} else "id" === r && (c[Vs(i.getTokenText())] = i.getTokenOffset());
				}
				s = i.scan();
			}
			for (const h of n) {
				const t = e.uri + "#";
				if (h.target && as(h.target, t)) {
	...
	function Gs(e, t, n) {
		...
		if (!r.tag) return [];
		const o = [], a = Js(Ma.StartTag, e, r.start), s = "number" == typeof r.endTagStart && Js(Ma.EndTag, e, r.endTagStart);
		return (a && Xs(a, t) || s && Xs(s, t)) && (a && o.push({
			kind: $o.Read,
			range: a
		}), s && o.push({
			kind: $o.Read,
	...
	function Xs(e, t) {
		return $s(e.start, t) && $s(t, e.end);
	}
	function Js(e, t, n) {
		const i = ts(t.getText(), n);
		let r = i.scan();
		for (; r !== Ma.EOS && r !== e;) r = i.scan();
		return r !== Ma.EOS ? {
	...
	function Ys(e, t) {
		const n = [], i = Qs(e, t);
		for (const o of i) r(o, void 0);
		return n;
		function r(t, i) {
			const o = Qo.create(t.name, t.kind, t.range, e.uri, i?.name);
			if (o.containerName ?? (o.containerName = ""), n.push(o), t.children) for (const e of t.children) r(e, t);
		}
	}
	function Qs(e, t) {
		const n = [];
	...
	function Zs(e, t, n) {
		const i = function(e) {
			...
			return t || "?";
		}(t), r = ao.create(e.positionAt(t.start), e.positionAt(t.end)), o = ea.create(i, void 0, Jo.Field, r, r);
		n.push(o), t.children.forEach((t) => {
			o.children ?? (o.children = []), Zs(e, t, o.children);
		});
	}
	function el(e, t, n, i) {
		const r = e.offsetAt(t), o = i.findNodeAt(r);
		if (!o.tag) return null;
		if (!function(e, t, n) {
			return !!(e.endTagStart && e.endTagStart + 2 <= t && t <= e.endTagStart + 2 + n.length) || e.start + 1 <= t && t <= e.start + 1 + n.length;
		}(o, r, o.tag)) return null;
		const a = [], s = {
	...
	function tl(e, t, n) {
		const i = e.offsetAt(t), r = n.findNodeAt(i);
		return r.tag && r.endTagStart ? r.start + 1 <= i && i <= r.start + 1 + r.tag.length ? e.positionAt(i - 1 - r.start + r.endTagStart + 2) : r.endTagStart + 2 <= i && i <= r.endTagStart + 2 + r.tag.length ? e.positionAt(i - 2 - r.endTagStart + r.start + 1) : null : null;
	}
	function nl(e, t, n) {
		const i = e.offsetAt(t), r = n.findNodeAt(i), o = r.tag ? r.tag.length : 0;
		return r.endTagStart && (r.start + 1 <= i && i <= r.start + 1 + o || r.endTagStart + 2 <= i && i <= r.endTagStart + 2 + o) ? [ao.create(e.positionAt(r.start + 1), e.positionAt(r.start + 1 + o)), ao.create(e.positionAt(r.endTagStart + 2), e.positionAt(r.endTagStart + 2 + o))] : null;
	}
	var il = class {
		constructor(e) {
			this.dataManager = e;
			...
			for (let h = 0; h < e.length; h++) {
				...
				if (n) {
					if (t.startLine > n.startLine) {
						if (t.endLine <= n.endLine) i.push(n), n = t, a(h, i.length);
						else if (t.startLine > n.endLine) {
							do
								n = i.pop();
							while (n && t.startLine > n.endLine);
							n && i.push(n), n = t, a(h, i.length);
						}
					}
				} else n = t, a(h, 0);
			}
		...
		getFoldingRanges(e, t) {
			const n = this.dataManager.getVoidElements(e.languageId), i = ts(e.getText());
			let r = i.scan();
			const o = [], a = [];
			let s = null, l = -1;
			function c(e) {
				o.push(e), l = e.startLine;
			}
			for (; r !== Ma.EOS;) {
				switch (r) {
					case Ma.StartTag: {
					...
					case Ma.EndTag:
						s = i.getTokenText();
						break;
					case Ma.StartTagClose: if (!s || !this.dataManager.isVoidElement(s, n)) break;
					case Ma.EndTagClose:
					case Ma.StartTagSelfClose: {
						let t = a.length - 1;
						for (; t >= 0 && a[t].tagName !== s;) t--;
						if (t >= 0) {
							const n = a[t];
							a.length = t;
							const r = e.positionAt(i.getTokenOffset()).line, o = n.startLine, s = r - 1;
							s > o && l !== o && c({
								startLine: o,
								endLine: s
							});
			...
			return o.length > h ? this.limitRanges(o, h) : o;
		}
	}, rl = class {
		constructor(e) {
			this.htmlParser = e;
		...
		getSelectionRange(e, t, n) {
			...
			for (let a = i.length - 1; a >= 0; a--) {
				const e = i[a];
				r && e[0] === r[0] && e[1] === r[1] || (o = la.create(ao.create(t.positionAt(i[a][0]), t.positionAt(i[a][1])), o)), r = e;
			}
			return o || (o = la.create(ao.create(e, e))), o;
		}
		getApplicableRanges(e, t, n) {
			const i = e.offsetAt(t), r = n.findNodeAt(i);
			let o = this.getAllParentTagRanges(r);
			if (r.startTagEnd && !r.endTagStart) {
				if (r.startTagEnd !== r.end) return [[r.start, r.end]];
				const t = ao.create(e.positionAt(r.startTagEnd - 2), e.positionAt(r.startTagEnd));
				return "/>" === e.getText(t) ? o.unshift([r.start + 1, r.startTagEnd - 2]) : o.unshift([r.start + 1, r.startTagEnd - 1]), o = this.getAttributeLevelRanges(e, r, i).concat(o), o;
			}
			return r.startTagEnd && r.endTagStart ? (o.unshift([r.start, r.end]), r.start < i && i < r.startTagEnd ? (o.unshift([r.start + 1, r.startTagEnd - 1]), o = this.getAttributeLevelRanges(e, r, i).concat(o), o) : r.startTagEnd <= i && i <= r.endTagStart ? (o.unshift([r.startTagEnd, r.endTagStart]), o) : (i >= r.endTagStart + 2 && o.unshift([r.endTagStart + 2, r.end - 1]), o)) : o;
		}
		...
		getAttributeLevelRanges(e, t, n) {
			const i = ao.create(e.positionAt(t.start), e.positionAt(t.end)), r = e.getText(i), o = n - t.start, a = ts(r);
			let s = a.scan();
			const l = t.start, c = [];
			let h = !1, d = -1;
			for (; s !== Ma.EOS;) {
				switch (s) {
					case Ma.AttributeName:
						if (o < a.getTokenOffset()) {
							h = !1;
							break;
						}
						o <= a.getTokenEnd() && c.unshift([a.getTokenOffset(), a.getTokenEnd()]), h = !0, d = a.getTokenOffset();
						break;
					case Ma.AttributeValue: {
						if (!h) break;
						const e = a.getTokenText();
						if (o < a.getTokenOffset()) {
							c.push([d, a.getTokenEnd()]);
							break;
						}
						o >= a.getTokenOffset() && o <= a.getTokenEnd() && (c.unshift([a.getTokenOffset(), a.getTokenEnd()]), ("\"" === e[0] && "\"" === e[e.length - 1] || "'" === e[0] && "'" === e[e.length - 1]) && o >= a.getTokenOffset() + 1 && o <= a.getTokenEnd() - 1 && c.unshift([a.getTokenOffset() + 1, a.getTokenEnd() - 1]), c.push([d, a.getTokenEnd()]));
						break;
					}
				}
				s = a.scan();
	...
	var al = class {
		...
		setDataProviders(e, t) {
			this.dataProviders = [], e && this.dataProviders.push(new bs("html5", ol)), this.dataProviders.push(...t);
		}
		getDataProviders() {
	...
	var hl = class {
		constructor(e, t) {
			...
			if (n?.dataProviders) for (const o in n.dataProviders) r.push(cl(o, n.dataProviders[o]));
			this._languageService = function(e = ll) {
				const t = new al(e), n = new Ms(e, t), i = new xs(e, t), r = new rs(t), o = new rl(r), a = new il(t), s = new js(t);
				return {
					...
					format: Us,
					findDocumentHighlights: Gs,
					findDocumentLinks: s.findDocumentLinks.bind(s),
					findDocumentSymbols: Ys,
					findDocumentSymbols2: Qs,
					getFoldingRanges: a.getFoldingRanges.bind(a),
					getSelectionRanges: o.getSelectionRanges.bind(o),
					doQuoteComplete: i.doQuoteComplete.bind(i),
					doTagComplete: i.doTagComplete.bind(i),
					doRename: el,
					findMatchingTagPosition: tl,
					findOnTypeRenameRanges: nl,
					findLinkedEditingRanges: nl
				};
			}({
		...
		async doRename(e, t, n) {
			let i = this._getTextDocument(e);
			if (!i) return null;
			let r = this._languageService.parseHTMLDocument(i), o = this._languageService.doRename(i, t, n, r);
			return Promise.resolve(o);
		}
		_getTextDocument(e) {
			let t = this._ctx.getMirrorModels();
			for (let n of t) if (n.uri.toString() === e) return Ra.create(e, this._languageId, n.version, n.getValue());
			return null;
		}
	};
	self.onmessage = () => {
		var e = (e, t) => new hl(e, t);
		self.onmessage = (t) => {
			(function() {
				let n;
				const i = function(e) {
					if (be) throw new Error("WebWorker already initialized!");
					be = !0;
					const t = new fe((e) => globalThis.postMessage(e), (t) => e(t));
					return globalThis.onmessage = (e) => {
						t.onmessage(e.data);
					}, t;
				}((r) => {
					const o = Qr.getChannel(r);
					return a = {
						...
						getMirrorModels: () => i.requestHandler.getModels()
					}, n = e(a, t.data), new Yr(n);
					var a;
				});
			})();
		};
